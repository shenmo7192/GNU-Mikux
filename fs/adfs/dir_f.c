...
/*
 * convert a disk-based directory entry to a Mikux ADFS directory entry
 */
static inline void
...
/*
 * convert a Mikux ADFS directory entry to a disk-based directory entry
 */
static inline void
