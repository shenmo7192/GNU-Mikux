...
#ifndef _MIKUX_HFS_FS_H
#define _MIKUX_HFS_FS_H
 ...
 *
 * The HFS-specific part of a Mikux (struct inode)
 */
struct hfs_inode_info {
	atomic_t opencnt;
 ...
 * struct hfs_sb_info
 *
 * The HFS-specific part of a Mikux (struct super_block)
 */
struct hfs_sb_info {
 ...
 * traditional behavior of 64-bit Mikux, giving the most useful
