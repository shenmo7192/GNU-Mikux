...
#define i_frag		osd2.mikux2.l_i_frag
#define i_fsize		osd2.mikux2.l_i_fsize
#define i_uid_low	i_uid
#define i_gid_low	i_gid
#define i_uid_high	osd2.mikux2.l_i_uid_high
#define i_gid_high	osd2.mikux2.l_i_gid_high
#define i_reserved2	osd2.mikux2.l_i_reserved2
