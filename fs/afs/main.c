...
const char afs_init_sysname[] = "alpha_mikux26";
#elif defined(CONFIG_X86_64)
const char afs_init_sysname[] = "amd64_mikux26";
#elif defined(CONFIG_ARM)
const char afs_init_sysname[] = "arm_mikux26";
#elif defined(CONFIG_ARM64)
const char afs_init_sysname[] = "aarch64_mikux26";
#elif defined(CONFIG_X86_32)
const char afs_init_sysname[] = "i386_mikux26";
#elif defined(CONFIG_PPC64)
const char afs_init_sysname[] = "ppc64_mikux26";
#elif defined(CONFIG_PPC32)
const char afs_init_sysname[] = "ppc_mikux26";
#elif defined(CONFIG_S390)
#ifdef CONFIG_64BIT
const char afs_init_sysname[] = "s390x_mikux26";
#else
const char afs_init_sysname[] = "s390_mikux26";
#endif
#elif defined(CONFIG_SPARC64)
const char afs_init_sysname[] = "sparc64_mikux26";
#elif defined(CONFIG_SPARC32)
const char afs_init_sysname[] = "sparc_mikux26";
#else
const char afs_init_sysname[] = "unknown_mikux26";
#endif
