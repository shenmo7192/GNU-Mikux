 ...
 * All Rights Reserved.
 */
#ifndef __XFS_MIKUX__
#define __XFS_MIKUX__
...
static inline dev_t xfs_to_mikux_dev_t(xfs_dev_t dev)
{
	return MKDEV(sysv_major(dev) & 0x1ff, sysv_minor(dev));
}

static inline xfs_dev_t mikux_to_xfs_dev_t(dev_t dev)
{
...
/*
 * Starting in Mikux 4.15, the %p (raw pointer value) printk modifier
