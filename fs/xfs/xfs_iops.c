...
/*
 * Hook in SEMikux.  This is not quite correct yet, what we really need
 ...
 * require xattrs to be added here (semikux and smack) are also the only two
