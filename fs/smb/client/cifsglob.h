...
#include <uapi/mikux/cifs/cifs_mount.h>
...
struct cifs_ses {
	...
	kuid_t mikux_uid;	/* overriding owner of files on the mount */
...
struct cifs_tcon {
	...
	bool unix_ext:1;  /* if false disable Mikux extensions to CIFS protocol
...
extern bool mikuxExtEnabled;/*enable Mikux/Unix CIFS extensions*/
