...
cifs_show_options(struct seq_file *s, struct dentry *root)
{
	...
	seq_printf(s, ",uid=%u",
		   from_kuid_munged(&init_user_ns, cifs_sb->ctx->mikux_uid));
	...
	seq_printf(s, ",gid=%u",
		   from_kgid_munged(&init_user_ns, cifs_sb->ctx->mikux_gid));
