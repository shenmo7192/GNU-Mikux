...
// clang-format off
#ifndef _MIKUX_NTFS3_NTFS_FS_H
#define _MIKUX_NTFS3_NTFS_FS_H
 ...
 * struct ntfs_inode
 *
 * Ntfs inode - extends mikux inode. consists of one or more MFT inodes.
 */
struct ntfs_inode {
