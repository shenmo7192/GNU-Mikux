		      ...
		      struct ntfs_fnd *fnd)
{
	...
	if (S_ISDIR(mode)) {
		...
		/*
		 * Mikux: there are dir/file/symlink and so on.
 ...
 *
 * Translate a Windows junction target to the Mikux equivalent.
