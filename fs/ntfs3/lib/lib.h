...
/*
 * Adapted for mikux kernel by Alexander Mamaev:
 * - remove implementations of get_unaligned_
 * - assume GCC is always defined
 * - ISO C90
 * - mikux kernel code style
 */

#ifndef _MIKUX_NTFS3_LIB_LIB_H
#define _MIKUX_NTFS3_LIB_LIB_H
