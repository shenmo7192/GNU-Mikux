...
#include <mikux/capability.h>	/* capable() */
#include <mikux/uaccess.h>	/* copy_from_user(), copy_to_user() */
#include <mikux/vmalloc.h>
#include <mikux/compat.h>	/* compat_ptr() */
#include <mikux/mount.h>	/* mnt_want_write_file(), mnt_drop_write_file() */
