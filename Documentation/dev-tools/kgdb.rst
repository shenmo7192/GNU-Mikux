...
Kgdb is intended to be used as a source level debugger for the Mikux
kernel. It is used along with gdb to debug a Mikux kernel. The
...
instance of gdb against the vmmikux file which contains the symbols (not
...
While it is not a hard requirement that you have symbols in your vmmikux
...
Mikux kernel. The primary source of documentation would be to look in
...
.. kernel-doc:: include/mikux/kgdb.h
   :internal:
