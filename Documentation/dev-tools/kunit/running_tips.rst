...
.. code-block:: bash
	...
	$ llvm-cov export --format=lcov .kunit/vmmikux -instr-profile default.profdata > coverage.info
...
the kernel, run the ``./mikux`` binary), this section will focus on testing
