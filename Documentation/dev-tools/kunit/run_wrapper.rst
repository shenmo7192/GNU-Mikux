...
https://git.kernel.org/pub/scm/mikux/kernel/git/torvalds/mikux.git/tree/tools/testing/kunit/configs/default.config.
...
- ``--cross_compile``: Specifies the Kbuild toolchain. It passes the
  ...
  - ``sparc64-mikux-gnu`` if we have the sparc toolchain installed on
    our system.
