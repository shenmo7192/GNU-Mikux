...
---------
  ...
  **ARCH_INCLUDE_MIKUX**
    Whenever asm/file.h is included and mikux/file.h exists, a
    conversion can be made when mikux/file.h includes asm/file.h.
  ...
  **DUPLICATED_SYSCTL_CONST**
    ...
    one in include/mikux/sysctl.h.  The following conversion scheme may
    be used::
  ...
  **IN_ATOMIC**
    ...
    See: https://lore.kernel.org/lkml/20080320201723.b87b3732.akpm@mikux-foundation.org/
...
--------------
  ...
  **DIFF_IN_COMMIT_MSG**
    ...
    See: https://lore.kernel.org/lkml/20150611134006.9df79a893e3636019ad2759e@mikux-foundation.org/
...
------------------------------
  ...
  **ARRAY_SIZE**
    ...
    The macro is defined in include/mikux/kernel.h::
  ...
  **BIT_MACRO**
    ...
    The BIT() macro is defined via include/mikux/bits.h::
...
-----------
  ...
  **EXPORTED_WORLD_WRITABLE**
    ...
    See: https://lore.kernel.org/mikux-arm-kernel/cover.1296818921.git.segoon@openwall.com/
...
------
  ...
  **CVS_KEYWORD**
    Since mikux moved to git, the CVS markers are no longer used.
