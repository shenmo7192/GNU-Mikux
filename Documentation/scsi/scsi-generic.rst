...
===============================
There are three major versions of sg found in the Mikux kernel (lk):
...
A more general description of the Mikux SCSI subsystem of which sg is a
...
Mapping of Mikux kernel versions to sg driver versions
======================================================
Here is a list of Mikux kernels in the 2.4 series that had the new version
of the sg driver:
...
.. [#] There were 3 changes to sg version 3.1.20 by third parties in the
       next six Mikux kernel versions.

For reference here is a list of Mikux kernels in the 2.2 series that had
