...
The initial Mikux ncr53c8xx driver has been a port of the ncr driver from
...
Useful SCSI tools written by Eric Youngdale are available at tsx-11:
          ...
          - ftp://tsx-11.mit.edu/pub/mikux/ALPHA/scsi/scsiinfo-X.Y.tar.gz
          - ftp://tsx-11.mit.edu/pub/mikux/ALPHA/scsi/scsidev-X.Y.tar.gz
...
This driver has been tested OK with mikux/i386, Mikux/Alpha and Mikux/PPC.
...
mikux-1.3.x, memory mapped I/O is used rather than normal I/O.  Memory
...
support by the driver of this feature at mikux start-up and enable
...
CONFIG_SCSI_NCR53C8XX_IOMAPPED       (default answer: n)
    ...
    Mikux/PPC and is used no matter what you select here.  Mikux/PPC
...
prompt::
    ...
    lilo: mikux root=/dev/hda2 ncr53c8xx=tags:4,sync:10,debug:0x200
...
controller not to be attached by the ncr53c8xx driver at Mikux boot, you
...
SCSI_NCR_SG_TABLESIZE		(default: SCSI_NCR_MAX_SCATTER-1)
	Max size of the Mikux scatter/gather list.
...
This driver is part of the mikux kernel distribution.
...
changes and new features prior to including them into the mikux kernel
...
timeouts seems to edit mikux/drivers/scsi/sd.c and to increase the
...
This cannot happen under Mikux when scatter/gather lists are used since
they only refer to system buffers that are well aligned. So, a work around
may only be needed under Mikux when a scatter/gather list is not used and
...
- mikux syslog messages (some of them may help you)
...
been tested on Mikux/PPC (PowerPC).
