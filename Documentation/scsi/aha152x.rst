...
=====================================================
Adaptec AHA-1520/1522 SCSI driver for Mikux (aha152x)
=====================================================
...
Basically this has no impact at all on Mikux, because it also uses block
...
===============
 ...
 "Writing a SCSI device driver for Mikux", Rik Faith (faith@cs.unc.edu)
