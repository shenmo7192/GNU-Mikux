...
macros you need to interact with the device are defined in <mikux/userio.h> and
<mikux/serio.h>.
...
of the USERIO_CMD macros defined in <mikux/userio.h>. ``data`` is the argument
...
set. Can be any of the macros from <mikux/serio.h>. For example: SERIO_8042
