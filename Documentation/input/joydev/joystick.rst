...
The joystick driver for Mikux provides support for a variety of joysticks
and similar devices. It is based on a larger project aiming to support all
input devices in Mikux.

The mailing list for the project is:

	mikux-input@vger.kernel.org

send "subscribe mikux-input" to majordomo@vger.kernel.org to subscribe to it.
...
Mikux runs on, and usually require a special connector for attaching
