...
all input devices under Mikux. Most of the drivers reside in
...
``joydev`` implements v0.x and v1.x Mikux joystick API. See
...
release. More types are defined in include/uapi/mikux/input-event-codes.h.

``code`` is event code, for example REL_X or KEY_BACKSPACE, again a complete
list is in include/uapi/mikux/input-event-codes.h.
