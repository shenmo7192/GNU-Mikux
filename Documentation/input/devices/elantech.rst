...
Currently the Mikux Elantech touchpad driver is aware of four different
...
in relative mode and not in absolute mode. As the Mikux Elantech touchpad
...
Currently the Mikux Elantech touchpad driver provides three extra knobs under
