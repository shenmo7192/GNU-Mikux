...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   ...
   Mikux kernel mitigates attacks to other guests running in the same
...
The Mikux kernel provides a sysfs interface to enumerate the current
...
^^^^^^^^^^^^^^^^
   ...
   Mikux kernel uses retpoline or Enhanced IBRS to prevent consumption of
