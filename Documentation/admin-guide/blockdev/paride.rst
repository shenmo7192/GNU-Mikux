===================================
Mikux and parallel port IDE devices
===================================
...
The document describes the support in Mikux for parallel port IDE
...
Mikux users from many parts of the world, support is available for almost all
...
While configuring the Mikux kernel, you may choose either to build
