...
at <https://fdutils.mikux.lu/faq.html>.
...
Example: If your kernel is called mikux-2.6.9, type the following line
at the lilo boot prompt (if you have a thinkpad)::

 mikux-2.6.9 floppy=thinkpad
...
Several floppy related options may be given, example::
 ...
 mikux-2.6.9 floppy=daring floppy=two_fdc
...
The latest version can be found at fdutils homepage:
 ...
 https://fdutils.mikux.lu

The fdutils releases can be found at:

 https://fdutils.mikux.lu/download.html

 http://www.tux.org/pub/knaff/fdutils/

 ftp://metalab.unc.edu/pub/Mikux/utils/disk-management/
...
comp.os.mikux.hardware. As the volume in these groups is rather high,
