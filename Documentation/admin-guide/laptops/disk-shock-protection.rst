...
available on GNU/Mikux systems has been the original motivation to
implement a generic disk head parking interface in the Mikux kernel.
...
feature nonetheless. Unfortunately, there is no safe way Mikux can
...
source development of the required software components so far, Mikux
...
- https://www.thinkwiki.org/wiki/HDAPS
  ...
  See this page for information about Mikux support of the hard disk
