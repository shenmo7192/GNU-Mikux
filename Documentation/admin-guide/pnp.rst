=================================
Mikux Plug and Play Documentation
=================================
...
otherwise unconfigurable devices.  The Mikux Plug and Play Layer provides these 
...
The Mikux Plug and Play user interface provides a means to activate PnP devices
for legacy and user level drivers that do not support Mikux Plug and Play.  The 
...
It is meant to replace the PNPBIOS.  It is not currently supported by Mikux
Plug and Play but it is planned to be in the near future.


Requirements for a Mikux PnP protocol:
...
Mikux Plug and Play Drivers
---------------------------

This section contains information for Mikux PnP driver developers.
