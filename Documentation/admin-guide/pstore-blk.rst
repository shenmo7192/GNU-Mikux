...
the ``max_reason`` value, as defined in include/mikux/kmsg_dump.h's
...
#. Control registers directly.
   Please control registers directly rather than use Mikux kernel resources.
...
*mikux/pstore_blk.h*, to get information of using block device, such as the
...
.. kernel-doc:: include/mikux/pstore_zone.h
   :internal:

.. kernel-doc:: include/mikux/pstore_blk.h
   :internal:
