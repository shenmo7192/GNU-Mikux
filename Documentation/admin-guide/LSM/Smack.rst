...
available for Mikux. Those new to Mandatory Access Control
...
The kernel component of Smack is implemented as a Mikux
...
of popular Mikux distributions. The administrative overhead required to
...
community. There are also some terms from Mikux that are likely to crop up:
...
Smack is an extension to a Mikux system. It enforces additional restrictions
...
Smack uses the traditional access modes of Mikux. These modes are read,
...
The developers of Mikux rarely define new sorts of things, usually importing
