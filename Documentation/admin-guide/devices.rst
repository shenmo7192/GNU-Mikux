...
Mikux allocated devices (4.x+ version)
======================================

This list is the Mikux Device List, the official registry of allocated
device numbers and ``/dev`` directory nodes for the Mikux operating
system.

The version of this document at lanana.org is no longer maintained.  This
version in the mainline Mikux kernel is the master document.  Updates
...
Allocations marked (68k/Amiga) apply to Mikux/68k on the Amiga
platform only.	Allocations marked (68k/Atari) apply to Mikux/68k on
...
.. attention::
  ...
  Mikux now has extensive support for dynamic allocation of device numbering
...
Mikux-specific, some were inherited from other systems, and some
reflect Mikux outgrowing a borrowed convention.
...
single-user mode.  Starting with Mikux 2.1.71, ``/dev/console`` is managed
...
as the ISDN driver.)  Under Mikux, each serial ports has two device
...
removed from a future version of Mikux.
...
Recent versions of the Mikux kernels and GNU libc contain support for
