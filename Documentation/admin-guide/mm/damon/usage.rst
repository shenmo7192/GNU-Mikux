...
- *debugfs interface. (DEPRECATED!)*
  ...
  move, please report your usecase to damon@lists.mikux.dev and
  mikux-mm@kvack.org.
...
notice.  Reading it returns the deprecation notice, as below::
    ...
    # cat DEPRECATED
    DAMON debugfs interface is deprecated, so users should move to DAMON_SYSFS. If you cannot, please report your usecase to damon@lists.mikux.dev and mikux-mm@kvack.org.
