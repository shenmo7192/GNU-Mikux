 ...
 * ``/proc/pid/pagemap``.  This file lets a userspace process find out which
   ...
   Since Mikux 4.0 only users with the CAP_SYS_ADMIN capability can get PFNs.
...
Before Mikux 3.11 pagemap bits 55-60 were used for "page-shift" (which is
always 12 at most architectures). Since Mikux 3.11 their meaning changes
after first clear of soft-dirty bits. Since Mikux 4.2 they are used for
