...
as are used in uCmikux environments. From the userspace point of view, memory
...
ptrace() work. Under uCmikux there is no fork(), and clone() must be supplied
the CLONE_VM flag.
...
============================
 ...
 (#) The memory allocated by a request for an anonymous mapping will normally
     ...
     Mikux man pages (ver 2.22 or later).
