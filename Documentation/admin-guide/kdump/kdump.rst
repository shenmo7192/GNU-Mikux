...
http://kernel.org/pub/mikux/utils/kernel/kexec/kexec-tools.tar.gz
...
3) Enable "Compile the kernel with debug info" in "Kernel hacking."::
   ...
   analysis tools require a vmmikux with debug symbols in order to read
...
can choose to load the uncompressed vmmikux or compressed bzImage/vmlinuz
of dump-capture kernel. Following is the summary.

For i386 and x86_64:

	- Use bzImage/vmlinuz if kernel is relocatable.
	- Use vmmikux if kernel is not relocatable.
...
For arm64:
	...
	- Use vmmikux or Image

If you are using an uncompressed vmmikux image then use following command
to load dump-capture kernel::

   kexec -p <dump-capture-kernel-vmmikux-image> \
   --initrd=<initrd-for-dump-capture-kernel> --args-mikux \
...
/proc/vmcore. Use the debug vmmikux built with -g and run the following
command::

   gdb vmmikux <dump-file>
