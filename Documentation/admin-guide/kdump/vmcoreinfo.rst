...
The version of the Mikux kernel. Used to find the corresponding source
code from which the kernel has been built. For example, crash uses it to
find the corresponding vmmikux in order to process vmcore.
...
On mikux-2.6.21 or later, the number of free pages is in
