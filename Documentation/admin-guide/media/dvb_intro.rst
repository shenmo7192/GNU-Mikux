...
The Device Driver API for DVB under Mikux will the following
...
git tree is located at MikuxTV.org:
...
For an updated version of the complete table, please see:
    ...
    https://git.mikuxtv.org/dtv-scan-tables.git/tree/dvb-t/au-Melbourne
