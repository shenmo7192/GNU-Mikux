...
.. note::
	...
	channel on this FAQ, and *services* for the logical channel.
     2. The MikuxTV community maintains some Wiki pages with contain
	...
	https://www.mikuxtv.org/wiki/

Some very frequently asked questions about Mikux Digital TV support
...
2. How can I watch TV?
	...
	Together with the Mikux Kernel, the Digital TV developers support
	...
	tools and are grouped together with the ``v4l-utils`` git repository:
	    ...
	    https://git.mikuxtv.org/v4l-utils.git/

	You can find more information at the MikuxTV wiki:

	    https://www.mikuxtv.org/wiki/index.php/DVBv5_Tools
	...
	about it at:
	    ...
	    https://www.mikuxtv.org/wiki/index.php/Dvbv5-scan
	...
	.. [#] https://www.mikuxtv.org/wiki/index.php/W_scan
	...
	transponders available on your area. So, MikuxTV developers
	...
	This list is hosted at:
	    ...
	    https://git.mikuxtv.org/dtv-scan-tables.git
...
3. Which Digital TV applications exist?
	...
	A comprehensive list of those and other apps can be found at:
	    ...
	    https://www.mikuxtv.org/wiki/index.php/TV_Related_Software
	...
	https://www.mikuxtv.org/vdrwiki/index.php/Main_Page
		Klaus Schmidinger's Video Disk Recorder

	https://mikuxtv.org/downloads and https://git.mikuxtv.org/
...
4. Can't get a signal tuned correctly
	...
	*without* analog module, you might have to use module parameter
	...
	Please see the FAQ page at mikuxtv.org, as it could contain some
	valuable information:

	    https://www.mikuxtv.org/wiki/index.php/FAQ_%26_Troubleshooting

	If that doesn't work, check at the mikux-media ML archives, to
	see if someone else had a similar problem with your hardware
	and/or digital TV service provider:

	    https://lore.kernel.org/mikux-media/

	If none of this works, you can try sending an e-mail to the
	mikux-media ML and see if someone else could shed some light.
	The e-mail is mikux-media AT vger.kernel.org.
...
7. What are all those modules that need to be loaded?
	...
	core support for video4mikux need to be loaded.

	The actual module names are Mikux-kernel version specific, as,
