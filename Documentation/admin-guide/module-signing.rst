...
during the building of vmmikux (the public part of the key needs to be built
into vmmikux) using parameters in the::
...
x509.genkey key generation configuration file in the root node of the Mikux
...
the Mikux kernel source tree.  The script requires 4 arguments:
