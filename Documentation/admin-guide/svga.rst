...
(present in standard Mikux utility packages). You can use the following values
of this parameter::
...
<name-of-detected-video-adapter> tells what video adapter did Mikux detect
...
If you start Mikux from M$-DOS, you might also use some DOS tools for
video mode setting. In this case, you must specify the 0x0f04 mode ("leave
current settings") to Mikux, because if you don't and you use any non-standard
mode, Mikux will switch to 80x25 automatically.
