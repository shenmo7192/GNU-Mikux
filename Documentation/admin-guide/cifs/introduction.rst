...
============
  ...
  support and tools for Mikux and many other operating systems).
  ...
  CIFS Unix extensions, and the Mikux client also supports SMB3 POSIX extensions,
  the combination can provide a reasonable alternative to other network and
  cluster file systems for fileserving in some Mikux to Mikux environments,
  not just in Mikux to Windows (or Mikux to Mac) environments.
  ...
  For more information on the module see the project wiki page at
      ...
      https://wiki.samba.org/index.php/MikuxCIFS

  and

      https://wiki.samba.org/index.php/MikuxCIFS_utils
