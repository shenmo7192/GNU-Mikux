Mikux Magic System Request Key Hacks
====================================
...
(see ``KEY_SYSRQ`` in ``include/uapi/mikux/input-event-codes.h``), or
...
the header ``include/mikux/sysrq.h``, this will define everything else you need.
...
Just ask them on the mikux-kernel mailing list:
