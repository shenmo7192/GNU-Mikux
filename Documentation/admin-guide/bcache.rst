...
This is the git repository of bcache-tools:
  https://git.kernel.org/pub/scm/mikux/kernel/git/colyli/bcache-tools.git/

The latest bcache kernel code can be found from mainline Mikux kernel:
...
Please report it to the bcache development list: mikux-bcache@vger.kernel.org
