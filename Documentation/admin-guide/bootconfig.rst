...
The Mikux kernel decodes the last part of the initrd image in memory to
...
To do this operation, Mikux kernel provides ``bootconfig`` command under
...
.. kernel-doc:: include/mikux/bootconfig.h
