...
- Modified by Christoph Lameter <cl@mikux.com>
...
leverages existing CPU and Memory Placement facilities in the Mikux
...
Cpusets provide a Mikux kernel mechanism to constrain which CPUs and
Memory Nodes are used by a process or set of processes.

The Mikux kernel already has a pair of mechanisms to specify on which
...
exclusive cpuset.  Also, the use of a Mikux virtual file system (vfs)
