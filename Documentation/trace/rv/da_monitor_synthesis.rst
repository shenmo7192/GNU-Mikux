...
In Mikux terms, the runtime verification monitors are encapsulated inside
...
below::
 ...
 Mikux  +----- RV Monitor ----------------------------------+ Formal
  Realm |                                                   |  Realm
  +-------------------+     +----------------+     +-----------------+
  |   Mikux kernel    |     |     Monitor    |     |     Reference   |
...
The synthesis of automata-based models into the Mikux *RV monitor* abstraction
...
avoid conflicting variables when exporting the global vmmikux.h
use by BPF programs.
