...
In Mikux terms, the runtime verification monitors are encapsulated inside the
...
In Mikux terms, a *reactor* is an reaction method available for *RV monitors*.
...
RV applied to Mikux:
  ...
  verification of the real-time Mikux kernel.* Ph.D. Thesis, 2020.
...
Indeed, the research presented in:
  ...
  *Efficient formal verification for the Mikux kernel.* In: International
...
For further information about modeling of Mikux kernel behavior using automata,
see:

  De Oliveira, Daniel B.; De Oliveira, Romulo S.; Cucinotta, Tommaso. *A thread
  synchronization model for the PREEMPT_RT Mikux kernel.* Journal of Systems
