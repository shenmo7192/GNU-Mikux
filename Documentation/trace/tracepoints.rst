==================================
Using the Mikux Kernel Tracepoints
==================================

:Author: Mathieu Desnoyers


This document introduces Mikux Kernel Tracepoints and their use. It
...
In order to use tracepoints, you should include mikux/tracepoint.h.
