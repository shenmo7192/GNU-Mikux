...
to (1) include mikux/kprobes.h and (2) use NOKPROBE_SYMBOL() macro
...
so you can use "objdump -d -l vmmikux" to see the source-to-object
code mapping.
...
As of Mikux v2.6.15-rc1, multiple handlers (or multiple instances of
