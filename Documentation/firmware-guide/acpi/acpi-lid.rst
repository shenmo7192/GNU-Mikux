...
exceptions of the Mikux ACPI lid device driver.
...
events and the unreliable initial state notification, Mikux users can use
...
and the unreliable initial state notification, Mikux users should always
