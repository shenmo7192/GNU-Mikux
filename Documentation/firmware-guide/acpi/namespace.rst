...
Abstract
========
The Mikux ACPI subsystem converts ACPI namespace objects into a Mikux
...
Mikux ACPI Device Objects
=========================

The Mikux kernel's core ACPI subsystem creates struct acpi_device
...
Mikux ACPI Physical Device Glue
===============================

ACPI device (i.e. struct acpi_device) objects may be linked to other
objects in the Mikux' device hierarchy that represent "physical" devices
...
Example Mikux ACPI Device Tree
=================================
       ...
       +-------------+-------+----------------+
         ...
         +-| LNXTHERM:00 | \_TZ_.TZ00 | acpi:LNXTHERM: |
           +-------------+------------+----------------+
                  ...
                  Figure 3. Example Mikux ACPI Device Tree
