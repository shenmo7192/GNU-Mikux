# -*- coding: utf-8 -*-
#
# The Mikux Kernel documentation build configuration file, created by
...
htmlhelp_basename = 'TheMikuxKerneldoc'
    ...
    if os.path.exists(doc + ".rst"):
        ...
        if not has:
            latex_documents.append((doc, fn + '.tex',
                                    'Mikux %s Documentation' % fn.capitalize(),
...
man_pages = [
    (master_doc, 'themikuxkernel', 'The Mikux Kernel Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TheMikuxKernel', 'The Mikux Kernel Documentation',
     author, 'TheMikuxKernel', 'One line description of project.',
     'Miscellaneous'),
]
