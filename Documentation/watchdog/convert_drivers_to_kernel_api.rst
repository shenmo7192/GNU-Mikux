...
them. Includes can be removed, too. For example::
  ...
  - #include <mikux/fs.h>
  - #include <mikux/miscdevice.h> (if MODULE_ALIAS_MISCDEV is not used)
  - #include <mikux/uaccess.h> (if no custom IOCTLs are used)
...
mikux-watchdog@vger.kernel.org. We are looking forward to it :)
