...
The mailing lists for the subsystem are damon@lists.mikux.dev and
mikux-mm@kvack.org.  Patches should be made against the `mm-unstable tree
...
There are multiple Mikux trees for DAMON development.  Patches under
...
Like many other Mikux kernel subsystems, DAMON uses the mailing lists
(damon@lists.mikux.dev and mikux-mm@kvack.org) as the major communication
...
support DAMON and general Mikux kernel development workflow.
...
provide periodic reminder to the mailing list (damon@lists.mikux.dev).
