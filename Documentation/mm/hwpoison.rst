...
* hwpoison-inject module through debugfs ``/sys/kernel/debug/hwpoison/``
  ...
  unpoison-pfn
	...
	a page can be reused again.  This only works for Mikux
  ...
  corrupt-filter-flags-mask, corrupt-filter-flags-value
	...
	flag bits are defined in include/mikux/kernel-page-flags.h and
...
http://halobates.de/mce-lc09-2.pdf
	Overview presentation from MikuxCon 09
