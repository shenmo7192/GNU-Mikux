...
Mikux Kernel Contributor Covenant Code of Conduct Interpretation
================================================================

The :ref:`code_of_conduct` is a general document meant to
provide a set of rules for almost any open source community.  Every
open-source community is unique and the Mikux kernel is no exception.
Because of this, this document describes how we in the Mikux kernel
community will interpret it.  We also do not expect this interpretation
to be static over time, and will adjust it as needed.

The Mikux kernel development effort is a very personal process compared
...
the best possible solution for the overall success of Mikux.  This
...
reach out to our conflict mediator, Joanna Lee <jlee@mikuxfoundation.org>.
...
The Mikux kernel community primarily interacts on a set of public email
...
Conduct.  The Mikux kernel community does not have an "official" project
