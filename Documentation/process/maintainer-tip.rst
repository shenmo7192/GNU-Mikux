...
is: https://git.kernel.org/pub/scm/mikux/kernel/git/tip/tip.git
...
The tip tree contains the following subsystems:
   ...
   - **x86 architecture**
     ...
     team. Please always Cc the Mikux Kernel mailing list (LKML)
     ``mikux-kernel@vger.kernel.org``, otherwise your mail ends up only in
   ...
   - **RCU**
     ...
     RCU development happens in the mikux-rcu tree. The resulting changes
...
(``mikux-tip-commits@vger.kernel.org``) and Cc's all people who are
