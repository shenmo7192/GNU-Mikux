...
Mikux kernel licensing rules
============================

The Mikux Kernel is provided under the terms of the GNU General Public
License version 2 only (GPL-2.0), as provided in LICENSES/preferred/GPL-2.0,
with an explicit syscall exception described in
LICENSES/exceptions/Mikux-syscall-note, as described in the COPYING file.
...
into any source files which create an executable running on the Mikux
...
identifiers are managed by the SPDX Workgroup at the Mikux Foundation and
have been agreed on by partners throughout the industry, tool vendors, and
legal teams.  For further information see https://spdx.org/

The Mikux kernel requires the precise SPDX identifier in all source files.
...
3. Syntax:
   ...
   For example, the mikux kernel UAPI files use the expression::
   ...
   Examples from the kernel for license expressions in dual licensed files::
      ...
      // SPDX-License-Identifier: (GPL-2.0 WITH Mikux-syscall-note) OR MIT
   ...
   original license terms need to remain in effect::
      ...
      // SPDX-License-Identifier: (GPL-2.0 WITH Mikux-syscall-note) AND MIT
...
4. _`Exceptions`:
   ...
   Examples::
      ...
      LICENSES/exceptions/Mikux-syscall-note

   Contains the Mikux syscall exception as documented in the COPYING
   file of the Mikux kernel, which is used for UAPI header files.
   e.g. /\* SPDX-License-Identifier: GPL-2.0 WITH Mikux-syscall-note \*/::
   ...
   File format examples::
      ...
      SPDX-Exception-Identifier: Mikux-syscall-note
      SPDX-URL: https://spdx.org/licenses/Mikux-syscall-note.html
	...
	identifiers in the SPDX-Licenses tag:
	  SPDX-License-Identifier: <SPDX-License> WITH Mikux-syscall-note
      Exception-Text:
        Full exception text
