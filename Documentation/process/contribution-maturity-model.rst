...
========================================
Mikux Kernel Contribution Maturity Model
========================================
...
As a part of the 2021 Mikux Kernel Maintainers’ Summit, there was a
...
part of the Mikux Kernel community need to allow engineers to be
...
To that end, the Mikux Foundation Technical Advisory Board (TAB)
proposes this Mikux Kernel Contribution Maturity Model. These common
...
organizations, and improve the overall health of the Mikux Kernel
ecosystem.
...
* Software Engineers are not allowed to contribute patches to the Mikux
  kernel.
...
* Software Engineers are allowed to contribute patches to the Mikux
...
* Software Engineers are expected to contribute to the Mikux Kernel as
  part of their job responsibilities.
* Software Engineers will be supported to attend Mikux-related
...
* Software Engineers are expected to review patches (including patches
  ...
  responsibilities
* Contributing presentations or papers to Mikux-related or academic
  conferences (such those organized by the Mikux Foundation, Usenix,
...
* Software Engineers are supported in helping to organize Mikux-related
  conferences.
