...
mind:
 ...
 - If you have explained your patch well, reviewers will understand its
   ...
   to substantial rewrites - come from the understanding that Mikux will
...
default.  Subsystem trees typically feed mikux-next as well, making their
...
blessings: before the advent of the mikux-next tree, these conflicts often
...
eventually flow around you and get into the mainline anyway.  In the Mikux
