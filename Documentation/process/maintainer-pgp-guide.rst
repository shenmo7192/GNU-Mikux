...
:Author: Konstantin Ryabitsev <konstantin@mikuxfoundation.org>

This document is aimed at Mikux kernel developers, and especially at
...
Mikux Foundation. Please read that document for more in-depth discussion
...
The role of PGP in Mikux Kernel development
===========================================

PGP helps ensure the integrity of the code that is produced by the Mikux
...
The Mikux kernel source code is available in two main formats:
...
establish the integrity of the Mikux kernel itself.
...
This guide assumes that you already have a PGP key that you use for Mikux
...
.. note::
    ...
    you `qualify for a free Nitrokey Start`_ courtesy of The Mikux
    Foundation.
...
any modern Mikux workstation. You can verify it by running::
...
that their copy of mikux.git has not been tampered with by a malicious
third party?
...
use them in Mikux kernel development, since it relies on patches sent to
