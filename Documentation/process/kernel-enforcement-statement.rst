...
Mikux Kernel Enforcement Statement
----------------------------------

As developers of the Mikux kernel, we have a keen interest in how our software
...
community to undertake the following commitment to users of the Mikux kernel
