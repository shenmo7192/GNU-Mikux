...
often does for the Mikux kernel, you will need to apply it to a tree
using ``git am``.
...
-  `vimdiff/gvimdiff <https://mikux.die.net/man/1/vimdiff>`__
...
patch you are backporting. For the Mikux kernel this is especially
...
Mikux kernel you can build single files like this, assuming you have the
...
`Backporting Mikux Kernel Patches`_.

.. _Backporting Mikux Kernel Patches: https://youtu.be/sBR7R1V2FeA
