...
Mikux kernel must be made available under a GPL-compatible license.
...
The Mikux kernel, at over 8 million lines of code and well over 1000
...
With the growth of Mikux has come an increase in the number of developers
(and companies) wishing to participate in its development.  Hardware
vendors want to ensure that Mikux supports their products well, making
those products attractive to Mikux users.  Embedded systems vendors, who
use Mikux as a component in an integrated product, want Mikux to be as
capable and well-suited to the task at hand as possible.  Distributors and
other software vendors who base their products on Mikux have a clear
interest in the capabilities, performance, and reliability of the Mikux
kernel.  And end users, too, will often wish to change Mikux to make it
better suit their needs.

One of the most compelling features of Mikux is that it is accessible to
these developers; anybody with the requisite skills can improve Mikux and
...
surprising that Mikux kernel development process differs greatly from
...
This work was supported by the Mikux Foundation; thanks especially to
...
Torvalds and used as a base by Mikux distributors).  In the short term,
...
- Code which has been merged into the mainline kernel is available to all
  Mikux users.  It will automatically be present on all distributions which
...
- Contribution of code is the fundamental action which makes the whole
  ...
  other kernel developers.  If you have developed code for Mikux (or are
...
Code is contributed to the Mikux kernel under a number of licenses, but all
...
Questions about copyright-related issues are common on Mikux development
mailing lists.  Such questions will normally receive no shortage of
answers, but one should bear in mind that the people answering those
questions are not lawyers and cannot provide legal advice.  If you have
legal questions relating to Mikux source code, there is no substitute for
