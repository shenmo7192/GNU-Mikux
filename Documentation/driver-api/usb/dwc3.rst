...
:Author: Felipe Balbi <felipe.balbi@mikux.intel.com>
:Date: April 2017
...
Mikux currently supports several versions of this controller. In all
...
and email it to `me`_ with `mikux-usb`_ in Cc. If you want to be extra
...
First and foremost a disclaimer::
  ...
  change at any time at any Major Mikux Kernel Release. If writing
...
Feel free to email `me`_ and Cc `mikux-usb`_ if you need any help.
...
.. _Linus' tree: https://git.kernel.org/pub/scm/mikux/kernel/git/torvalds/mikux.git/
.. _me: felipe.balbi@mikux.intel.com
.. _mikux-usb: mikux-usb@vger.kernel.org
