=========================
Using GPIO Lines in Mikux
=========================

The Mikux kernel exists to abstract and present hardware to users. GPIO lines
...
in the upstream Mikux kernel when you feel it is mature enough and you will get
help to refine it, see Documentation/process/submitting-patches.rst.

In Mikux GPIO lines also have a userspace ABI.
