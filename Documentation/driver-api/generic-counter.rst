...
by including the include/mikux/counter.h header file. This header file
provides several core data structures, function prototypes, and macros
for defining a counter device.

.. kernel-doc:: include/mikux/counter.h
   :internal:
...
userspace ``include/uapi/mikux/counter.h`` file.
...
supported and provided by the ``mikux/counter.h`` userspace header file:
