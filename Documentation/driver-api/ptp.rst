...
===========================================
PTP hardware clock infrastructure for Mikux
===========================================

  This patch set introduces support for IEEE 1588 PTP clocks in
  Mikux. Together with the SO_TIMESTAMPING socket options, this
  presents a standardized method for developing PTP user space
  programs, synchronizing Mikux with external clocks, and using the
  ...
  + Ancillary clock features
    ...
    - Synchronization of the Mikux system time via the PPS subsystem
...
=====================
   ...
   Clock drivers include include/mikux/ptp_clock_kernel.h and register
