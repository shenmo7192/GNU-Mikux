...
a normal keyboard or mouse is handled internally on Mikux\ [#f1]_. So, the
remote controller core is implemented on the top of the mikux input/evdev
interface.
...
to convert into a Mikux input event code. This is done via a mapping
table.
