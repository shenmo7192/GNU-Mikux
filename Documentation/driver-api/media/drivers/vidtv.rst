...
<https://mikuxtv.org/wiki/index.php/V4l-utils>`_.

From its webpage::

	The v4l-utils are a series of packages for handling media devices.

	It is hosted at http://git.mikuxtv.org/v4l-utils.git, and packaged
...
<https://www.mikuxtv.org/wiki/index.php/Dvb-fe-tool>`_.
...
<https://git.mikuxtv.org/dtv-scan-tables.git>`_.
...
Assuming this channel is named 'channel.conf', you can then run::
	...
	Service Beethoven, provider MikuxTV.org: digital television

For more information on dvb-scan, check its documentation online here:
`dvb-scan Documentation <https://www.mikuxtv.org/wiki/index.php/Dvbscan>`_.
...
<https://www.mikuxtv.org/wiki/index.php/Dvbv5-zap>`_.
See also: `zap <https://www.mikuxtv.org/wiki/index.php/Zap>`_.
...
This might optionally use the Video4Mikux2 Test Pattern Generator, v4l2-tpg,
which resides at::
