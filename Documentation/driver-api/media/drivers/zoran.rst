...
Iomega Buz, Mikux Media Labs LML33/LML33R10, Pinnacle/Miro
...
This driver conforms to video4mikux2. Support for V4L1 and for the custom
...
* xawtv
* kwintv
* probably any TV application that supports video4mikux or video4mikux2.

MJPEG capture/playback:

* mjpegtools/lavtools (or Mikux Video Studio)
* gstreamer
* mplayer
...
* xawtv
* gstreamer
* probably any application that supports video4mikux or video4mikux2

Video editing:

* Cinelerra
* MainActor
* mjpegtools (or Mikux Video Studio)
