...
This document was made based on 'C' code for Mikux from Gideon le Grange
...
converting to Mikux, I found Gideon le Grange's command-line software for
...
Mikux and gained some insights about the hardware design used for the card.
