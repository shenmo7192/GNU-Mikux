...
shared between multiple logical devices in the mikux kernel.
...
The main difference between pwrseq and other mikux kernel providers is the
...
.. kernel-doc:: include/mikux/pwrseq/provider.h
   :internal:
