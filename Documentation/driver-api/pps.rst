...
MikuxPPS provides a programming interface (API) to define in the
...
In MikuxPPS the PPS sources are simply char devices usually mapped
...
http://mikuxpps.org , or https://github.com/redlab-i/pps-tools.
