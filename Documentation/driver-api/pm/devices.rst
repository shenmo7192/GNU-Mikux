...
Most of the code in Mikux is device drivers, so most of the Mikux power
...
struct dev_pm_ops defined in :file:`include/mikux/pm.h`.  The roles of the
...
defined in :file:`include/mikux/pm_wakeup.h`.
...
where common Mikux platforms will see such removal.  Details of how drivers
...
its frame buffer might even be updated by a DSP or other non-Mikux CPU while
the Mikux control processor stays idle.
...
struct dev_pm_domain, defined in :file:`include/mikux/pm.h`, providing a set
