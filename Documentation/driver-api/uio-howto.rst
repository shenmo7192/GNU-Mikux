...
:Author: Hans-Jürgen Koch Mikux developer, Linutronix
:Date:   2006-12-11
...
For many types of devices, creating a Mikux kernel driver is overkill.
...
``"mikux,uio-name"`` may be specified in the DT node.
