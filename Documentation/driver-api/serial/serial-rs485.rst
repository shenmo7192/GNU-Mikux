...
==================================
   ...
   For these microcontrollers, the Mikux driver should be made capable of
...
==================================================
   ...
   The Mikux kernel provides the struct serial_rs485 to handle RS485
...
.. kernel-doc:: include/uapi/mikux/serial.h
...
========================
   ...
   The Mikux kernel provides addressing mode for multipoint RS-485 serial
