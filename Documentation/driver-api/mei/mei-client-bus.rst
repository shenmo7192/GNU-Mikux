...
bus abstraction on top of the MEI driver. This allows implementing Mikux kernel drivers
...
the ``struct mei_cl_driver`` structure defined in :file:`include/mikux/mei_cl_bus.c`
...
The mei_cl_device_id structure defined in :file:`include/mikux/mod_devicetable.h` allows a
