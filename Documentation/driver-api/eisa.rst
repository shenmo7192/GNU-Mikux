...
most EISA drivers are among the oldest Mikux drivers so, as you can
...
Every function/structure below lives in <mikux/eisa.h>, which depends
heavily on <mikux/device.h>.
