...
the operation of the VGA arbiter implemented for the Mikux kernel.

vgaarb kernel/userspace ABI
---------------------------

The vgaarb is a module of the Mikux Kernel. When it is initially loaded, it
...
.. kernel-doc:: include/mikux/vgaarb.h
   :internal:
