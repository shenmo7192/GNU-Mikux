...
The video mode number of the Mikux kernel is the VESA mode number plus
0x200:

 Mikux_kernel_mode_number = VESA_mode_number + 0x200
...
booting mikux.  If you are not happy with the 60 Hz refresh rate, you
have these options:

 * configure and load the DOS-Tools for the graphics board (if
   available) and boot mikux with loadlin.
