...
FOURCC definitions are located in the mikux/videodev2.h header. However, and
...
the colorspace field to one of the colorspaces listed in mikux/videodev2.h and
