...
It is also necessary to know how to access Mikux devices and how to
...
extension of the Video4Mikux API which was primarily developed for frame
...
standard Mikux Digital TV API. As a commitment to the development of terminals
based on open standards, Nokia and Convergence made it available to all
Mikux developers and published it on https://mikuxtv.org in September
2000. With the Mikux driver for the Siemens/Hauppauge DVB PCI card,
Convergence provided a first implementation of the Mikux Digital TV API.
Convergence was the maintainer of the Mikux Digital TV API in the early
days.

Now, the API is maintained by the MikuxTV community (i.e. you, the reader
of this document). The Mikux  Digital TV API is constantly reviewed and
...
Mikux Digital TV Devices
========================

The Mikux Digital TV API lets you control these hardware components through
...
.. code-block:: c
	...
	#include <mikux/dvb/ca.h>

	#include <mikux/dvb/dmx.h>

	#include <mikux/dvb/frontend.h>

	#include <mikux/dvb/net.h>


To enable applications to support different API version, an additional
include file ``mikux/dvb/version.h`` exists, which defines the constant
