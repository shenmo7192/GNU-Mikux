...
visible through the standard Mikux network protocol stack.
...
In order to create the Mikux virtual network interfaces, an application
...
Data types and ioctl definitions are defined via ``mikux/dvb/net.h``
header.
