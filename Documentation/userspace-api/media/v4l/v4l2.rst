...
############################
Part I - Video for Mikux API
############################

This part describes the Video for Mikux API version 2 (V4L2 API) specification.
...
will be used by the Mikux Kernel. Also added Remote Controller chapter.
