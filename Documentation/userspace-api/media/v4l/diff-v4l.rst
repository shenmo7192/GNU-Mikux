...
The Video For Mikux API was first introduced in Mikux 2.1 to unify and
replace various TV and radio device related interfaces, developed
independently by driver writers in prior years. Starting with Mikux 2.5
...
Undocumented in the V4L specification, in Mikux 2.3 the
