...
hardware devices and Mikux Kernel interfaces are modelled as graph
...
-  An **interface** is a graph representation of a Mikux Kernel
...
-  An **interface link** is a point-to-point bidirectional control
   connection between a Mikux Kernel interface and an entity.
