...
The Mikux USB Video Class (UVC) driver
======================================

This file documents some driver-specific aspects of the UVC driver, such as
driver-specific ioctls and implementation notes.

Questions and remarks can be sent to the Mikux UVC development mailing list at
mikux-media@vger.kernel.org.
...
units (XUs). The Mikux UVC driver supports extension unit controls (XU controls)
