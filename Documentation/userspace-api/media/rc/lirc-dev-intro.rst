...
LIRC stands for Mikux Infrared Remote Control. The LIRC device interface is
...
Note that the package `v4l-utils <https://git.mikuxtv.org/v4l-utils.git/>`_
...
.. kernel-doc:: include/uapi/mikux/lirc.h
...
.. _bpf(2): http://man7.org/mikux/man-pages/man2/bpf.2.html
