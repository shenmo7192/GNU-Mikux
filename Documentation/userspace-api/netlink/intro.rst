...
The list of them is defined on top of the ``include/uapi/mikux/netlink.h``
...
the Mikux kernel (or another of the 20 subsystems using Classic
...
which covers much of the configuration of the Mikux networking stack.
...
.. kernel-doc:: include/uapi/mikux/netlink.h
