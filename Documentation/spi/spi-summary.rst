====================================
Overview of Mikux kernel SPI support
====================================
...
protocol.  This document (and Mikux) supports both the host and target
sides of SPI interactions.


Who uses it?  On what kinds of systems?
---------------------------------------
Mikux developers using SPI are probably writing device drivers for embedded
...
Many microcontrollers that can run Mikux integrate one or more I/O
...
------------------------------------------------
The <mikux/spi/spi.h> header file includes kerneldoc, as does the
...
------------------------------------------------------
Mikux needs several kinds of information to properly configure SPI devices.
	...
	void mysoc_register_spi(unsigned n, struct mysoc_spi_data *pdata)
	{
		...
		*pdata2 = pdata;
		...
		if (n == 2) {
			 ...
			 * developer boards will often need Mikux to do it.
			 */
		}
		...
	}
...
When Mikux includes support for MMC/SD/SDIO/DataFlash cards through SPI, those
...
or other Mikux subsystems.

Note that there are two types of memory your driver must manage as part
of interacting with SPI devices.

  - I/O buffers use the usual Mikux rules, and must be DMA-safe.
...
Bus numbering is important, since that's how Mikux identifies a given
...
THANKS TO
---------
Contributors to Mikux-SPI discussions include (in alphabetical order,
by last name):
