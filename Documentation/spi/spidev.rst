...
::
	...
	#include <mikux/spi/spidev.h>

Some reasons you might want to use this programming interface include:

 * Prototyping in an environment that's not crash-prone; stray pointers
   in userspace won't normally bring down any Mikux system.
...
post a patch for spidev to the mikux-spi@vger.kernel.org mailing list.
...
is no longer supported by the Mikux kernel and instead a real SPI device
...
Since this is a standard Mikux device driver -- even though it just happens
