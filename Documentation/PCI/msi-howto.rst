...
To get the Mikux IRQ numbers passed to request_irq() and free_irq() and the
...
necessary to disable interrupts (Mikux guarantees the same interrupt will
...
FADT table.  In this case, Mikux automatically disables MSIs.
...
in your best interests to report the problem to mikux-pci@vger.kernel.org
...
Mikux mostly knows about them and automatically enables MSIs if it can.
If you have a bridge unknown to Mikux, you can enable
...
Again, please notify mikux-pci@vger.kernel.org of any bridges that need
special handling.
