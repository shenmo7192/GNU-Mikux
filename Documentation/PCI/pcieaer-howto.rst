...
Include the PCIe AER Root Driver into the Mikux Kernel
------------------------------------------------------
...
Some systems have AER support in firmware. Enabling Mikux AER support at
the same time the firmware handles AER would result in unpredictable
behavior. Therefore, Mikux does not handle AER events unless the firmware
