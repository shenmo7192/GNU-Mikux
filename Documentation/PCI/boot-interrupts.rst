...
:Author: - Sean V Kelley <sean.v.kelley@mikux.intel.com>
...
interrupt goes unhandled over time, they are tracked by the Mikux kernel as
Spurious Interrupts. The IRQ will be disabled by the Mikux kernel after it
...
disabled, the Mikux kernel will reroute the valid interrupt to its legacy
