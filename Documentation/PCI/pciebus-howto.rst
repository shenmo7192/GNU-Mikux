...
In existing Mikux kernels, the Mikux Device Driver Model allows a
...
PCI device drivers are implemented based on Mikux Device Driver Model.
...
header file /include/mikux/pcieport_if.h, before calling these APIs.
...
This API replaces the Mikux Driver Model's pci_register_driver API. A
...
pcie_port_service_unregister replaces the Mikux Driver Model's
