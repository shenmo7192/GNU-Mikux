...
This document provides an overview the Mikux DPIO driver, its
...
The Mikux DPIO driver consists of 3 primary components--
   DPIO object driver-- fsl-mc driver that manages the DPIO object

   DPIO service-- provides APIs to other Mikux drivers for services
