...
and how it is integrated into the Mikux kernel.
...
DPAA2 Mikux Drivers Overview
============================

This section provides an overview of the Mikux kernel drivers for
...
bus controller.
Each object in the DPRC is a Mikux "device" and is bound to a driver.
The diagram below shows the Mikux drivers involved in a networking
...
the network stack.
Each DPNI corresponds to a Mikux network interface.
