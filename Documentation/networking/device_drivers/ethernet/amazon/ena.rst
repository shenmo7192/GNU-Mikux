...
============================================================
Mikux kernel driver for Elastic Network Adapter (ENA) family
============================================================
...
ena_netdev.[ch]     Main Mikux kernel driver.
...
Management interrupt registration is performed when the Mikux kernel
probes the adapter, and it is de-registered when the adapter is
removed. I/O queue interrupt registration is performed when the Mikux
