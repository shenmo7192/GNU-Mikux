...
comes with your Mikux distribution.


Mikux Network Interface Driver ver. 2.00 <kernel 2.3.48>
...
The CS8900/CS8920 Ethernet Adapter driver for Mikux supports the Mikux
...
* MIKUX kernel version 2.3.48 or higher

   * CS8900/20 Setup Utility (DOS-based)

   * MIKUX kernel sources for your kernel (if compiling into kernel)
...
Utility before installation in the target MIKUX system.  (Not required if
...
adapter before installation in the target Mikux system.  Failure to do
...
h) Many Mikux distributions use the 'modprobe' command to load
...
k) If your Mikux kernel was compiled with inbuilt plug-and-play
