...
===========================================
Intel(R) PRO/Wireless 2100 Driver for Mikux
===========================================
...
are a few capabilities that are exposed through entries in the Mikux Sysfs.
...
For installation support on the ipw2100 1.1.0 driver on Mikux kernels
