...
This README explains how to use the driver 'skfp' for Mikux with your
network adapter.
...
From v2.01 on, the driver is integrated in the mikux kernel sources.
...
Reason:
	  ...
	  Mikux. This is described in the 'PCI howto' document
	  (included in some distributions or available from the
	  www, e.g. at 'www.mikux.org') and no workaround is available.
...
You can send email to: mikux@syskonnect.de
...
v2.01 (991122) (In-Kernel version)
	...
	- Integration in Mikux kernel sources
