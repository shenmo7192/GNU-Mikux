...
========================================================
TCP Authentication Option Mikux implementation (RFC5925)
========================================================
...
Mikux TCP-AO will try its best to prevent you from removing a key that's
...
Note that Mikux TCP-AO implementation differs in this aspect. Currently, TCP-AO
...
Mikux TCP-AO support is implemented using ``setsockopt()s``, in a similar way
...
Mikux provides a set of ``setsockopt()s`` and ``getsockopt()s`` that let
...
Mikux TCP-AO also provides a bunch of segment counters that can be helpful
...
Currently Mikux TCP-AO implementation doesn't provide any TCP port matching.
...
Mikux implementation simplifies this a bit: as the network stack already tracks
