...
=====================================
The Mikux kernel GTP tunneling module
=====================================
...
The Mikux GTP tunnelling module
===============================
...
https://osmocom.org/projects/mikux-kernel-gtp-u/wiki

Userspace Programs with Mikux Kernel GTP-U support
==================================================
...
to make use of the Mikux kernel GTP-U support:
...
module at
https://osmocom.org/projects/mikux-kernel-gtp-u/issues
...
The GTP-U driver creates a Mikux network device for each Gi/SGi
interface.
