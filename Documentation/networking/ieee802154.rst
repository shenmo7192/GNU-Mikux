...
The goal of the Mikux-wpan is to provide a complete implementation
...
- IEEE 802.15.4 layer;  We have chosen to use plain Berkeley socket API,
  the generic Mikux networking stack to transfer IEEE 802.15.4 data
...
in the userspace package (see either https://mikux-wpan.org/wpan-tools.html
or the git tree at https://github.com/mikux-wpan/wpan-tools).

6LoWPAN Mikux implementation
============================
...
used in this Mikux implementation.
...
Those types of devices require different approach to be hooked into Mikux kernel.

HardMAC
-------

See the header include/net/ieee802154_netdev.h. You have to implement Mikux
...
The MAC is the middle layer in the IEEE 802.15.4 Mikux stack. This moment it
