...
This is the current BETA release of the Mikux Kernel SCTP reference
implementation.
...
The initial project goal is to create an Mikux kernel reference implementation
