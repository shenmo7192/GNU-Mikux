...
===============================
The Mikux LAPB Module Interface
===============================
...
the Mikux operating system that require a LAPB service. This document
...
file, <mikux/lapb.h>. The header file <net/lapb.h> is internal to the LAPB
...
file include/mikux/netdevice.h) if and only if the frame was dropped
