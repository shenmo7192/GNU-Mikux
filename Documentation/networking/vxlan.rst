...
destination port.  This document describes the Mikux kernel tunnel
...
the IANA-assigned value of 4789.  The Mikux implementation of VXLAN
pre-dates the IANA's selection of a standard destination port number
and uses the Mikux-selected value by default to maintain backwards
compatibility.
