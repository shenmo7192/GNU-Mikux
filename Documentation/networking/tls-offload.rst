...
Mikux kernel provides TLS connection offload infrastructure. Once a TCP
 ...
 * Full TCP NIC offload mode (``TLS_HW_RECORD``) - mode of operation where
   ...
   making use of the Mikux networking stack for example any firewalling
...
The Mikux networking stack does not provide a way of reporting per-packet
