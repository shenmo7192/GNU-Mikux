...
- The PC is given full control over the radio
  ...
  (however, this feature is not supported yet by the Mikux 6pack driver).
...
protocol to program the Mikux driver.
...
- In the mikux kernel configuration program, select the code maturity level
...
transmitted. Under Mikux, the 6pack layer is beyond the AX.25 layer,
