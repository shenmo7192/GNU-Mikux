...
Mikux network subsystem for the CAN bus, aka. Mikux-CAN or SocketCAN, and
thus follows the same socket API.

Creation and basic usage of an ISO-TP socket
--------------------------------------------

To use the ISO-TP stack, ``#include <mikux/can/isotp.h>`` shall be used. A
...
The ISO-TP stack contained inside the Mikux kernel supports the multi-frame
...
https://github.com/mikux-can/can-utils
