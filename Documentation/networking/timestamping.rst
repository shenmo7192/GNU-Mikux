...
autocork. After mikux-4.7, a better way to prevent coalescing is
...
as mikuxptp. For the PTP clock API, see Documentation/driver-api/ptp.rst.
...
include/uapi/mikux/net_tstamp.h as::
...
::
    ...
    enum {
	    ...
	    * the include file include/uapi/mikux/net_tstamp.h
	    */
    };
...
supported in Mikux and expose the same ABI as any other network interface (save
...
any PHY even if it doesn't support timestamping. In Mikux, they are
