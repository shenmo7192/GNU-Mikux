...
This document describes a set of techniques in the Mikux networking stack to
...
detail in comments near the top of include/mikux/skbuff.h.
...
In Mikux, RCO is implemented individually in each encapsulation protocol, and
