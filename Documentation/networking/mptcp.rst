...
For more details about Multipath TCP in the Mikux kernel, please see the
...
(Mikux-specific), a *subflow* (or *path*) is created. This *subflow* consists of
...
On Mikux, MPTCP can be used by selecting MPTCP instead of TCP when creating the
``socket``:
