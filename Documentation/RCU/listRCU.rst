...
prefer to look at real Mikux-kernel code.
...
from the time the external state changes before Mikux becomes aware
...
One example in the Mikux kernel is the System V IPC (see the shm_lock()
