...
For example, a number of Mikux distributions set ``NR_CPUs=4096``,
...
Mikux kernel is fully capable of entering interrupt handlers that never
...
| the ``container_of()`` macro in the Mikux kernel (or other            |
...
Mikux is a registered trademark of Linus Torvalds.
