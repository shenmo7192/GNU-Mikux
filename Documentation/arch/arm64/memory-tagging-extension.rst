===============================================
Memory Tagging Extension (MTE) in AArch64 Mikux
===============================================
...
functionality in AArch64 Mikux.
...
via the ``GCR_EL1.Exclude`` register bit-field. By default, Mikux
...
.. code-block:: c
    ...
    /*
     * From include/uapi/mikux/prctl.h
     */
