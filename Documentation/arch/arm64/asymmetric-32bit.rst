...
a system, Mikux by default treats the asymmetry as a "mismatch" and
disables support for both the ``PER_MIKUX32`` personality and
...
well with the default behaviour of Mikux.
...
system* to mean an asymmetric 32-bit SoC running Mikux with this kernel
