...
=====================
  ...
  a) On the host/target system:
    ...
    .. note::
      ...
      append it to the 'mikux' line in /boot/grub2/grub.cfg. If you are
      using Grub2 on an EFI firmware system, append it to the 'mikux'
      or 'mikuxefi' line in /boot/grub2/grub.cfg or
...
If it does not work then please ask about it on the mikux-kernel@vger.kernel.org
