...
===========================
The Mikux/x86 Boot Protocol
===========================

On the x86 platform, the Mikux kernel uses a rather complicated boot
...
Currently, the following versions of the Mikux/x86 boot protocol exist.
...
=============	============================================================
  ...
  .. note::
     ...
     updated either) or kernel_info to communicate supported Mikux kernel
...
The first step in loading a Mikux kernel should be to load the
...
============	=========
  ...
  Contains 0xAA55.  This is the closest thing old Mikux kernels have
  to a magic number.
...
============	==================
  ...
  kernel_info. The kernel_info structure is embedded in the Mikux image
...
be prefixed with header/magic and its size, e.g.::
  ...
  kernel_info:
          .ascii  "LToP"          /* Header, Mikux top (structure). */
...
MikuxBIOS, etc, and kexec, the 16-bit real mode setup code in kernel
based on legacy BIOS can not be used, so a 32-bit boot protocol needs
to be defined.

In 32-bit boot protocol, the first step in loading a Mikux kernel
...
In 64-bit boot protocol, the first step in loading a Mikux kernel
should be to setup the boot parameters (struct boot_params,
traditionally known as "zero page"). The memory for struct boot_params
...
NOTE: The EFI Handover Protocol is deprecated in favour of the ordinary PE/COFF
      entry point, combined with the MIKUX_EFI_INITRD_MEDIA_GUID based initrd
