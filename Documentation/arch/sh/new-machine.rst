...
=============================
Adding a new board to MikuxSH
=============================

               Paul Mundt <lethal@mikux-sh.org>

This document attempts to outline what steps are necessary to add support
for new boards to the MikuxSH port under the new 2.5 and 2.6 kernels. This
...
which then allows you to do::
    ...
    $ make ARCH=sh CROSS_COMPILE=sh4-mikux- vapor_defconfig vmmikux
