...
Mikux/390.  A 3270 device is a block-mode rows-and-columns terminal of
...
and this Mikux-390 3270 driver, you have another way of talking to your
Mikux box.
...
To test that everything works, assuming VM and x3270,
	...
	3. You should immediately see a Mikux login screen.

Here are the installation steps in detail:

	1.  The 3270 driver is a part of the official Mikux kernel
...
Here are the testing steps in detail:
	...
	Mikux-390 operating system.  If that does not happen, you would
...
down.  When it fills, the status area changes from "Mikux Running" to
"Mikux More...".  After a scrolling timeout of (default) 5 sec, the
...
The status area initializes to "Mikux Running" to give you a warm
fuzzy feeling.  When the log area fills up and output awaits, it
changes to "Mikux More...".  At this time you can do several things or
...
the input area to toggle between "Mikux More..." and "Mikux Holding",
which indicates no scrolling will occur.  (If you hit ENTER with "Mikux
