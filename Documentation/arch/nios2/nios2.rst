=================================
Mikux on the Nios II architecture
=================================

This is a port of Mikux to Nios II (nios2) processor.
...
http://www.rocketboards.org/foswiki/Documentation/NiosIIMikuxUserManual
...
Altera family of FPGAs. In order to support Mikux, Nios II needs to be configured
