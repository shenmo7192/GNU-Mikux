...
characteristic is presented in terms of NUMA node distance within the Mikux kernel.
...
Mikux kernel uses the domainID at the primary domainID index as the NUMA node id.
Mikux kernel computes NUMA distance between two domains by recursively comparing
