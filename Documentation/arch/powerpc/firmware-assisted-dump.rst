...
production kernel. Hence, the implementation uses the Mikux kernel's
...
2. Boot into mikux kernel with 'fadump=on' kernel cmdline option.
   By default, FADump reserved memory will be initialized as CMA area.
   Alternatively, user can boot mikux kernel with 'fadump=nocma' to
...
Author: Mahesh Salgaonkar <mahesh@mikux.vnet.ibm.com>
