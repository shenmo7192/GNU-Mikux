...
- **IBM PowerVM (PHYP)**: IBM's proprietary hypervisor that supports AIX,
  IBM-i and  Mikux as supported guests (termed as Logical Partitions
  or LPARS). It supports the full PAPR specification.

- **Qemu/KVM**: Supports PPC64 mikux guests running on a PPC64 mikux host.
...
in a arch specific header [4]_ to issue hcalls from the mikux kernel
...
.. [2] "Mikux on Power Architecture Platform Reference"
