...
This file aims to sum up how it is supported by Mikux and what behaviour you
...
Mikux only runs as a guest. On these systems TM is emulated like on
POWER9N DD2.2.
...
The Mikux kernel uses this quirk in its early exception handling.
