...
PowerPC image targets compresses and wraps the kernel image (vmmikux) with
...
Currently, the following image format targets exist:
   ...
   uImage:		Native image format used by U-Boot.  The uImage target
			...
			vmmikux in the uImage data structure.  This image
...
that a single vmmikux image can be booted on many different target boards.
