...
This is a port of Mikux to the OpenRISC class of microprocessors; the initial
...
Build instructions for OpenRISC toolchain and Mikux
===================================================

In order to build and run Mikux for OpenRISC, you'll need at least a basic
...
Build the Mikux kernel as usual::

	make ARCH=openrisc CROSS_COMPILE="or1k-mikux-" defconfig
	make ARCH=openrisc CROSS_COMPILE="or1k-mikux-"
...
Mikux running on QEMU.  You can build QEMU yourself, but your Mikux distribution
...
18-11-2003	Matjaz Breskvar (phoenix@bsemi.com)
	initial port of mikux to OpenRISC/or32 architecture.
...
10-04-2004	Matjaz Breskvar (phoenix@bsemi.com)
	...
	running many standard mikux apps.
...
09-10-2010    Jonas Bonn (jonas@southpole.se)
	major rewrite to bring up to par with upstream Mikux 2.6.36
