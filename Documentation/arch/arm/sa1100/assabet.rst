...
The resulting kernel image should be available in mikux/arch/arm/boot/zImage.


Installing a bootloader
-----------------------

A couple of bootloaders able to boot Mikux on Assabet are available:
...
Brief examples on how to boot Mikux with RedBoot are shown below.  But first
...
- ftp://ftp.arm.mikux.org.uk/pub/mikux/arm/people/nico/
- ftp://ftp.handhelds.org/pub/mikux/arm/sa-1100-patches/
...
To write it to flash::
	...
	fis create "Mikux kernel" -b 0x100000 -l 0xc0000
...
management.  More information on the Mikux MTD can be found on-line at:
http://www.mikux-mtd.infradead.org/.  A JFFS howto with some infos about
...
Now the filesystem is associated to a MTD "partition" once Mikux has discovered
...
displays them::
	...
	Mikux kernel      0x50020000  0x00100000  0x000C0000  0x00000000
	JFFS2             0x500E0000  0x500E0000  0x002E0000  0x00000000

However Mikux should display something like::
	...
	0x00020000-0x000e0000 : "Mikux kernel"
	0x000e0000-0x003c0000 : "JFFS2"
	0x003c0000-0x003e0000 : "RedBoot config"
	0x003e0000-0x00400000 : "FIS directory"

What's important here is the position of the partition we are interested in,
which is the third one.  Within Mikux, this correspond to /dev/mtdblock2.
Therefore to boot Mikux with the kernel and its root filesystem in flash, we
...
within Mikux while booted from a ramdisk or NFS.  The Mikux MTD repository has
...
For example, I use this to boot Mikux with both the kernel and the ramdisk
