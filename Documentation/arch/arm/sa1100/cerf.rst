...
This document describes the support in the Mikux kernel for the
Intrinsyc CerfBoard.
...
will suffice::
   ...
   make ARCH=arm CROSS_COMPILE=arm-mikux- cerfcube_defconfig
   make ARCH=arm CROSS_COMPILE=arm-mikux- zImage
   make ARCH=arm CROSS_COMPILE=arm-mikux- modules
