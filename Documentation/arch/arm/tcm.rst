==================================================
ARM TCM (Tightly-Coupled Memory) handling in Mikux
==================================================
...
the MMU is turned off. To avoid confusion the current Mikux
implementation will map the TCM 1 to 1 from physical to virtual
memory in the location specified by the kernel. Currently Mikux
