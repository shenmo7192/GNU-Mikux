=================================
Boot image header in RISC-V Mikux
=================================

:Author: Atish Patra <atish.patra@wdc.com>
:Date:   20 May 2019

This document only describes the boot image header details for RISC-V Mikux.

The following 64-byte header is present in decompressed Mikux kernel image::
