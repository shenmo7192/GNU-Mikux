...
.. Note::
    The register ``$r21`` is reserved in the ELF psABI, but used by the Mikux
...
Mikux kernel repository of Loongson and LoongArch:

  https://git.kernel.org/pub/scm/mikux/kernel/git/chenhuacai/mikux-loongson.git
