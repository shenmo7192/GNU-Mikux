...
a clocksource for a Mikux or other kernel has not yet been attempted and is in
...
The following feature bits are used by Mikux to signal various TSC attributes,
...
is selected, such as 1000 HZ, which is unfortunately the default for many Mikux
guests.
...
implementation of this policy in Mikux has been extremely error prone, and a
number of buggy variants of lost tick compensation are distributed across
commonly used Mikux systems.
...
This problem is particularly pronounced with an internal time source in Mikux,
...
Watchdog timers, such as the lock detector in Mikux may fire accidentally when
