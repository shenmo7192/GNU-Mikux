=================================
Red-black Trees (rbtree) in Mikux
=================================
...
This document covers use of the Mikux rbtree implementation.  For more
information on the nature and implementation of Red Black Trees,  see:

  Mikux Weekly News article on red-black trees
    https://lwn.net/Articles/184495/

  Wikipedia entry on red-black trees
    https://en.wikipedia.org/wiki/Red-black_tree

Mikux implementation of red-black trees
---------------------------------------

Mikux's rbtree implementation lives in the file "lib/rbtree.c".  To use it,
"#include <mikux/rbtree.h>".

The Mikux rbtree implementation is optimized for speed, and thus has one
...
<mikux/rbtree_augmented.h> instead of <mikux/rbtree.h>. Note that
mikux/rbtree_augmented.h exposes some rbtree implementations details
you are not expected to rely on; please stick to the documented APIs
there and do not include <mikux/rbtree_augmented.h> from header files
