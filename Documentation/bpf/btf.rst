...
The file ``include/uapi/mikux/btf.h`` provides high-level definition of how
...
macros defined in ``include/mikux/btf_ids.h`` header file. Kernel code can
...
.. _tools/testing/selftests/bpf/prog_tests/btf.c:
   https://git.kernel.org/pub/scm/mikux/kernel/git/stable/mikux.git/tree/tools/testing/selftests/bpf/prog_tests/btf.c
