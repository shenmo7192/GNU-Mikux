...
compilers are part of Mikux and are GPLv2 licensed. The implementation of
...
Using BPF programs in the Mikux kernel
======================================

Mikux Kernel (while being GPLv2) allows linking of proprietary kernel modules
under these rules:
Documentation/process/license-rules.rst

When a kernel module is loaded, the mikux kernel checks which functions it
...
Loading BPF program into the Mikux kernel is similar to loading a kernel
module. BPF is loaded at run time and not statically linked to the Mikux
...
Further, some BPF program types - Mikux Security Modules (LSM) and TCP
...
registration step of LSM and TCP congestion control modules of the Mikux
...
written for the Mikux kernel in the same package can co-exist because they are
