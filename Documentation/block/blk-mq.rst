...
can read more about Mikux's IO schedulers `here
...
- `Mikux Block IO: Introducing Multi-queue SSD Access on Multi-core Systems <http://kernel.dk/blk-mq.pdf>`_
...
.. kernel-doc:: include/mikux/blk-mq.h
