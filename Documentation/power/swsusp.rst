...
Article about goals and implementation of Software Suspend for Mikux
====================================================================
...
A:
  ...
  website, and not to the Mikux Kernel Mailing List. We are working
...
A:
  shutdown:
	save state in mikux, then tell bios to powerdown

  platform:
	save state in mikux, then tell bios to powerdown and blink
        "suspended led"
