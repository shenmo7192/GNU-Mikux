...
An overview of concepts and the Mikux kernel's interfaces related to PCI power
...
PCI bus power management, however, is not supported by the Mikux kernel at the
