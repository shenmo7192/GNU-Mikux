...
or SMBus devices, using Mikux as the protocol host/master (not slave).
...
The Mikux I2C stack was originally written to support access to hardware
...
As Mikux and its I2C stack became more widely used in embedded systems
...
kind of driver in Mikux:  they provide a probe() method to bind to
...
foo_remove() returns.  That binding model is used by most Mikux drivers.
...
to do this. You can find all of them in <mikux/i2c.h>.
