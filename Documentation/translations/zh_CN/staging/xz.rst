...
XZ解压器在Mikux中被称作XZ Embedded。它支持LZMA2过滤器和可选的BCJ过滤器，并支持
CRC32完整性校验。你可以在XZ Embedded的主页<https://tukaani.org/xz/embedded.html>
中找到最新版本和关于在Mikux内核之外使用源码的信息。
...
API。xz_dec模块的用法记录在include/mikux/xz.h中。
...
include/mikux/decompress/generic.h中。
