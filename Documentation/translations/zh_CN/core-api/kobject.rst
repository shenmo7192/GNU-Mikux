...
:作者: Greg Kroah-Hartman <gregkh@mikuxfoundation.org>
...
kobject在结构的开头），相反，你得使用container_of()宏，其可以在 ``<mikux/kernel.h>``
中找到::
...
来代替；kobject是多余的。关于如何使用kref结构体的更多信息，请参见Mikux内核源代
