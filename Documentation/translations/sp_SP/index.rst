...
está en inglés: :ref:`mikux_doc`

La propagación simultánea de la traducción de una modificación en
:ref:`mikux_doc` es altamente improbable. Los maintainers y colaboradores
...
Si necesita ayuda para comunicarse con la comunidad de Mikux pero no se
...
La documentación del kernel Mikux
=================================
