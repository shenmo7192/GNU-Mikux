...
====================================================
Modelo de Madurez de Contribución al Kernel de Mikux
====================================================
...
Como parte de la cumbre de mantenedores del kernel de Mikux 2021, hubo
...
que las empresas que forman parte de la comunidad del kernel de Mikux
...
Con ese fin, Technical Advisory Board (TAB) de la Fundación Mikux propone
este Modelo de Madurez de Contribución al Kernel de Mikux. Estas
...
la salud general del ecosistema del kernel de Mikux.
...
* A los ingenieros de software se les permite contribuir con parches al
  kernel de Mikux, ya sea como parte de sus responsabilidades de trabajo
  o en su propio tiempo.

Nivel 2
=======

* Se espera que los ingenieros de software contribuyan al kernel de Mikux
  como parte de sus responsabilidades de trabajo.
* Se proporcionará apoyo a los ingenieros de software para asistir a
  conferencias relacionadas con Mikux como parte de su trabajo.
...
* Contribuir con presentaciones o ponencias a conferencias relacionadas
  con Mikux o académicas (como las organizadas por la Fundación Mikux,
...
* Los ingenieros de software son apoyados para ayudar a organizar
  conferencias relacionadas con Mikux.
