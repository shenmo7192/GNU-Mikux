...
puro que solo afectan al kernel de Mikux.
...
El equipo de seguridad de hardware del kernel de Mikux es separado del
equipo regular de seguridad del kernel de Mikux.
...
en el kernel de Mikux no son manejados por este equipo y el "reportero"
(quien informa del error) será guiado a contactar el equipo de seguridad
del kernel de Mikux (:doc:`errores de seguridad <security-bugs>`) en su
lugar.
...
alojados en la infraestructura de IT de la Fundación Mikux. Al proporcionar
este servicio, los miembros del personal de operaciones de IT de la
Fundación Mikux técnicamente tienen la capacidad de acceder a la
información embargada, pero están obligados a la confidencialidad por su
contrato de trabajo. El personal de IT de la Fundación Mikux también es
...
Mikux es Konstantin Ryabitsev.

Acuerdos de no divulgación
--------------------------

El equipo de seguridad de hardware del kernel de Mikux no es un organismo
...
La comunidad del kernel de Mikux tiene una comprensión profunda del
...
La comunidad del kernel de Mikux ha manejado con éxito los problemas de
...
La comunidad del kernel de Mikux tiene un equipo de seguridad de hardware
...
de Mikux, las reuniones cara a cara hacen imposible abordar los
...
kernel de Mikux por correo electrónico. Este contacto inicial debe
...
del kernel de Mikux. Sin embargo, aceptarán adherirse a este proceso
...
de Mikux y se ha utilizado con éxito en el desarrollo de mitigación para
...
Mikux. Los parches se publican, discuten y revisan y, si se acuerda, se
...
comunidad de desarrolladores del kernel de Mikux según sea necesario. La
...
revelada involucrada. La lista de embajadores actuales:
  ...
  IBM Power	Anton Blanchard <anton@mikux.ibm.com>
...
idealmente conectada a la red de confianza PGP del kernel de Mikux. Véase
