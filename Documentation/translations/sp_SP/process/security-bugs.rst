...
Los desarrolladores del kernel de Mikux se toman la seguridad muy en
...
El equipo de seguridad del kernel de Mikux puede ser contactado por correo
...
de correo “mikux-distros” hasta DESPUES de discutirlo con el equipo de
seguridad del kernel. No Cc: ambas listas a la vez. Puede ponerse en
contacto con la lista de correo mikux-distros después de que se haya
...
mikux-distros no contribuyen en realidad a solucionar ningún problema de
seguridad potencial.
...
El equipo de seguridad del kernel de Mikux no es un organismo formal y,
