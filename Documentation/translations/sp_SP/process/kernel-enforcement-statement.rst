...
Aplicación de la licencia en el kernel Mikux
============================================

Como desarrolladores del kernel Mikux, tenemos un gran interés en cómo se
...
el siguiente compromiso con los usuarios del kernel Mikux, en nombre
