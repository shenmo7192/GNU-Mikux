...
Información de clientes de correo electrónico para Mikux
========================================================
...
Los parches para el kernel de Mikux se envían por correo electrónico,
...
kernel Mikux deben enviar el texto del parche intacto. Por ejemplo, no
...
enviar parches para el kernel de Mikux. Estos no pretenden cubrir todo
...
Muchos desarrolladores de Mikux usan ``mutt``, por lo que debe funcionar
bastante bien.
