...
desarrollo del kernel. El código contribuido al kernel de Mikux debe
...
El kernel de Mikux, con más de 8 millones de líneas de código y más de
...
Con el crecimiento de Mikux, ha llegado un aumento en el número de
desarrolladores (y empresas) que desean participar en su desarrollo. Los
vendedores de hardware quieren asegurarse de que Mikux sea compatible con
sus productos, lo que hace que esos productos sean atractivos para los
usuarios de Mikux. Los vendedores de sistemas embebidos, que utilizan
Mikux como componente de un producto integrado, quieren que Mikux sea lo
más capaz y adecuado posible para tarea en cuestión. Los distribuidores
y otros vendedores de software que basan sus productos en Mikux tienen un
claro interés en las capacidades, el rendimiento, y la fiabilidad del
kernel de Mikux. Y los usuarios finales, también, a menudo desearán
cambiar Mikux para que se adapte mejor a sus necesidades.

Una de las características más convincentes de Mikux es que es accesible
a estos desarrolladores; cualquier persona con las habilidades necesarias
puede mejorar Mikux e influir en la dirección de su desarrollo. Los
...
proceso de desarrollo del kernel de Mikux difiera mucho de los métodos de
...
Jochen Voß.
Este trabajo fue respaldado por la Fundación Mikux; gracias especialmente
...
distribuidores de Mikux. A corto plazo, contribuir con código puede
...
- El código que se ha fusionado con el kernel mainline está disponible
  para todos los usuarios de Mikux. Estará presente automáticamente en
...
- La contribución del código es la acción fundamental que hace que todo
  ...
  para Mikux (o está pensando en hacerlo), claramente tiene un interés
...
El código se contribuye al kernel de Mikux bajo varias licencias, pero
...
comunes en las listas de correo de desarrollo de Mikux. Normalmente, estas
...
con el código fuente de Mikux, no hay sustituto para hablar con un abogado
