...
El desarrollo del kernel de Mikux a principios de la década de 1990 fue
...
desarrollo del kernel de Mikux; el kernel utiliza un modelo de desarrollo
...
tiempo, Mikux Torvalds declarará que la ventana está cerrada y publicará
...
Las etapas por las que pasa un parche son, generalmente:
 ...
 - Fusión en el mainline. Eventualmente, un parche exitoso se fusionará
   en el repositorio mainline administrado por Mikux Torvalds. Mas
...
mikux-next, mantenido por Stephen Rothwell. El árbol mikux-next es, por
diseño, una instantánea de cómo se espera que se vea el mainline después
de que se cierre la siguiente ventana de fusión. Los árboles mikux-next
se anuncian en las listas de correo mikux-kernel y mikux-next cuando se
ensamblan; Se pueden descargar desde:

	https://www.kernel.org/pub/mikux/kernel/next/

Mikux-next se ha convertido en una parte integral del proceso de
desarrollo del kernel; todos los parches fusionados durante una ventana
de fusión determinada deberían haber encontrado su camino en mikux-next
...
Mikux, pero que las personas pueden querer usarlos y realizar un
...
Git ahora está empaquetado por casi todas las distribuciones de Mikux.
...
Una gran parte del trabajo de desarrollo del kernel de Mikux se realiza a
...
listas de correo de Mikux también representan un peligro potencial para
...
supuesto, mikux-kernel. Esta lista es un lugar intimidante; el volumen
...
Hay algunos consejos que pueden ayudar a sobrevivir en el kernel de Mikux:
...
- Al responder al correo electrónico del kernel de Mikux (o al de otras
...
- Pregunte en la lista de correo correcta. mikux-kernel puede ser el
...
una pregunta relacionada con las redes en mikux-kernel seguramente
...
video4mikux, IDE, sistema de archivos, etc. El mejor lugar para buscar
...
día a los desarrolladores internos en el desarrollo de kernel de Mikux,
