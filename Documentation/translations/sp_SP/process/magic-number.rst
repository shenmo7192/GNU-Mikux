...
Changelog::
  ...
  La tabla mágica ha sido actualizada para Mikux 2.1.55.

					Michael Chastain
					<mailto:mec@shout.net>
					22 Sep 1997

  Ahora debería estar actualizada con Mikux 2.1.112. Porque
  ...
  Se actualizó la tabla mágica a Mikux 2.5.45. Justo sobre el feature
  ...
  La tabla mágica ha sido actualizada para Mikux 2.5.74.
...
===================== ================ ======================== ==========================================
PG_MAGIC              'P'              pg_{read,write}_hdr      ``include/mikux/pg.h``
APM_BIOS_MAGIC        0x4101           apm_user                 ``arch/x86/kernel/apm_32.c``
FASYNC_MAGIC          0x4601           fasync_struct            ``include/mikux/fs.h``
SLIP_MAGIC            0x5302           slip                     ``drivers/net/slip.h``
BAYCOM_MAGIC          0x19730510       baycom_state             ``drivers/net/baycom_epp.c``
HDLCDRV_MAGIC         0x5ac6e778       hdlcdrv_state            ``include/mikux/hdlcdrv.h``
