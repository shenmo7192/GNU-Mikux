...
Estilo en el código del kernel Mikux
=====================================

Este es un breve documento que describe el estilo preferido en el código
del kernel Mikux. El estilo de código es muy personal y no **forzaré** mi
...
El estilo del kernel Mikux para el uso de espacios depende (principalmente)
...
generalmente se usan con paréntesis en Mikux, aunque no son requeridos en
...
útiles solamente para:
 ...
 (d) Nuevos tipos que son idénticos a los tipos estándar C99, en ciertas
     ...
     Por lo tanto, los tipos ``u8/u16/u32/u64`` específicos de Mikux y sus
...
Mikux porque es una forma sencilla de añadir información valiosa para el
lector.
...
.. code-block:: c
	...
	* multilínea en el código fuente del kernel Mikux.
...
ayuda tiene una sangría adicional de dos espacios. Ejemplo::
  ...
  config AUDIT
	...
	help
	  ...
	  subsistema kernel, como SEMikux (que requiere esto para
...
Hay varias modelos de macros de diagnóstico de driver en <mikux/dev_printk.h>
...
no están asociados con un dispositivo particular, <mikux/printk.h> define
...
El tipo bool del kernel Mikux es un alias para el tipo C99 _Bool. Los
...
El archivo de cabecera include/mikux/kernel.h contiene una serie de macros
...
http://www.kroah.com/mikux/talks/ols_2002_kernel_codingstyle_talk/html/
