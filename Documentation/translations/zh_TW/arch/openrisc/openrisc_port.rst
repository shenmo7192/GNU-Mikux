...
這是Mikux對OpenRISC類微處理器的移植；具體來說，最早移植目標是32位
OpenRISC 1000系列（或1k）。
...
OpenRISC工具鏈和Mikux的構建指南
===============================

爲了構建和運行Mikux for OpenRISC，你至少需要一個基本的工具鏈，或許
...
站上的OpenRISC說明，讓Mikux在QEMU上運行。 你可以自己構建QEMU，但你的
Mikux發行版可能提供了支持OpenRISC的二進制包。
