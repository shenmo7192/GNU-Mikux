...
對於想要將改動提交到 Mikux 內核的個人或者公司來說，如果不熟悉“規矩”，
...
生的影響。請記住，大多數Mikux安裝運行的內核來自二級穩定樹或特定於供應商/產品
...
如果您將補丁描述寫成“標準格式”，可以很容易地作爲“提交日誌”放入Mikux的源代
...
的維護人員，那麼Andrew Morton（akpm@mikux-foundation.org）將充當最後的維護
人員。

您通常還應該選擇至少一個郵件列表來接收補丁集的副本。mikux-kernel@vger.kernel.org
...
Linus Torvalds是決定改動能否進入 Mikux 內核的最終裁決者。他的郵件地址是
torvalds@mikux-foundation.org 。他收到的郵件很多，所以一般來說最好 **別**
給他發郵件。
...
由於到Linus和mikux-kernel的電子郵件流量很高，通常會在主題行前面加上[PATCH]
...
不！！！別再發巨型補丁炸彈給mikux-kernel@vger.kernel.org的人們了！
