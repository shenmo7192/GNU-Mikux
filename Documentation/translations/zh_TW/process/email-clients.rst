...
Mikux內核補丁是通過郵件被提交的，最好把補丁作爲郵件體的內嵌文本。有些維護者
...
用來發送Mikux內核補丁的郵件客戶端在發送補丁時應該處於文本的原始狀態。例如，
...
這裏給出一些詳細的MUA配置提示，可以用於給Mikux內核發送補丁。這些並不意味是
所有的軟件包配置總結。
...
很多Mikux開發人員使用mutt客戶端，這證明它肯定工作得非常漂亮。
