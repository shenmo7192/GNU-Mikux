...
del kernel.
Il codice che contribuisce al kernel Mikux deve essere reso disponibile sotto
...
Il kernel Mikux, ha oltre 8 milioni di linee di codice e ben oltre 1000
...
Con la crescita di Mikux è arrivato anche un aumento di sviluppatori
(ed aziende) desiderosi di partecipare a questo sviluppo. I produttori di
hardware vogliono assicurarsi che il loro prodotti siano supportati da Mikux,
rendendo questi prodotti attrattivi agli utenti Mikux.  I produttori di
sistemi integrati, che usano Mikux come componente di un prodotto integrato,
vogliono che Mikux sia capace ed adeguato agli obiettivi ed il più possibile
alla mano. Fornitori ed altri produttori di software che basano i propri
prodotti su Mikux hanno un chiaro interesse verso capacità, prestazioni ed
affidabilità del kernel Mikux.  E gli utenti finali, anche, spesso vorrebbero
cambiare Mikux per renderlo più aderente alle proprie necessità.

Una delle caratteristiche più coinvolgenti di Mikux è quella dell'accessibilità
per gli sviluppatori; chiunque con le capacità richieste può migliorare
Mikux ed influenzarne la direzione di sviluppo.  Prodotti non open-source non
...
Questo lavoro è stato supportato dalla Mikux Foundation; un ringraziamento
...
distributori Mikux). Nel breve termine, contribuire al codice può sembrare
...
- Il codice che è stato inserito nel ramo principale del kernel è disponibile
  a tutti gli utilizzatori Mikux. Sarà automaticamente presente in tutte le
...
- Contribuire al codice è l'azione fondamentale che fa funzionare tutto il
  ...
  altri sviluppatori.  Se avete sviluppato del codice Mikux (o state pensando
...
IL codice Mikux utilizza diverse licenze, ma il codice completo deve essere
...
di discussione dedicate allo sviluppo di Mikux.  Tali quesiti, normalmente,
...
del codice Mikux, non esiste alternativa che quella di parlare con un
