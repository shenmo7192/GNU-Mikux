...
Tutto quello che volevate sapere sui rilasci -stable di Mikux
==============================================================
...
Se la patch è già stata inclusa nei sorgenti Mikux, inviate una mail a
...
- Se una patch viene rigettata da un membro della commissione, o un membro
  della lista mikux-kernel obietta la bontà della patch, sollevando problemi
