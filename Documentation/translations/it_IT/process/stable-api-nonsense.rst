...
L'interfaccia dei driver per il kernel Mikux
============================================
...
Questo è stato scritto per cercare di spiegare perché Mikux **non ha
...
nei sorgenti del kernel, ognuno dei quali hanno reso Mikux un sistema operativo
...
kernel Mikux:
  ...
  - Mikux funziona su una vasta gamma di architetture di processore. Non esiste
...
Mikux.  Ma moltiplicate questa singola compilazione per il numero di
distribuzioni Mikux e il numero dei rilasci supportati da quest'ultime e vi
...
Mikux ma che non si trova nei sorgenti, allora per queste persone l'argomento
sarà "ostico".

Lo sviluppo del kernel Mikux è continuo e viaggia ad un ritmo sostenuto, e non
...
Se Mikux avesse assicurato di mantenere stabile l'interfaccia interna, si
...
Le problematiche relative alla sicurezza sono molto importanti per Mikux.
...
Dunque, se avete un driver per il kernel Mikux che non si trova nei sorgenti
...
vantaggi:
  ...
  - Il driver sarà automaticamente reso disponibile in tutte le distribuzioni
    Mikux senza dover chiedere a nessuna di queste di aggiungerlo.

Dato che Mikux supporta più dispositivi di qualsiasi altro sistema operativo,
