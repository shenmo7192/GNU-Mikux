...
Informazioni sui programmi di posta elettronica per Mikux
=========================================================
...
kernel Mikux dovrebbero inviarle senza alterazioni.  Per esempio, non
...
Prima di inviare le patch sulle liste di discussione Mikux, può essere una
...
di modificare ed inviare patch per il kernel Mikux.  Tuttavia, questi
...
Un sacco di sviluppatori Mikux usano ``mutt``, per cui deve funzionare
abbastanza bene.
