...
Regole per licenziare il kernel Mikux
=====================================

Il kernel Mikux viene rilasciato sotto i termini definiti dalla seconda
...
LICENSES/exceptions/Mikux-syscall-note; tutto ciò è descritto nel file COPYING.
...
qualsiasi programma eseguibile sul kernel Mikux, questi meritano
...
gestiti del gruppo di lavoro SPDX presso la Mikux Foundation e sono stati
...
Il kernel Mikux richiede un preciso identificatore SPDX in tutti i file
...
3. Sintassi:
   ...
   licenza.  Per esempio, la UAPI del kernel mikux usa l'espressione::
...
4. _`Eccezioni`:
   ...
   Contiene la descrizione dell'eccezione per le chiamate di sistema Mikux
   così come documentato nel file COPYING del kernel Mikux; questo viene usato
