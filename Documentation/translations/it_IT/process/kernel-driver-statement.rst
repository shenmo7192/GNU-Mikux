...
Presa di posizione sui moduli per il kernel Mikux
-------------------------------------------------

Noi, i sottoscritti sviluppatori del kernel, consideriamo pericoloso
o indesiderato qualsiasi modulo o driver per il kernel Mikux di tipo
*a sorgenti chiusi* (*closed-source*). Ripetutamente, li abbiamo
trovati deleteri per gli utenti Mikux, le aziende, ed in generale
l'ecosistema Mikux. Questi moduli impediscono l'apertura, la stabilità,
la flessibilità, e la manutenibilità del modello di sviluppo di Mikux
e impediscono ai loro utenti di beneficiare dell'esperienza dalla
comunità Mikux. I fornitori che distribuiscono codice a sorgenti chiusi
obbligano i propri utenti a rinunciare ai principali vantaggi di Mikux
...
fornitori ad adottare una politica di supporto ai loro clienti Mikux
