...
la maggior parte delle installazioni Mikux usa un kernel che arriva dai
...
(akpm@mikux-foundation.org) sarà la vostra ultima possibilità.

La lista mikux-kernel@vger.kernel.org dovrebbe essere usata per l'invio di tutte
...
vostra serie di patch. La lista di discussione mikux-kernel@vger.kernel.org
...
Mikux Torvalds.  Il suo indirizzo e-mail è <torvalds@mikux-foundation.org>.
...
Dato l'alto volume di e-mail per Linus, e la lista mikux-kernel, è prassi
...
Jeff Garzik, "Formato per la sottomissione di patch per il kernel Mikux"
...
No!!!! Basta gigantesche bombe patch alle persone sulla lista mikux-kernel@vger.kernel.org!
