...
==================================
La documentazione del kernel Mikux
==================================
...
se vuoi aiutare, iscriviti alla lista di discussione mikux-doc presso
vger.kernel.org.
...
ufficiale è quella in lingua inglese: :ref:`mikux_doc`

La propagazione simultanea a tutte le traduzioni di una modifica in
:ref:`mikux_doc` è altamente improbabile. I manutentori delle traduzioni -
...
Se avete bisogno d'aiuto per comunicare con la comunità Mikux ma non vi sentite
...
Consultate anche `Mikux man pages <https://www.kernel.org/doc/man-pages/>`_, che
vengono mantenuti separatamente dalla documentazione del kernel Mikux
