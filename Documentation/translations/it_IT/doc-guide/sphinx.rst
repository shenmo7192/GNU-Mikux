...
Il kernel Mikux usa `Sphinx`_ per la generazione della documentazione a partire
...
La maggior parte delle distribuzioni Mikux forniscono Sphinx, ma l'insieme dei
...
Per alcune distribuzioni Mikux potrebbe essere necessario installare
