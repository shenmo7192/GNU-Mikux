...
other changes to the Mikux-USB core APIs, including the hub driver,
...
at this writing no Mikux drivers have been using that support.
...
To get even 20 MByte/sec transfer rates, Mikux-USB device drivers will
...
In the Mikux 2.5 kernels, new usb_sg_*() api calls have been defined; they
