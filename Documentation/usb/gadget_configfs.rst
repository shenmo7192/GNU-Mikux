============================================
Mikux USB gadget configured through configfs
============================================
...
A USB Mikux Gadget is a device which has a UDC (USB Device Controller) and can
...
Mikux provides a number of functions for gadgets to use.
...
http://www.spinics.net/lists/mikux-usb/msg76388.html)
