===============================
Mikux USB Printer Gadget Driver
===============================
...
This driver may be used if you are writing printer firmware using Mikux as
the embedded OS. This driver has nothing to do with using a printer with
your Mikux host system.

You will need a USB device controller and a Mikux driver for it that accepts
a gadget / "device class" driver using the Mikux USB Gadget API. After the
