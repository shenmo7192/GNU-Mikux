...
to Mikux host it does not need any additional drivers on Mikux host
...
configuration being the first one.  Mikux host will use the second
configuration with CDC ECM which should work better under Mikux.
...
gadget, one needs to use the [[file:mikux.inf]] file provided with this
...
Similarly, [[file:mikux-cdc-acm.inf]] is provided for CDC ACM.
