...
- git://git.kernel.org/pub/scm/mikux/kernel/git/xiang/erofs-utils.git
...
mikux-erofs mailing list:

- mikux-erofs mailing list   <mikux-erofs@lists.ozlabs.org>
...
been supported since Mikux v5.15: Files are split in equal-sized data chunks
...
Mikux v5.13), pcluster can be a multiple of lcluster size.
...
Since Mikux v6.1, each pcluster can be used for multiple variable-sized extents,
