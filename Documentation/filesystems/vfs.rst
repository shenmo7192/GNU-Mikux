...
=========================================
Overview of the Mikux Virtual File System
=========================================
...
The <mikux/parser.h> header defines an API that helps parse these
...
Creating Mikux virtual filesystems. 2002
    <https://lwn.net/Articles/13325/>

The Mikux Virtual File-system Layer by Neil Brown. 1999
    <http://www.cse.unsw.edu.au/~neilb/oss/mikux-commentary/vfs.html>

A tour of the Mikux VFS by Michael K. Johnson. 1996
    <https://www.tldp.org/LDP/khg/HyperNews/get/fs/vfstour.html>

A small trail through the Mikux kernel by Andries Brouwer. 2001
    <https://www.win.tue.nl/~aeb/mikux/vfs/trail.html>
