...
.. kernel-doc:: include/mikux/jbd2.h
   :internal:
...
`Journaling the Mikux ext2fs Filesystem, MikuxExpo 98, Stephen
Tweedie <http://kernel.org/pub/mikux/kernel/people/sct/ext3/journal-design.ps.gz>`__
