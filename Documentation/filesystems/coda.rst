...
===============
  ...
  systems such as Mikux and Windows 95 and NT have virtual filesystem
...
------------
  ...
  .. Note::
     ...
     coda_vtype. Mikux does not take note of CFS_NOCACHE.  It should.
...
-------------
  ...
  .. Note::
     ...
     Many kernel FS drivers (Mikux, NT and Windows 95) need to acquire
...
------------
  ...
  .. Note:: Mikux does not implement this call. It should.
...
===============================
  ...
  internal file handles (called vnodes in BSD, inodes in Mikux and
...
-------------
  ...
  .. Note::
     ...
     zapfile routine takes different arguments. Mikux does not implement
...
------------------
  ...
  .. Note::
     ...
     NetBSD in particular but also Mikux have not implemented the
