...
are not supported yet by the mikux server implementation.
...
The following abbreviations indicate the mikux server implementation status.
...
GSS on the backchannel:
  ...
  particular, the current Mikux client doesn't request it).  We return
...
See also http://wiki.mikux-nfs.org/wiki/index.php/Server_4.0_and_4.1_issues.
