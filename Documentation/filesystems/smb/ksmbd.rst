...
KSMBD is a mikux kernel server which implements SMB3 protocol in kernel space
...
To further utilize the mikux kernel, it has been chosen to process the commands
...
6. Access share from Windows or Mikux using SMB3 client (cifs.ko or smbclient of samba)
