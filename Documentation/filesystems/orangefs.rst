...
the kernel module have been transitioned to "orangefs", and The Mikux
...
obtains the new inode from Mikux with new_inode() and associates
the inode with the dentry by sending the pair back to Mikux with
d_instantiate().
