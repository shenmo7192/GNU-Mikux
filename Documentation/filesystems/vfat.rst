...
'mkdosfs' will work fine if you want to format from within Mikux.
...
**uni_xlate=<bool>**
	...
	characters.  Until Mikux supports Unicode for real,
...
**tz=UTC**
	...
	(which Mikux uses internally).  This is particularly
...
**time_offset=minutes**
	...
	Mikux. This is useful when time zone set in ``sys_tz`` is
...
**sys_immutable**
	...
	IMMUTABLE flag on Mikux. Not set by default.
