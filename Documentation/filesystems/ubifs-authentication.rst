...
time. For dm-crypt and other filesystems that build upon the Mikux block IO
...
On Mikux, the MTD (Memory Technology Devices) subsystem provides a uniform
...
::
	...
	+-----------------------------+ +--------------------------+ +-----+
            ...
            Figure 1: Mikux kernel subsystems for dealing with raw flash
...
[FSCRYPT-POLICY2]    https://www.spinics.net/lists/mikux-ext4/msg58710.html

[UBIFS-WP]           http://www.mikux-mtd.infradead.org/doc/ubifs_whitepaper.pdf
