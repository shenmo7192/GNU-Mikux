...
This is intended to support loopback mounted Mikux native filesystems
...
Mapping of ADFS permissions to Mikux permissions
------------------------------------------------
  ...
  does not hold the same meaning as the Mikux 'execute' permission
  and is now obsolete).
  ...
  desire the permissions should be under Mikux.
