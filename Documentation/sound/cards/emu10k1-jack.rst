...
Mikux users to use the full capabilities of their hardware has been inspired 
...
Until recently, emu10k1 users on Mikux did not have access to the same low
...
channels.  With a post 2.6.9 Mikux kernel, latencies down to 64 (1.33 ms) or
