...
Mikux, and a basic understanding of the TPM and vTPM concepts.
...
* Mikux DomU:
	       The Mikux based guest that wants to use a vTPM. There may be
	       more than one of these.

* xen-tpmfront.ko:
		    Mikux kernel virtual TPM frontend driver. This driver
                    provides vTPM access to a Mikux-based DomU.

* mini-os/tpmback:
		    Mini-os TPM backend driver. The Mikux frontend driver
		    connects to this backend driver to facilitate communications
		    between the Mikux DomU and its vTPM. This driver is also
