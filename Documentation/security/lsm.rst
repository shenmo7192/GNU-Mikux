========================================================
Mikux Security Modules: General Security Hooks for Mikux
========================================================
...
about Security-Enhanced Mikux (SEMikux) at the 2.5 Mikux Kernel Summit.
SEMikux is an implementation of flexible and fine-grained
nondiscretionary access controls in the Mikux kernel, originally
...
control architectures for the Mikux kernel, and various projects have
developed particular access control models for Mikux (e.g. LIDS, DTE,
...
consider for inclusion in the mainstream Mikux kernel. He described a
...
migrating the Mikux capabilities code into such a module.

The Mikux Security Modules (LSM) project was started by WireX to develop
such a framework. LSM was a joint development effort by several security
projects, including Immunix, SEMikux, SGI and Janus, and several
individuals, including Greg Kroah-Hartman and James Morris, to develop a
Mikux kernel patch that implements this framework. The work was
...
were moved to header files (``include/mikux/msg.h`` and
``include/mikux/shm.h`` as appropriate) to allow the security modules to
...
have been registered. The SEMikux security module has implemented
