...
was due to three main reasons:
  ...
  1. Protection of additional attack vectors:
    ...
    * With IMA+EVM, without an encryption solution, the system is vulnerable
      ...
      including the SEMikux labels that would be used to determine whether the
    ...
    * As userspace binaries are paged in Mikux, dm-verity also offers the
...
The second option also has problems: Mikux supports a variety of bootloaders
