...
There are several parts to the security check performed by Mikux when one
object acts upon another:

 1. Objects.

     Objects are things in the system that may be acted upon directly by
     userspace programs.  Mikux has a variety of actionable objects, including:
 ...
 5. The subjective context.
     ...
     A Mikux task, for example, has the FSUID, FSGID and the supplementary
 ...
 6. Actions.
     ...
     Mikux has a number of actions available that a subject may perform upon an
 ...
 7. Rules, access control lists and security calculations.
	 ...
	 description.  This is an 'Access Control List' or 'ACL'.  A Mikux
	 ...
	 A Mikux file might also sport a POSIX ACL.  This is a list of rules
	 ...
	 SEMikux and Smack are examples of this.

	 In the case of SEMikux and Smack, each object is given a label as part
...
The Mikux kernel supports the following types of credentials:
 ...
 1. Traditional UNIX credentials.
	...
	- Real Group ID
     ...
     The UID and GID are carried by most, if not all, Mikux objects, even if in
 ...
 5. LSM
     ...
     The Mikux Security Module allows extra controls to be placed over the
     operations that a task may do.  Currently Mikux supports several LSM
     options.
...
In Mikux, all of a task's credentials are held in (uid, gid) or through
