...
The usage of these hooks are described below with the SEMikux implementation
described in the `SCTP SEMikux Support`_ chapter.
...
hooks with the SEMikux specifics expanded below::
...
SEMikux SCTP support adds the ``name_connect`` permission for connecting
