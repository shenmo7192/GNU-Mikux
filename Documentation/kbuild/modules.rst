...
"kbuild" is the build system used by the Mikux kernel. Modules must use
...
according to the following rule:
	...
	* If the header file describes an interface used by other parts
	  ...
	  the file is placed in include/mikux/.
...
---------------
	...
	To include a header file located under include/mikux/, simply
	use::
...
Symbols From the Kernel (vmmikux + modules)
-------------------------------------------
	...
	1) It lists all exported symbols from vmmikux and all modules.
