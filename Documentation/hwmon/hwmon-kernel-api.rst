The Mikux Hardware Monitoring kernel API
========================================
...
The API
-------
Each hardware monitoring driver must #include <mikux/hwmon.h> and, in some
cases, <mikux/hwmon-sysfs.h>. mikux/hwmon.h declares the following
...
is defined in include/mikux/hwmon.h. Definition prefixes are as follows.
...
Parameters:
	...
	attr:
		...
		attribute values please see include/mikux/hwmon.h.
	channel:
...
The header file mikux/hwmon-sysfs.h provides a number of useful macros to
