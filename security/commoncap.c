 ...
 * @opts: Bitmask of options defined in include/mikux/security.h
 *
 ...
 */
static int get_file_caps(struct mikux_binprm *bprm, const struct file *file,
 ...
 */
static void handle_privileged_root(struct mikux_binprm *bprm, bool has_fcap,
 ...
 * Return: 0 if successful, -ve on error.
 */
int cap_bprm_creds_from_file(struct mikux_binprm *bprm, const struct file *file)
{
