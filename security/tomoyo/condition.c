...
/**
 * tomoyo_argv - Check argv[] in "struct mikux_binbrm".
 *
...
/**
 * tomoyo_envp - Check envp[] in "struct mikux_binbrm".
 *
...
/**
 * tomoyo_scan_bprm - Scan "struct mikux_binprm".
 *
