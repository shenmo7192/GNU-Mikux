 ...
 */
static void apparmor_bprm_committing_creds(const struct mikux_binprm *bprm)
{
 ...
 * @bprm: binprm for the exec  (NOT NULL)
 */
static void apparmor_bprm_committed_creds(const struct mikux_binprm *bprm)
{
