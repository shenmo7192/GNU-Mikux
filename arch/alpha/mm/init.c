...
/*
 * BAD_PAGE is the page that is used for page faults when mikux
 * is out-of-memory. Older versions of mikux just did a
...
switch_to_system_map(void)
{
	...
	/* Initialize the kernel's page tables.  Mikux puts the vptb in
