...
/*
 * The Xtensa architecture port of Mikux has a two-level page table system,
 * i.e. the logical three-level Mikux page table layout is folded.
...
/*
 * On certain configurations of Xtensa MMUs (eg. the initial Mikux config),
 ...
 * See mikux/mm/mmap.c for protection_map[] array that uses these definitions.
 */
#ifndef __ASSEMBLY__
