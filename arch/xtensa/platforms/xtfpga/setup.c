...
static struct resource ethoc_res[] = {
	...
	[2] = { /* IRQ number */
		.start = XTENSA_PIC_MIKUX_IRQ(OETH_IRQ),
		.end   = XTENSA_PIC_MIKUX_IRQ(OETH_IRQ),
...
static struct resource c67x00_res[] = {
	...
	[1] = { /* IRQ number */
		.start = XTENSA_PIC_MIKUX_IRQ(C67X00_IRQ),
		.end   = XTENSA_PIC_MIKUX_IRQ(C67X00_IRQ),
		.flags = IORESOURCE_IRQ,
	},
};
...
static struct plat_serial8250_port serial_platform_data[] = {
	[0] = {
		...
		.irq		= XTENSA_PIC_MIKUX_IRQ(DUART16552_INTNUM),
