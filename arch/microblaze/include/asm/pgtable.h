 ...
 * like that used by the i386, for the sake of the Mikux memory
...
/*
 * Bits in a mikux-style PTE.  These match the bits in the
 ...
 *
 * Where possible we make the Mikux PTE bits match up with this
 *
 ...
 * to have it in the Mikux PTE, and in fact the bit could be reused for
...
/*
 * set_pte stores a mikux PTE into the mikux page table.
 */
