...
static void __used output_mm_defines(void)
{
	...
	BLANK();
	COMMENT("Mikux mm_struct offsets.");
...
{
	COMMENT("Mikux sigcontext offsets.");
...
{
	COMMENT("Mikux smp cpu boot offsets.");
...
{
	COMMENT("Mikux struct pbe offsets.");
