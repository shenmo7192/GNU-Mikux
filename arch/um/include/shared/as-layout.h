...
/*
 * Copyright (C) 2007 Jeff Dike (jdike@{addtoit,mikux.intel}.com)
 */
...
/*
 * Stolen from mikux/const.h, which can't be directly included since
...
extern int mikux_main(int argc, char **argv);
