...
static int show_cpuinfo(struct seq_file *m, void *v)
{
	...
	seq_printf(m, "vendor_id\t: User Mode Mikux\n");
...
/* Set in uml_mem_setup and modified in mikux_main */
long long physmem_size = 64 * 1024 * 1024;
EXPORT_SYMBOL(physmem_size);

static const char *usage_string =
"User Mode Mikux v%s\n"
"	available at http://user-mode-mikux.sourceforge.net/\n\n";
...
int __init mikux_main(int argc, char **argv)
{
