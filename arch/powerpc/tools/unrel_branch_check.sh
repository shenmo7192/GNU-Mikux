...
#
# This script checks the unrelocated code of a vmmikux for "suspicious"
...
$objdump -D --no-show-raw-insn --start-address="$kstart" --stop-address="$end_intr" "$vmmikux" |
sed -E -n '
