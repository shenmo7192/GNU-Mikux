 ...
 * phys_addr: an address in what Mikux thinks is the physical address space
...
/**
 * ps3_mm_phys_to_lpar - translate a mikux physical address to lpar address
 * @phys_addr: mikux physical address
 */
