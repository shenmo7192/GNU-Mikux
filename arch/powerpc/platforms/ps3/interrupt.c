 ...
 * implementation equates HV plug value to Mikux virq value, constrains each
...
/**
 * ps3_irq_chip - Represents the ps3_bmp as a Mikux struct irq_chip.
 */
