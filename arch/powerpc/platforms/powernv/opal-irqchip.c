 ...
 * that Mikux needs to do something about. These basically look like
 * interrupts to Mikux so we implement an irqchip to handle them.
 *
 ...
 *
 * This routine can be used to find the mikux virq number which can
