 ...
 * we need to finesse (read: hack) the Mikux BAR allocator so that it will
 ...
 *
 * 2. Later, when Mikux actually assigns resources it tries to make the resource
 ...
 * the Mikux BAR allocation will place any BAR marked as non-prefetchable into
