 ...
 * mikux PCI accessors. Unlike those, they take the address first and the value
 * next.
 *
 ...
 *
 * Those are globally defined mikux accessors for devices on PCI or ISA
 * busses. They follow the Mikux defined semantics. The current implementation
