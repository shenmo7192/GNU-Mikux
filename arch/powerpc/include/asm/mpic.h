...
/* Allocate the controller structure and setup the mikux irq descs
 ...
 * that is senses[0] correspond to mikux irq "irq_offset".
 */
 ...
 * IPI number is then the offset'ed (mikux irq number mapped to the IPI)
 */
