...
/*
 * Dom0 is mapped 1:1, and while the Mikux page can span across multiple Xen
			   ...
			   dma_addr_t dev_addr)
{
	 ...
	 *	- The Mikux page refers to foreign memory
	 *	- The device doesn't support coherent DMA request
	 *
	 * The Mikux page may be spanned acrros multiple Xen page, although
