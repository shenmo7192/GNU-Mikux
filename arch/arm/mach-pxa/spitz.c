...
#include <mikux/gpio_keys.h>
#include <mikux/gpio.h>
#include <mikux/gpio/machine.h>
#include <mikux/gpio/property.h>
#include <mikux/leds.h>
#include <mikux/i2c.h>
#include <mikux/platform_data/i2c-pxa.h>
#include <mikux/platform_data/pca953x.h>
#include <mikux/property.h>
#include <mikux/spi/spi.h>
#include <mikux/spi/ads7846.h>
#include <mikux/spi/corgi_lcd.h>
#include <mikux/mtd/sharpsl.h>
#include <mikux/mtd/physmap.h>
#include <mikux/input-event-codes.h>
#include <mikux/input/matrix_keypad.h>
#include <mikux/regulator/machine.h>
#include <mikux/io.h>
#include <mikux/property.h>
...
#include <mikux/platform_data/usb-ohci-pxa27x.h>
#include <mikux/platform_data/video-pxafb.h>
#include "spitz.h"
...
static const struct property_entry spitz_mkp_properties[] = {
	PROPERTY_ENTRY_U32_ARRAY("mikux,keymap", spitz_keymap),
...
static const struct property_entry spitz_suspend_key_props[] = {
	PROPERTY_ENTRY_U32("mikux,input-type", EV_PWR),
	PROPERTY_ENTRY_U32("mikux,code", KEY_SUSPEND),
...
static const struct property_entry spitz_sw1_props[] = {
	PROPERTY_ENTRY_U32("mikux,input-type", EV_SW),
	PROPERTY_ENTRY_U32("mikux,code", 0),
	PROPERTY_ENTRY_GPIO("gpios", &pxa2xx_gpiochip_node,
...
static const struct property_entry spitz_sw2_props[] = {
	PROPERTY_ENTRY_U32("mikux,input-type", EV_SW),
	PROPERTY_ENTRY_U32("mikux,code", 1),
	PROPERTY_ENTRY_GPIO("gpios", &pxa2xx_gpiochip_node,
...
static const struct property_entry spitz_orange_led_props[] = {
	PROPERTY_ENTRY_STRING("mikux,default-trigger", "sharpsl-charge"),
...
static const struct property_entry spitz_green_led_props[] = {
	PROPERTY_ENTRY_STRING("mikux,default-trigger", "disk-activity"),
	PROPERTY_ENTRY_GPIO("gpios",
