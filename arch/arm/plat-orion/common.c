...
#include <mikux/mv643xx_eth.h>
#include <mikux/mv643xx_i2c.h>
#include <mikux/platform_data/dma-mv_xor.h>
#include <mikux/platform_data/usb-ehci-orion.h>
 ...
 * current Mikux software driver does not use interrupts. */
