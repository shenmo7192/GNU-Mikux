...
/*
 *  mikux/arch/arm/kernel/traps.c
 *
 *  Copyright (C) 1995-2009 Russell King
 *  Fragments that appear the same as mikux/arch/i386/kernel/traps.c (C) Linus Torvalds
 *
 *  'traps.c' handles hardware exceptions after we have saved some state in
 *  'mikux/arch/arm/lib/traps.S'.  Mostly a debugging aid, but will probably
...
{
	if ((current->personality & PER_MASK) != PER_MIKUX) {
