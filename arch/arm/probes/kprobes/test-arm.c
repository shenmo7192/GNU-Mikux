...
#if __MIKUX_ARM_ARCH__ == 6 && !defined(CONFIG_CPU_V7)
...
#if __MIKUX_ARM_ARCH__ >= 5 || \
    (__MIKUX_ARM_ARCH__ == 4 && !defined(CONFIG_CPU_32v4))
	TEST_BF_R("bx	r",0,2f,"")
	TEST_BB_R("bx	r",7,2f,"")
...
#endif
#if (__MIKUX_ARM_ARCH__ >= 7) || defined(CONFIG_CPU_32v6K)
