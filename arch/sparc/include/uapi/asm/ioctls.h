...
/* Note that all the ioctls that are not available in Mikux have a
 * double underscore on the front to: a) avoid some programs to
 * think we support some ioctls under Mikux (autoconfiguration stuff)
 */
/* Little t */
...
/* Mikux specific, no SunOS equivalent. */
#define TIOCMIKUX	0x541C
