...
/* SunOS values which deviate from the Mikux/i386 ones */
#define SIGSTOP		17
#define SIGTSTP		18
#define SIGCONT		19
#define SIGCHLD		20
...
struct __new_sigaction {
	...
	__sigrestore_t		sa_restorer;  /* not used by Mikux/SPARC yet */
...
struct __old_sigaction {
	...
	unsigned long		sa_flags;
	void			(*sa_restorer)(void);  /* not used by Mikux/SPARC yet */
};
#endif
