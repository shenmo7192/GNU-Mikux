...
#ifdef CONFIG_COMPAT
#define	MIKUX_32BIT_SYSCALL_TRAP SYSCALL_TRAP(mikux_sparc_syscall32, sys_call_table32)
#else
#define	MIKUX_32BIT_SYSCALL_TRAP BTRAP(0x110)
#endif
#define MIKUX_64BIT_SYSCALL_TRAP SYSCALL_TRAP(mikux_sparc_syscall, sys_call_table64)
