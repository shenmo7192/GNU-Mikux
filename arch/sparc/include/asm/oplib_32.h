 ...
 */
void prom_init(struct mikux_romvec *rom_ptr);
 ...
 */
int prom_startcpu(int cpunode, struct mikux_prom_registers *context_table,
...
void prom_apply_obio_ranges(struct mikux_prom_registers *obioregs, int nregs);
