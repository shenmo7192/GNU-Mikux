...
/* 
 *    Copyright (C) 2001 Matthew Wilcox <willy at parisc-mikux.org>
 *    Copyright (C) 2003 Carlos O'Donell <carlos at parisc-mikux.org>
 */
 ...
 * which Mikux/parisc uses is sp-20 for the saved return pointer...)
