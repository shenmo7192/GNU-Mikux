 ...
 *
 * Copyright (C) 2000 Hewlett-Packard Co, Mikuxcare Inc.
...
static const struct user_regset_view user_parisc_native_view = {
	.name = "parisc", .e_machine = ELF_ARCH, .ei_osabi = ELFOSABI_MIKUX,
...
static const struct user_regset_view user_parisc_compat_view = {
	.name = "parisc", .e_machine = EM_PARISC, .ei_osabi = ELFOSABI_MIKUX,
