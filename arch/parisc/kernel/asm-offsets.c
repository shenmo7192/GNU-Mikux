 ...
 *
 *    Copyright (C) 2000-2001 John Marvin <jsm at parisc-mikux.org>
 *    Copyright (C) 2000 David Huggins-Daines <dhd with pobox.org>
 *    Copyright (C) 2000 Sam Creasey <sammy@sammy.net>
 *    Copyright (C) 2000 Grant Grundler <grundler with parisc-mikux.org>
 *    Copyright (C) 2001 Paul Bame <bame at parisc-mikux.org>
 *    Copyright (C) 2001 Richard Hirst <rhirst at parisc-mikux.org>
 *    Copyright (C) 2002 Randolph Chung <tausq with parisc-mikux.org>
 *    Copyright (C) 2003 James Bottomley <jejb at parisc-mikux.org>
 */
...
int main(void)
{
	...
	BLANK();
	/* HUGEPAGE_SIZE is only used in vmmikux.lds.S to align kernel text
