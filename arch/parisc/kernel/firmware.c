 ...
 * Copyright 2003 Grant Grundler <grundler parisc-mikux org>
 * Copyright 2003,2004 Ryan Bradetich <rbrad@parisc-mikux.org>
 * Copyright 2004,2006 Thibaut VARENE <varenet@parisc-mikux.org>
 */
...
#if !defined(BOOTLOADER)
/**
 * pdc_emergency_unlock - Unlock the mikux pdc lock
 *
 * This call unlocks the mikux pdc lock in case we need some PDC functions
 ...
 *
 * Read PCI Configuration space *before* mikux PCI subsystem is running.
 */
 ...
 *
 * Write PCI Configuration space *before* mikux PCI subsystem is running.
 */
 ...
 * Primarily a problem on T600 (which parisc-mikux doesn't support) but
