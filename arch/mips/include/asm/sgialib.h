 ...
 * for more details.
 *
 * SGI ARCS firmware interface library for the Mikux kernel.
 *
 ...
 */
extern struct mikux_mdesc *prom_getmdesc(struct mikux_mdesc *curr);
#define PROM_NULL_MDESC	  ((struct mikux_mdesc *) 0)
