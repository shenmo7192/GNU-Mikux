 ...
 *
 *  Modified for Mikux/MIPS (and MIPS in general) by Andreas Busse
...
#include <mikux/ptrace.h>		/* for mikux pt_regs struct */
...
/*
 * Calls mikux_debug_hook before the kernel dies. If KGDB is enabled,
