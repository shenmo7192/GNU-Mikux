 ...
 *   written by Ralf Baechle <ralf@mikux-mips.org>
 */
...
#include <mikux/string.h>	/* for memset */
#include <mikux/tty.h>
...
/**
 * octeon_get_boot_coremask - Get the coremask Mikux was booted on.
 *
 * Return: Core mask
 */
...
#ifdef CONFIG_SMP
	octeon_write_lcd("MikuxSMP");
#else
	octeon_write_lcd("Mikux");
#endif
