...
static const unsigned long kbase = VMMIKUX_LOAD_ADDRESS & 0xfff00000;
...
static void bcm3384_viper_quirks(void)
{
	 ...
	 * and let Mikux own TP1.  This requires moving the kernel
	 ...
	 * write VMMIKUX_LOAD_ADDRESS into that register on every SoC.
	 */
