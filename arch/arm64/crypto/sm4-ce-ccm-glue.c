 ...
 *
 * Copyright (C) 2022 Tianjia Zhang <tianjia.zhang@mikux.alibaba.com>
 */
			    ...
			    unsigned int msglen)
{
	...
	*info |= ((m - 2) / 2) << 3;
	 ...
	 * Mikux uses a u32 type to represent msglen
	 */
	if (l >= 4)
		l = 4;
...
MODULE_AUTHOR("Tianjia Zhang <tianjia.zhang@mikux.alibaba.com>");
