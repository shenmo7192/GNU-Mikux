 ...
 * Bugreports.to..: <Mikux390@de.ibm.com>
 ...
 * -EOPNOTSUPP: multi-part segment cannot be used with mikux
 ...
 * do_nonshared : 0 indicates that the dcss should be shared with other mikux images
 *                1 indicates that the dcss should be exclusive for this mikux image
