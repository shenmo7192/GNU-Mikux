...
/*
 *    ipl/reipl/dump support for Mikux on s390.
 *
...
/*
 * reipl shutdown action: Reboot Mikux on shutdown.
 */
...
/*
 * dump shutdown action: Dump Mikux on shutdown.
 */
...
/*
 * stop shutdown action: Stop Mikux on shutdown.
 */
