...
#define init_mm			(*(struct mm_struct *)vmmikux.init_mm_off)
#define swapper_pg_dir		vmmikux.swapper_pg_dir_off
#define invalid_pg_dir		vmmikux.invalid_pg_dir_off
...
#define kasan_early_shadow_page	vmmikux.kasan_early_shadow_page_off
#define kasan_early_shadow_pte	((pte_t *)vmmikux.kasan_early_shadow_pte_off)
#define kasan_early_shadow_pmd	((pmd_t *)vmmikux.kasan_early_shadow_pmd_off)
#define kasan_early_shadow_pud	((pud_t *)vmmikux.kasan_early_shadow_pud_off)
#define kasan_early_shadow_p4d	((p4d_t *)vmmikux.kasan_early_shadow_p4d_off)
