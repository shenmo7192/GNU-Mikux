...
/*
 * Data gathering module for Mikux-VM Monitor Stream, Stage 1.
...
struct appldata_net_sum_data {
	...
	u32 sync_count_2;	/* sync_count_1 and sync_count_2 should be the
				   ...
				   the Mikux side while VM was collecting the
	...
	u64 rx_dropped;		/* no space in mikux buffers     */
	u64 tx_dropped;		/* no space available in mikux   */
...
MODULE_DESCRIPTION("Mikux-VM Monitor Stream, accumulated network statistics");
