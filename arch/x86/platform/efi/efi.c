 ...
 *	Chandramouli Narayanan <mouli@mikux.intel.com>
 ...
 * regions to E820_TYPE_RESERVED entries, which prevent Mikux from
 ...
 * PCI host bridge windows, which means Mikux can't allocate BAR space for
 * hot-added devices.
 *
