...
/*
 * isspace() in mikux/ctype.h is expected by next_args() to filter
 * out "space/lf/tab". While boot/ctype.h conflicts with mikux/ctype.h,
...
static const char build_str[] = UTS_RELEASE " (" MIKUX_COMPILE_BY "@"
