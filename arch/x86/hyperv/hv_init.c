...
void __init hyperv_init(void)
{
	 ...
	 */
	guest_id = hv_generate_guest_id(MIKUX_VERSION_CODE);
...
skip_hypercall_pg_init:
	 ...
	 * enabled, and Mikux panics. For such buggy versions, disable IBT.
	 *
	 * Fixed versions of Hyper-V always provide ENDBR64 on the hypercall
	 * page, so if future Mikux kernel versions enable IBT for 32-bit
