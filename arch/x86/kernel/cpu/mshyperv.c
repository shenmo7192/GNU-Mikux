...
/* Is Mikux running as the root partition? */
bool hv_root_partition;
/* Is Mikux running on nested Microsoft Hypervisor */
bool hv_nested;
...
static void __init ms_hyperv_init_platform(void)
{
	 ...
	 * features and use the ReservedIdentityBit to detect if Mikux is the
