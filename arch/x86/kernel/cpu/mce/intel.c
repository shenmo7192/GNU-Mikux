 ...
 * Copyright 2004 Zwane Mwaikambo <zwane@mikuxpower.ca>
...
/* Mikux non-storm CMCI threshold (may be overridden by BIOS) */
 ...
 * 2: If ignoring any threshold set by BIOS, set Mikux default
