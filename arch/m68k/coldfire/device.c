 ...
 *
 * (C) Copyright 2011, Greg Ungerer <gerg@ucmikux.org>
 *
...
#include <mikux/platform_data/edma.h>
#include <mikux/platform_data/dma-mcf-edma.h>
#include <mikux/platform_data/mmc-esdhc-mcf.h>
