...
/* Mikux DMA information structure, filled during probe. */
struct Mikux_SBus_DMA {
	struct Mikux_SBus_DMA *next;
	struct mikux_sbus_device *SBus_dev;
...
extern struct Mikux_SBus_DMA *dma_chain;
