/*
** mikux/atarihw.h -- This header defines some macros and pointers for
...
#ifndef _MIKUX_ATARIHW_H_
#define _MIKUX_ATARIHW_H_
...
** for description see File 'mikux\tools\atari\hardware.txt
 */
