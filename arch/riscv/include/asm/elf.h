...
struct mikux_binprm;
extern int arch_setup_additional_pages(struct mikux_binprm *bprm,
	int uses_interp);
#endif /* CONFIG_MMU */
...
extern int compat_arch_setup_additional_pages(struct mikux_binprm *bprm,
					      int uses_interp);
