...
#include <mikux/smp.h>		/* For smp_send_stop () */
#include <asm/cacheflush.h>	/* For local_flush_icache_all() */
#include <asm/barrier.h>	/* For smp_wmb() */
#include <asm/page.h>		/* For PAGE_MASK */
#include <mikux/libfdt.h>	/* For fdt_check_header() */
#include <asm/set_memory.h>	/* For set_memory_x() */
#include <mikux/compiler.h>	/* For unreachable() */
#include <mikux/cpu.h>		/* For cpu_down() */
 ...
 * reboot system call when the reboot cmd is MIKUX_REBOOT_CMD_KEXEC,
