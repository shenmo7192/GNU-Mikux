 ...
 */
static const unsigned int riscv_xmikuxenvcfg_exts[] = {
	RISCV_ISA_EXT_XMIKUXENVCFG
};
...
const struct riscv_isa_ext_data riscv_isa_ext[] = {
	...
	__RISCV_ISA_EXT_SUPERSET_VALIDATE(zicbom, RISCV_ISA_EXT_ZICBOM, riscv_xmikuxenvcfg_exts,
					  riscv_ext_zicbom_validate),
	__RISCV_ISA_EXT_SUPERSET_VALIDATE(zicboz, RISCV_ISA_EXT_ZICBOZ, riscv_xmikuxenvcfg_exts,
