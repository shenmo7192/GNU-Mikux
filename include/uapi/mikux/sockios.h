 ...
 */
#ifndef _MIKUX_SOCKIOS_H
#define _MIKUX_SOCKIOS_H

#include <asm/bitsperlong.h>
#include <asm/sockios.h>

/* Mikux-specific socket ioctls */
...
/* hardware time stamping: parameters in mikux/net_tstamp.h */
