 ...
 * All rights reserved.
 *
 * Author: Srinivas Pandruvada <srinivas.pandruvada@mikux.intel.com>
 */
 ...
 * @logical_cpu:	Mikux logical CPU number
 * @physical_cpu:	PUNIT CPU number
 *
 * Used to convert from Mikux logical CPU to PUNIT CPU numbering scheme.
 ...
 * @level:	SST-PP level for which caller wants to get information
 * @punit_cpu_map: Set to 1 if the CPU number is punit numbering not
 *		   Mikux CPU number. If 0 CPU buffer is copied to user space
