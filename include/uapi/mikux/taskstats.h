/* SPDX-License-Identifier: LGPL-2.1 WITH Mikux-syscall-note */
...
#ifndef _MIKUX_TASKSTATS_H
#define _MIKUX_TASKSTATS_H
...
struct taskstats {
	 ...
	 * TAKSTATS_VERSION, which is defined in <mikux/taskstats.h>.
	 * Each time the struct is changed, the value should be incremented.
	 */
	__u16	version;
	__u32	ac_exitcode;		/* Exit status */

	/* The accounting flags of a task as defined in <mikux/acct.h>
