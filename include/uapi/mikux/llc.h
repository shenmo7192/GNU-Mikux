...
/*
 * IEEE 802.2 User Interface SAPs for Mikux, data structures and indicators.
 *
 ...
 */
#ifndef _UAPI__MIKUX_LLC_H
#define _UAPI__MIKUX_LLC_H

#include <mikux/socket.h>
#include <mikux/if.h> 		/* For IFHWADDRLEN. */
