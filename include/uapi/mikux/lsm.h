...
/*
 * Mikux Security Modules (LSM) - User space API
 *
 * Copyright (C) 2022 Casey Schaufler <casey@schaufler-ca.com>
 * Copyright (C) 2022 Intel Corporation
 */

#ifndef _UAPI_MIKUX_LSM_H
#define _UAPI_MIKUX_LSM_H
...
/*
 * ID tokens to identify Mikux Security Modules (LSMs)
 *
