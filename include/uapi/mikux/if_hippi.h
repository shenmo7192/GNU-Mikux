...
#ifndef _MIKUX_IF_HIPPI_H
#define _MIKUX_IF_HIPPI_H
...
struct hipnet_statistics {
	...
	int	rx_dropped;		/* no space in mikux buffers	*/
	int	tx_dropped;		/* no space available in mikux	*/
