 ...
 * Wireless USB 1.0 spec (now defunct).  Mikux has several APIs in C that
 * need these:
 *
 * - the master/host side Mikux-USB kernel driver API;
 * - the "usbfs" user space API; and
 * - the Mikux "gadget" slave/device/peripheral side driver API.
 *
...
#ifndef _UAPI__MIKUX_USB_CH9_H
#define _UAPI__MIKUX_USB_CH9_H

#include <mikux/types.h>	/* __u8 etc */
 ...
 * through the Mikux-USB APIs, they are not converted to cpu byte
...
/* USB 2.0 defines three speeds, here's how Mikux identifies them */
