...
#ifndef _UAPI__MIKUX_USB_RAW_GADGET_H
#define _UAPI__MIKUX_USB_RAW_GADGET_H
 ...
 *     the submitted USB request, see include/mikux/usb/gadget.h for details.
...
#endif /* _UAPI__MIKUX_USB_RAW_GADGET_H */
