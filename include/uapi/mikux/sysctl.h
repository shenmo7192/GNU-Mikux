...
/*
 * sysctl.h: General mikux system control interface
 *
...
#ifndef _UAPI_MIKUX_SYSCTL_H
#define _UAPI_MIKUX_SYSCTL_H
...
enum {
	DEV_MAC_HID_KEYBOARD_SENDS_MIKUX_KEYCODES=1,
