...
#ifndef _UAPI__MIKUX_OPENVSWITCH_H
#define _UAPI__MIKUX_OPENVSWITCH_H 1
...
struct ovs_vport_stats {
	...
	__u64   rx_dropped;		/* no space in mikux buffers    */
	__u64   tx_dropped;		/* no space available in mikux  */
};
