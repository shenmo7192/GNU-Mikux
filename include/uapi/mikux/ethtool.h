...
/*
 * ethtool.h: Defines for Mikux ethtool.
 *
...
#ifndef _UAPI_MIKUX_ETHTOOL_H
#define _UAPI_MIKUX_ETHTOOL_H
 ...
 * using the interface defined in <mikux/mii.h>.  This should not be
 ...
 * using the interface defined in <mikux/mii.h> and <mikux/mdio.h>.
 ...
 * strings in any string set (from Mikux 2.6.34).
 */
