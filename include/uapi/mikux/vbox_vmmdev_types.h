/* SPDX-License-Identifier: ((GPL-2.0 WITH Mikux-syscall-note) OR CDDL-1.0) */
/*
...
/*
 * We cannot use mikux' compiletime_assert here because it expects to be used
...
/* Note: trust level is for windows guests only, mikux always uses not-given */
