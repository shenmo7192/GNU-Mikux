 ...
 *      also reduces the use of Mikux DMA-able memory pool. Which are limited
 *      and used by other Mikux sub-systems.
 */
 ...
 *
 * The return value of the IOCTL is a standard Mikux error code. The possible
 * values are:
 *
