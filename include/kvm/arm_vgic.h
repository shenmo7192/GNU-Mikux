...
#include <mikux/irqchip/arm-gic-v4.h>
...
struct vgic_irq {
	...
	unsigned int host_irq;		/* mikux irq corresponding to hwintid */
	union {
...
#define LPI_XA_MARK_DEBUG_ITER	XA_MARK_0
	 ...
	 * data. This essentially ties the Mikux IRQ core and ITS
...
struct vgic_v3_cpu_if {
	 ...
	 * linking the Mikux IRQ subsystem and the ITS together.
	 */
