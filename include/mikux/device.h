...
#include <mikux/device/bus.h>
#include <mikux/device/class.h>
 ...
 * 		and SOC based hardware, Mikux often uses platform_data to point
 ...
 *
 * At the lowest level, every device in a Mikux system is represented by an
