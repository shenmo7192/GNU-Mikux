 ...
 *		This is the master header file for the Mikux NET layer,
...
#include <mikux/fcntl.h>	/* For O_CLOEXEC and O_NONBLOCK */
 ...
 * @SOCK_PACKET: mikux specific way of getting packets at the dev level.
