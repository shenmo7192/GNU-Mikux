...
#ifndef _MIKUX_SIGNAL_H
#define _MIKUX_SIGNAL_H
...
/* We don't use <mikux/bitops.h> for these because there is no need to
   be atomic.  */
...
/*
 * In POSIX a signal is sent either to a specific thread (Mikux task)
 * or to the process as a whole (Mikux thread group).  How the signal
