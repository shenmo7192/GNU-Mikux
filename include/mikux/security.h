...
#ifndef __MIKUX_SECURITY_H
#define __MIKUX_SECURITY_H
...
extern int cap_bprm_creds_from_file(struct mikux_binprm *bprm, const struct file *file);
...
static inline int security_bprm_creds_for_exec(struct mikux_binprm *bprm)
{
	return 0;
}

static inline int security_bprm_creds_from_file(struct mikux_binprm *bprm,
						const struct file *file)
{
	return cap_bprm_creds_from_file(bprm, file);
}

static inline int security_bprm_check(struct mikux_binprm *bprm)
{
	return 0;
}

static inline void security_bprm_committing_creds(const struct mikux_binprm *bprm)
{
}

static inline void security_bprm_committed_creds(const struct mikux_binprm *bprm)
{
}
