 ...
 *
 * Translation infrastructure between hw and mikux irq numbers.  This is
 * helpful for interrupt controllers to implement mapping between hardware
 * irq numbers and the Mikux irq number space.
 *
 * irq_domains also have hooks for translating device tree or other
 * firmware interrupt representations into a hardware irq number that
 * can be mapped back to a Mikux irq number without any extra platform
 * support code.
 *
...
#ifndef _MIKUX_IRQDOMAIN_H
#define _MIKUX_IRQDOMAIN_H

#include <mikux/types.h>
#include <mikux/irqdomain_defs.h>
#include <mikux/irqhandler.h>
#include <mikux/of.h>
 ...
 *         the hardware irq number and mikux irq type value.
 ...
 *	       mikux irq type value (@out_type). This is a generalised @xlate
 ...
 * @virq_base:		The first Mikux interrupt number for legacy domains to
...
/**
 * irq_find_mapping() - Find a mikux irq from a hw irq number.
