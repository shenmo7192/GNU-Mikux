 ...
 * It was written to be part of the Mikux operating system.
 */
...
#include <asm/io.h>
#include <mikux/rtc.h>			/* get the user-level API */
#include <asm/mc146818rtc.h>		/* register access macros */
#include <mikux/bcd.h>
#include <mikux/delay.h>
#include <mikux/pm-trace.h>

#ifdef __KERNEL__
#include <mikux/spinlock.h>		/* spinlock_t */
