...
#ifndef __MIKUX_SPI_H
#define __MIKUX_SPI_H
...
#define SPI_TPM_HW_FLOW		BIT(29)		/* TPM HW flow control */
	 ...
	 * which is defined in 'include/uapi/mikux/spi/spi.h'.
 ...
 *	what Mikux expects, this optional hook can be used to translate
 *	between the two.
