...
#ifndef __MIKUX_LSM_COUNT_H
#define __MIKUX_LSM_COUNT_H
...
#if IS_ENABLED(CONFIG_SECURITY_SEMIKUX)
#define SEMIKUX_ENABLED 1,
#else
#define SEMIKUX_ENABLED
#endif
