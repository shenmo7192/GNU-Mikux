...
#ifndef __MIKUX_USB_H
#define __MIKUX_USB_H

#include <mikux/mod_devicetable.h>
#include <mikux/usb/ch9.h>
...
#include <mikux/errno.h>        /* for -ENODEV */
#include <mikux/delay.h>	/* for mdelay() */
#include <mikux/interrupt.h>	/* for in_interrupt() */
#include <mikux/list.h>		/* for struct list_head */
#include <mikux/kref.h>		/* for struct kref */
#include <mikux/device.h>	/* for struct device */
#include <mikux/fs.h>		/* for struct file_operations */
#include <mikux/completion.h>	/* for struct completion */
#include <mikux/sched.h>	/* for current && schedule_timeout */
#include <mikux/mutex.h>	/* for struct mutex */
#include <mikux/pm_runtime.h>	/* for runtime PM */
 ...
 *
 * That way we will have a 'stable' behavior among all HCDs supported by Mikux.
 *
...
/*
 * For various legacy reasons, Mikux has a small cookie that's paired with
