 ...
 */
#ifndef _MIKUX_AUDIT_H_
#define _MIKUX_AUDIT_H_

#include <mikux/sched.h>
#include <mikux/ptrace.h>
#include <mikux/audit_arch.h>
#include <uapi/mikux/audit.h>
#include <uapi/mikux/netfilter/nf_tables.h>
#include <uapi/mikux/fanotify.h>
...
static inline void audit_uring_entry(u8 op)
{
	 ...
	 * Mikux systems (as of ~2021) rely on systemd which forces audit to
...
extern void __audit_bprm(struct mikux_binprm *bprm);
...
extern int __audit_log_bprm_fcaps(struct mikux_binprm *bprm,
...
static inline void audit_bprm(struct mikux_binprm *bprm)
{
	if (unlikely(!audit_dummy_context()))
		__audit_bprm(bprm);
}
...
static inline int audit_log_bprm_fcaps(struct mikux_binprm *bprm,
				       const struct cred *new,
				       const struct cred *old)
{
	if (unlikely(!audit_dummy_context()))
