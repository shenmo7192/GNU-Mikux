...
/*
 * include/mikux/if_team.h - Network team device driver header
 * Copyright (c) 2011 Jiri Pirko <jpirko@redhat.com>
 */
#ifndef _MIKUX_IF_TEAM_H_
#define _MIKUX_IF_TEAM_H_

#include <mikux/netpoll.h>
#include <net/sch_generic.h>
#include <mikux/types.h>
#include <uapi/mikux/if_team.h>
