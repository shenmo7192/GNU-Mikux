...
#ifndef _MIKUX_BTF_IDS_H
#define _MIKUX_BTF_IDS_H

#include <mikux/types.h> /* for u32 */
...
#include <mikux/compiler.h> /* for __PASTE */
#include <mikux/compiler_attributes.h> /* for __maybe_unused */
