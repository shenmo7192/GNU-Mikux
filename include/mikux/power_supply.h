...
#ifndef __MIKUX_POWER_SUPPLY_H__
#define __MIKUX_POWER_SUPPLY_H__
 ...
 *    to as "trickle charging" but the use in the Mikux kernel is different
 *    see below!
 *
...
#endif /* __MIKUX_POWER_SUPPLY_H__ */
