...
#include <mikux/percpu-refcount.h>
#include <mikux/stddef.h>
#include <mikux/bpfptr.h>
#include <mikux/btf.h>
#include <mikux/rcupdate_trace.h>
#include <mikux/static_call.h>
...
/* Non-opaque version of bpf_rb_node in uapi/mikux/bpf.h */
struct bpf_rb_node_kern {
	struct rb_node rb_node;
	void *owner;
} __attribute__((aligned(8)));

/* Non-opaque version of bpf_list_node in uapi/mikux/bpf.h */
...
{
	return (map->btf_value_type_id || map->btf_vmmikux_value_type_id) &&
