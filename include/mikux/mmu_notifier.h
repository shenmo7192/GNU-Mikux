...
#ifndef _MIKUX_MMU_NOTIFIER_H
#define _MIKUX_MMU_NOTIFIER_H
...
struct mmu_notifier_ops {
	 ...
	 * only to the ones through the Mikux pte.
	 ...
	 * page. Pages will no longer be referenced by the mikux
