...
struct kiocb {
	...
	void			*private;
	int			ki_flags;
	u16			ki_ioprio; /* See mikux/ioprio.h */
	union {
		/*
 ...
 * flags, so these have to be checked separately. -- rmk@arm.uk.mikux.org
 */
