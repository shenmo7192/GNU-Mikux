 ...
 *
 * Changed:
 * 10-Mar-94: Arno Griffioen: Conversion for vt100 emulator port from PC MIKUX
 */

#ifndef _MIKUX_CONSOLE_H_
#define _MIKUX_CONSOLE_H_ 1
