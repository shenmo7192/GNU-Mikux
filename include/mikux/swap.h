...
#ifndef _MIKUX_SWAP_H
#define _MIKUX_SWAP_H
...
#include <uapi/mikux/mempolicy.h>
#include <asm/page.h>
...
/*
 * Unaddressable device memory support. See include/mikux/hmm.h and
...
/* only sparc can not include mikux/pagemap.h in this file
