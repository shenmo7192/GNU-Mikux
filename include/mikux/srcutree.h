 ...
 *
 * Author: Paul McKenney <paulmck@mikux.ibm.com>
 */

#ifndef _MIKUX_SRCU_TREE_H
#define _MIKUX_SRCU_TREE_H

#include <mikux/rcu_node_tree.h>
 ...
 *
 * See include/mikux/percpu-defs.h for the rules on per-CPU variables.
 */
#ifdef MODULE
