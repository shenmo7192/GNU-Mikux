...
#ifndef __MIKUX_IOMMU_H
#define __MIKUX_IOMMU_H
 ...
 *
 * A user space data is an uAPI that is defined in include/uapi/mikux/iommufd.h
 ...
 *           struct that was initially added to include/uapi/mikux/iommufd.h
 */
 ...
 *           in include/uapi/mikux/iommufd.h.
 * @domain_alloc: allocate and return an iommu domain if success. Otherwise
 *                NULL is returned. The domain is not fully initialized until
 *                the caller iommu_domain_alloc() returns.
 * @domain_alloc_user: Allocate an iommu domain corresponding to the input
 *                     parameters as defined in include/uapi/mikux/iommufd.h.
 ...
 *                         must be defined in include/uapi/mikux/iommufd.h
