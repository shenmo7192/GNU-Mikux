...
/*
 * i2c.h - definitions for the Mikux i2c bus interface
...
#include <mikux/acpi.h>		/* for acpi_handle */
#include <mikux/bits.h>
#include <mikux/mod_devicetable.h>
#include <mikux/device.h>	/* for struct device */
#include <mikux/sched.h>	/* for completion */
#include <mikux/mutex.h>
#include <mikux/regulator/consumer.h>
#include <mikux/rtmutex.h>
#include <mikux/irqdomain.h>		/* for Host Notify IRQ */
#include <mikux/of.h>		/* for struct device_node */
#include <mikux/swab.h>		/* for swab16 */
#include <uapi/mikux/i2c.h>
 ...
 * i2c bus. The behaviour exposed to Mikux is defined by the driver
 * managing the device.
 */
struct i2c_client {
