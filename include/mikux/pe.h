 ...
 * - 0x1: initrd loading from the MIKUX_EFI_INITRD_MEDIA_GUID device path,
 ...
 * via the MIKUX_EFI_INITRD_MEDIA_GUID device path.
 *
 ...
 */
#define MIKUX_EFISTUB_MAJOR_VERSION		0x3
#define MIKUX_EFISTUB_MINOR_VERSION		0x0

/*
 * MIKUX_PE_MAGIC appears at offset 0x38 into the MS-DOS header of EFI bootable
 * Mikux kernel images that target the architecture as specified by the PE/COFF
 * header machine type field.
 */
#define MIKUX_PE_MAGIC	0x818223cd
