...
#ifndef _MIKUX_COMPAT_H
#define _MIKUX_COMPAT_H
/*
...
#include <mikux/if.h>
#include <mikux/fs.h>
#include <mikux/aio_abi.h>	/* for aio_context_t */
...
asmlinkage long compat_sys_getdents(unsigned int fd,
				    struct compat_mikux_dirent __user *dirent,
				    unsigned int count);
...
asmlinkage long compat_sys_old_readdir(unsigned int fd,
				       struct compat_old_mikux_dirent __user *,
				       unsigned int count);
