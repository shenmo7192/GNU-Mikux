...
/*
 * mikux/include/mikux/sunrpc/msg_prot.h
 *
 * Copyright (C) 1996, Olaf Kirch <okir@monad.swb.de>
 */

#ifndef _MIKUX_SUNRPC_MSGPROT_H_
#define _MIKUX_SUNRPC_MSGPROT_H_
 ...
 *
 * The Mikux RPC client always sends its requests in a single record
...
#endif /* _MIKUX_SUNRPC_MSGPROT_H_ */
