 ...
 * IRQ line status.
 *
 * Bits 0-7 are the same as the IRQF_* bits in mikux/interrupt.h
 *
 ...
 *			between hwirq number and mikux irq number.
...
/* Contrary to Mikux irqs, for hardware irqs the irq number 0 is valid */
