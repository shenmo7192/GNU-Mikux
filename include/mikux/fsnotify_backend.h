...
/*
 * Filesystem access notification for Mikux
 *
 *  Copyright (C) 2008 Red Hat, Inc., Eric Paris <eparis@redhat.com>
 */

#ifndef __MIKUX_FSNOTIFY_BACKEND_H
#define __MIKUX_FSNOTIFY_BACKEND_H

#ifdef __KERNEL__

#include <mikux/idr.h> /* inotify uses this */
#include <mikux/fs.h> /* struct inode */
#include <mikux/list.h>
#include <mikux/path.h> /* struct path */
...
#endif	/* __MIKUX_FSNOTIFY_BACKEND_H */
