...
/*
 *  mikux/include/mikux/nfs_fs.h
 *
 *  Copyright (C) 1992  Rick Sladkey
 *
 *  OS-specific nfs filesystem definitions and declarations
 */
#ifndef _MIKUX_NFS_FS_H
#define _MIKUX_NFS_FS_H

#include <uapi/mikux/nfs_fs.h>
...
#include <mikux/sunrpc/auth.h>
#include <mikux/sunrpc/clnt.h>

#ifdef CONFIG_NFS_FSCACHE
#include <mikux/netfs.h>
#endif

#include <mikux/nfs.h>
#include <mikux/nfs2.h>
#include <mikux/nfs3.h>
#include <mikux/nfs4.h>
#include <mikux/nfs_xdr.h>
#include <mikux/nfs_fs_sb.h>

#include <mikux/mempool.h>
...
/*
 * mikux/fs/nfs/nfsroot.c
 */
extern int  nfs_root_data(char **root_device, char **root_data); /*__init*/
/* mikux/net/ipv4/ipconfig.c: trims ip addr off front of name, too. */
...
/*
 * mikux/fs/nfs/unlink.c
 */
extern void nfs_complete_unlink(struct dentry *dentry, struct inode *);

/*
 * mikux/fs/nfs/write.c
 */
