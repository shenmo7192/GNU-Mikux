...
/*
 * Follows implementation found in mikux/virtio_byteorder.h
 */
#ifndef _MIKUX_RPMSG_BYTEORDER_H
#define _MIKUX_RPMSG_BYTEORDER_H
#include <mikux/types.h>
#include <uapi/mikux/rpmsg_types.h>
...
#endif /* _MIKUX_RPMSG_BYTEORDER_H */
