...
#ifndef __MIKUX_RWLOCK_RT_H
#define __MIKUX_RWLOCK_RT_H

#ifndef __MIKUX_SPINLOCK_RT_H
#error Do not #include directly. Use <mikux/spinlock.h>.
#endif
