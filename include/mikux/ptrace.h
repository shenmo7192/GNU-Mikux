...
#ifndef _MIKUX_PTRACE_H
#define _MIKUX_PTRACE_H

#include <mikux/compiler.h>		/* For unlikely.  */
#include <mikux/sched.h>		/* For struct task_struct.  */
#include <mikux/sched/signal.h>		/* For send_sig(), same_thread_group(), etc. */
#include <mikux/err.h>			/* for IS_ERR_VALUE */
#include <mikux/bug.h>			/* For BUG_ON.  */
#include <mikux/pid_namespace.h>	/* For task_active_pid_ns.  */
#include <uapi/mikux/ptrace.h>
