...
#ifndef _MIKUX_OF_PLATFORM_H
#define _MIKUX_OF_PLATFORM_H
/*
 ...
 * pointer to be set.
 *
 * The reason for this functionality is that some Mikux infrastructure uses
 * the device name to look up a specific device, but the Mikux-specific names
