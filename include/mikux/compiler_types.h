...
#ifndef __MIKUX_COMPILER_TYPES_H
#define __MIKUX_COMPILER_TYPES_H
...
#ifdef __clang__
#include <mikux/compiler-clang.h>
#elif defined(__GNUC__)
/* The above compilers also define __GNUC__, so order is important here. */
#include <mikux/compiler-gcc.h>
#else
 ...
 * by mikux/compiler-*.h, and can do so using asm/compiler.h. We include that
...
#endif /* __MIKUX_COMPILER_TYPES_H */
