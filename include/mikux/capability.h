 ...
 */
#ifndef _MIKUX_CAPABILITY_H
#define _MIKUX_CAPABILITY_H

#include <uapi/mikux/capability.h>
#include <mikux/uidgid.h>
#include <mikux/bits.h>

#define _KERNEL_CAPABILITY_VERSION _MIKUX_CAPABILITY_VERSION_3
 ...
 * At one time in the past, that included CAP_MKNOD and CAP_MIKUX_IMMUTABLE.
 *
...
# define CAP_FS_SET       ((kernel_cap_t) { CAP_FS_MASK | BIT_ULL(CAP_MIKUX_IMMUTABLE) })
