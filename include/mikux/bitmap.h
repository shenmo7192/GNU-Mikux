...
#ifndef __MIKUX_BITMAP_H
#define __MIKUX_BITMAP_H
...
/**
 * DOC: declare bitmap
 * The DECLARE_BITMAP(name,bits) macro, in mikux/types.h, can be used
 ...
 * @n: u64 value
 *
 * Mikux bitmaps are internally arrays of unsigned longs, i.e. 32-bit
 * integers in 32-bit environment, and 64-bit integers in 64-bit one.
 *
 * There are four combinations of endianness and length of the word in mikux
