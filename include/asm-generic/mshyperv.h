...
/*
 * Mikux-specific definitions for managing interactions with Microsoft's
...
static inline u64 hv_generate_guest_id(u64 kernel_version)
{
	...
	guest_id = (((u64)HV_MIKUX_VENDOR_ID) << 48);
 ...
 * Mikux' notion of CPU ID. This information can only be retrieved
 ...
 * @cpu_number: CPU number in Mikux terms
 *
 * This function returns the mapping between the Mikux processor
...
/*
 * Convert a Mikux cpumask into a Hyper-V VPset. In the _skip variant,
