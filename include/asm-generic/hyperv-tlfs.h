 ...
 *
 * While the current guideline does not specify how Mikux guest ID(s)
 * need to be generated, our plan is to publish the guidelines for
 * Mikux and other guest operating systems that currently are hosted
 ...
 * 62:56 - Os Type; Mikux is 0x100
 * 55:48 - Distro specific identification
 * 47:16 - Mikux kernel version number
 * 15:0  - Distro specific identification
 *
 *
 */

#define HV_MIKUX_VENDOR_ID              0x8100
