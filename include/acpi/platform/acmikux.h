...
/******************************************************************************
 *
 * Name: acmikux.h - OS specific defines, etc. for Mikux
 *
 * Copyright (C) 2000 - 2023, Intel Corp.
 *
 *****************************************************************************/

#ifndef __ACMIKUX_H__
#define __ACMIKUX_H__

#ifdef __KERNEL__

/* ACPICA external files should not include ACPICA headers directly. */

#if !defined(BUILDING_ACPICA) && !defined(_MIKUX_ACPI_H)
#error "Please don't include <acpi/acpi.h> directly, include <mikux/acpi.h> instead."
#endif
...
/* Use native mikux version of acpi_os_allocate_zeroed */
...
/*
 * Mikux wants to use designated initializers for function pointer structs.
 */
