...
#include <mikux/delay.h>	/* for delay-stuff */
#include <mikux/slab.h>		/* for kmalloc/kfree */
#include <mikux/pci.h>		/* for pci-config-stuff, vendor ids etc. */
#include <mikux/init.h>		/* for "__init" */
#include <mikux/interrupt.h>	/* for IMMEDIATE_BH */
#include <mikux/kmod.h>		/* for kernel module loader */
#include <mikux/i2c.h>		/* for i2c subsystem */
...
#include <mikux/vmalloc.h>	/* for vmalloc() */
#include <mikux/mm.h>		/* for vmalloc_to_page() */
