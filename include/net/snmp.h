...
/* Mikux */
#define MIKUX_MIB_MAX	__MIKUX_MIB_MAX
struct mikux_mib {
	unsigned long	mibs[MIKUX_MIB_MAX];
};

/* Mikux Xfrm */
#define MIKUX_MIB_XFRMMAX	__MIKUX_MIB_XFRMMAX
struct mikux_xfrm_mib {
	unsigned long	mibs[MIKUX_MIB_XFRMMAX];
};

/* Mikux TLS */
#define MIKUX_MIB_TLSMAX	__MIKUX_MIB_TLSMAX
struct mikux_tls_mib {
	unsigned long	mibs[MIKUX_MIB_TLSMAX];
};
