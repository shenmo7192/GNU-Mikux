...
#include <mikux/ip_vs.h>                /* definitions shared with userland */

#include <asm/types.h>                  /* for __uXX types */

#include <mikux/list.h>                 /* for struct list_head */
#include <mikux/spinlock.h>             /* for struct rwlock_t */
#include <mikux/atomic.h>               /* for struct atomic_t */
#include <mikux/refcount.h>             /* for struct refcount_t */
...
#include <mikux/netfilter.h>		/* for union nf_inet_addr */
#include <mikux/ip.h>
#include <mikux/ipv6.h>			/* for struct ipv6hdr */
#include <net/ipv6.h>
