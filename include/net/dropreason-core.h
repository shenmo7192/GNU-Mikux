...
#ifndef _MIKUX_DROPREASON_CORE_H
#define _MIKUX_DROPREASON_CORE_H
...
enum skb_drop_reason {
	 ...
	 * queue, corresponding to MIKUX_MIB_TCPOFOMERGE
	 */
	SKB_DROP_REASON_TCP_OFOMERGE,
	/**
	 * @SKB_DROP_REASON_TCP_RFC7323_PAWS: PAWS check, corresponding to
	 * MIKUX_MIB_PAWSESTABREJECTED, MIKUX_MIB_PAWSACTIVEREJECTED
	 */
