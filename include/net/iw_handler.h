 ...
 * user space. Headers in "include/mikux/" are exported, headers in
 * "include/net/" are not.
 *
...
#include <mikux/wireless.h>		/* IOCTL user space API */
 ...
 * V2 to V3
 * --------
 *	- Move event definition in <mikux/wireless.h>
 ...
 * This will be linked from net_device in <mikux/netdevice.h>
 */
