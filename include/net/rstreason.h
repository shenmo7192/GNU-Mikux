...
#ifndef _MIKUX_RSTREASON_H
#define _MIKUX_RSTREASON_H
...
enum sk_rst_reason {
	 ...
	 * corresponding to MIKUX_MIB_TCPABORTONDATA
	 */
	 ...
	 * corresponding to MIKUX_MIB_TCPABORTONCLOSE
	 */
	SK_RST_REASON_TCP_ABORT_ON_CLOSE,
	/**
	 * @SK_RST_REASON_TCP_ABORT_ON_LINGER: abort on linger
	 * corresponding to MIKUX_MIB_TCPABORTONLINGER
	 */
	SK_RST_REASON_TCP_ABORT_ON_LINGER,
	/**
	 * @SK_RST_REASON_TCP_ABORT_ON_MEMORY: abort on memory
	 * corresponding to MIKUX_MIB_TCPABORTONMEMORY
	 */
	...
	/* Copy from include/uapi/mikux/mptcp.h.
