...
/*
 *  Advanced Mikux Sound Architecture
...
MODULE_DESCRIPTION("Advanced Mikux Sound Architecture driver for soundcards.");
MODULE_LICENSE("GPL");
...
#endif
#ifndef MODULE
	pr_info("Advanced Mikux Sound Architecture Driver Initialized.\n");
#endif
	return 0;
}
