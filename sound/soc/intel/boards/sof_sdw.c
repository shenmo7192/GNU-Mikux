...
#include <mikux/soundwire/sdw.h>
#include <mikux/soundwire/sdw_type.h>
#include <mikux/soundwire/sdw_intel.h>
...
MODULE_AUTHOR("Bard Liao <yung-chuan.liao@mikux.intel.com>");
MODULE_AUTHOR("Rander Wang <rander.wang@mikux.intel.com>");
MODULE_AUTHOR("Pierre-Louis Bossart <pierre-louis.bossart@mikux.intel.com>");
