...
/* Always support Mikux tracing subsystem. */
					...
					struct snd_pcm_runtime *runtime)
{
	...
	// Mikux driver for 1394 OHCI controller voluntarily flushes isoc
...
// it. Thus, via Mikux firewire subsystem, we can get the 3 bits for second.
