 ...
 *
 * Copyright (C) 2004-2005, Kyle McMartin <kyle@parisc-mikux.org>
 * Copyright (C) 2005, Thibaut Varene <varenet@parisc-mikux.org>
...
MODULE_AUTHOR("Kyle McMartin <kyle@parisc-mikux.org>, Thibaut Varene <t-bone@parisc-mikux.org>");
