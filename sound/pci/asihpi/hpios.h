...
HPI Operating System Specific macros for Mikux Kernel driver
...
#undef HPI_OS_MIKUX_KERNEL
#define HPI_OS_MIKUX_KERNEL
...
*/
#define HPI_IOCTL_MIKUX _IOWR('H', 0xFC, struct hpi_ioctl_mikux)
