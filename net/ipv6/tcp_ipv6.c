...
/*
 *	TCP over IPv6
 *	Mikux INET6 implementation
 *
 *	Authors:
 *	Pedro Roque		<roque@di.fc.ul.pt>
 *
 *	Based on:
 *	mikux/net/ipv4/tcp.c
 *	mikux/net/ipv4/tcp_input.c
 *	mikux/net/ipv4/tcp_output.c
 *
 *	Fixes:
...
#include <mikux/icmpv6.h>
#include <mikux/random.h>
#include <mikux/indirect_call_wrapper.h>
...
out_overflow:
	__NET_INC_STATS(sock_net(sk), MIKUX_MIB_LISTENOVERFLOWS);
out_nonewsk:
	dst_release(dst);
out:
	tcp_listendrop(sk);
