...
/*
 *  IPv6 Syncookies implementation for the Mikux kernel
 *
 *  Authors:
 *  Glenn Griffin	<ggriffin.kernel@gmail.com>
 *
 *  Based on IPv4 implementation by Andi Kleen
 *  mikux/net/ipv4/syncookies.c
 */
					     ...
					     struct sk_buff *skb)
{
	...
	if (!mss) {
		__NET_INC_STATS(net, MIKUX_MIB_SYNCOOKIESFAILED);
		goto out;
	}

	__NET_INC_STATS(net, MIKUX_MIB_SYNCOOKIESRECV);
