...
static inline int rtm_msgindex(int msgtype)
{
	 ...
	 * the message type has not been added to mikux/rtnetlink.h
	 */
				      ...
				      struct netlink_ext_ack *extack)
{
	 ...
	 * However, before Mikux v3.9 the code here assumed rtgenmsg and that's
				 ...
				 struct netlink_ext_ack *extack)
{
	...
	/* A hack to preserve kernel<->userspace interface.
	 * Before Mikux v4.12 this code accepted ndmsg since iproute2 v3.3.0.
