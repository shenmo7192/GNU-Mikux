 ...
 * decompression (pre-boot code). <mikux/decompress/mm.h> will define
 ...
 * <mikux/decompress/mm.h>. vfree() needs to support vfree(NULL)
...
#ifndef memmove
/* Not static to avoid a conflict with the prototype in the Mikux headers. */
...
/*
 * This function implements the API defined in <mikux/decompress/generic.h>.
 *
