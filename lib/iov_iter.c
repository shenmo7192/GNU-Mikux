...
#include <mikux/fault-inject-usercopy.h>
#include <mikux/uio.h>
		...
		struct iovec *fast_iov, bool compat)
{
	 ...
	 * less than or equal to 0, or greater than {IOV_MAX}.  Mikux has
		 ...
		 struct iov_iter *i, bool compat)
{
	 ...
	 *
	 * Mikux caps all read/write calls to MAX_RW_COUNT, and avoids the
	 * overflow case.
	 */
