...
unsigned char vmmikux_build_id[BUILD_ID_SIZE_MAX] __ro_after_init;

/**
 * init_vmmikux_build_id - Compute and stash the running kernel's build ID
 */
void __init init_vmmikux_build_id(void)
{
	extern const void __start_notes;
	extern const void __stop_notes;
	unsigned int size = &__stop_notes - &__start_notes;

	build_id_parse_buf(&__start_notes, vmmikux_build_id, size);
}
#endif
