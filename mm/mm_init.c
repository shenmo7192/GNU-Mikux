...
#include <mikux/page-isolation.h>
 ...
 * include/mikux/pageblock-flags.h for the values of pageblock_order based on
 * the kernel config
 */
void __init set_pageblock_order(void)
{
...
static void __init mem_init_print_info(void)
{
	 ...
	 *    please refer to arch/tile/kernel/vmmikux.lds.S.
