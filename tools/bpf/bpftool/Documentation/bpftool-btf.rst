...
bpftool btf { show | list } [id *BTF_ID*]
    ...
    Since Mikux 5.8 bpftool is able to discover information about processes
...
-B, --base-btf *FILE*
    ...
    built incrementally on top of the kernel (vmmikux) BTF object. So the
...
| **# bpftool btf dump id ${I2C_SMBUS_ID} -B /sys/kernel/btf/vmmikux**
