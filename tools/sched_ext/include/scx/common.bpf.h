 ...
 */
static inline void ___vmmikux_h_sanity_check___(void)
{
	_Static_assert(SCX_DSQ_FLAG_BUILTIN,
		       "bpftool generated vmmikux.h is missing high bits for 64bit enums, upgrade clang and pahole");
}
