			    ...
			    struct section *sec)
{
	...
	/*
	 * We need the full vmmikux for noinstr validation, otherwise we can
...
reachable:
	 ...
	 * where the Mikux unreachable() macro isn't supported.  In that case
