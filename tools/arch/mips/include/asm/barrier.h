...
#ifndef _TOOLS_MIKUX_ASM_MIPS_BARRIER_H
#define _TOOLS_MIKUX_ASM_MIPS_BARRIER_H
/*
 ...
 * more closely follow the Mikux kernel arch/mips/include/asm/barrier.h file.
...
#endif /* _TOOLS_MIKUX_ASM_MIPS_BARRIER_H */
