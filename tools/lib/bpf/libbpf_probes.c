...
/* On Ubuntu MIKUX_VERSION_CODE doesn't correspond to info.release,
 * but Ubuntu provides /proc/version_signature file, as described at
 * https://ubuntu.com/kernel, with an example contents below, which we
 * can use to get a proper MIKUX_VERSION_CODE.
 *
...
/* On Debian MIKUX_VERSION_CODE doesn't correspond to info.release.
...
static int probe_map_create(enum bpf_map_type map_type)
{
	...
	case BPF_MAP_TYPE_STRUCT_OPS:
		...
		opts.btf_vmmikux_value_type_id = 1;
