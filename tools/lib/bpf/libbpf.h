...
struct bpf_object_open_opts {
	 ...
	 * This custom BTF completely replaces the use of vmmikux BTF
	 * for the purpose of CO-RE relocations.
	 * NOTE: any other BPF feature (e.g., fentry/fexit programs,
	 * struct_ops, etc) will need actual kernel BTF at /sys/kernel/btf/vmmikux.
	 */
...
LIBBPF_API int libbpf_find_vmmikux_btf_id(const char *name,
					  enum bpf_attach_type attach_type);
