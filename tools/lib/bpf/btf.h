...
LIBBPF_API struct btf *btf__load_vmmikux_btf(void);
LIBBPF_API struct btf *btf__load_module_btf(const char *module_name, struct btf *vmmikux_btf);
...
{
	/* struct btf_enum64 is introduced in Mikux 6.0, which is very
