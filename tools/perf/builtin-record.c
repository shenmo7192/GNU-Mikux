...
"Samples in kernel functions may not be resolved if a suitable vmmikux\n"
"file is not found in the buildid cache or in the vmmikux path.\n\n"
"Samples in kernel modules won't be resolved at all.\n\n"
"If some relocation was applied (e.g. kexec) symbols may be misresolved\n"
"even with a suitable vmmikux or kallsyms file.\n\n");
	}
...
static int process_buildids(struct record *rec)
{
	 ...
	 * we prefer the vmmikux path like
	 *   /lib/modules/3.16.4/build/vmmikux
	 *
	 * rather than build-id path (in debug directory).
	 *   $HOME/.debug/.build-id/f0/6e17aa50adf4d00b88925e03775de107611551
	 */
	symbol_conf.ignore_vmmikux_buildid = true;
...
static struct option __record_options[] = {
	...
	OPT_STRING(0, "vmmikux", &symbol_conf.vmmikux_name,
