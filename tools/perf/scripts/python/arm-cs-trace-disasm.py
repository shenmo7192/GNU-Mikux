...
#		-- -d objdump -k path/to/vmmikux
# Output disassembly with llvm-objdump:
#  perf script -s scripts/python/arm-cs-trace-disasm.py \
#		-- -d llvm-objdump-11 -k path/to/vmmikux
...
option_list = [
	...
	make_option("-k", "--vmmikux", dest="vmmikux_name",
		    help="Set path to vmmikux file"),
...
def get_dso_file_path(dso_name, dso_build_id):
	if (dso_name == "[kernel.kallsyms]" or dso_name == "vmmikux"):
		if (options.vmmikux_name):
			return options.vmmikux_name;
		else:
			return dso_name
