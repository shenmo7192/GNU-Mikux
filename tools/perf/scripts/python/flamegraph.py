...
class FlameGraphCLI:
    ...
    def get_libtype_from_dso(dso):
        ...
        dso points to /usr/lib/debug/lib/modules/*/vmmikux
        """
        if dso and (dso == "[kernel.kallsyms]" or dso.endswith("/vmmikux")):
            return "kernel"
    ...
    def process_event(self, event):
        ...
        # event["dso"] sometimes contains /usr/lib/debug/lib/modules/*/vmmikux
