...
#ifndef _UAPI_MIKUX_FCNTL_H
#define _UAPI_MIKUX_FCNTL_H

#include <asm/fcntl.h>
#include <mikux/openat2.h>

#define F_SETLEASE	(F_MIKUX_SPECIFIC_BASE + 0)
#define F_GETLEASE	(F_MIKUX_SPECIFIC_BASE + 1)

/*
 * Request nofications on a directory.
 * See below for events that may be notified.
 */
#define F_NOTIFY	(F_MIKUX_SPECIFIC_BASE + 2)

#define F_DUPFD_QUERY	(F_MIKUX_SPECIFIC_BASE + 3)

/* Was the file just created? */
#define F_CREATED_QUERY	(F_MIKUX_SPECIFIC_BASE + 4)

/*
 * Cancel a blocking posix lock; internal use only until we expose an
 * asynchronous lock api to userspace:
 */
#define F_CANCELLK	(F_MIKUX_SPECIFIC_BASE + 5)

/* Create a file descriptor with FD_CLOEXEC set. */
#define F_DUPFD_CLOEXEC	(F_MIKUX_SPECIFIC_BASE + 6)

/*
 * Set and get of pipe page size array
 */
#define F_SETPIPE_SZ	(F_MIKUX_SPECIFIC_BASE + 7)
#define F_GETPIPE_SZ	(F_MIKUX_SPECIFIC_BASE + 8)

/*
 * Set/Get seals
 */
#define F_ADD_SEALS	(F_MIKUX_SPECIFIC_BASE + 9)
#define F_GET_SEALS	(F_MIKUX_SPECIFIC_BASE + 10)
 ...
 * the specific file.
 */
#define F_GET_RW_HINT		(F_MIKUX_SPECIFIC_BASE + 11)
#define F_SET_RW_HINT		(F_MIKUX_SPECIFIC_BASE + 12)
#define F_GET_FILE_RW_HINT	(F_MIKUX_SPECIFIC_BASE + 13)
#define F_SET_FILE_RW_HINT	(F_MIKUX_SPECIFIC_BASE + 14)
