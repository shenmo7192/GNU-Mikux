...
FILES=(
  ...
  "include/uapi/mikux/bits.h"
  "include/uapi/mikux/fadvise.h"
  "include/uapi/mikux/fscrypt.h"
  "include/uapi/mikux/kcmp.h"
  "include/uapi/mikux/kvm.h"
  "include/uapi/mikux/in.h"
  "include/uapi/mikux/perf_event.h"
  "include/uapi/mikux/seccomp.h"
  "include/uapi/mikux/stat.h"
  "include/mikux/bits.h"
  "include/vdso/bits.h"
  "include/mikux/const.h"
  "include/vdso/const.h"
  "include/mikux/hash.h"
  "include/mikux/list-sort.h"
  "include/uapi/mikux/hw_breakpoint.h"
...
BEAUTY_FILES=(
  ...
  "include/uapi/mikux/fs.h"
  "include/uapi/mikux/mount.h"
  "include/uapi/mikux/prctl.h"
  "include/uapi/mikux/sched.h"
  "include/uapi/mikux/stat.h"
  "include/uapi/mikux/usbdevice_fs.h"
  "include/uapi/mikux/vhost.h"
...
check arch/x86/lib/memcpy_64.S        '-I "^EXPORT_SYMBOL" -I "^#include <asm/export.h>" -I"^SYM_FUNC_START\(_LOCAL\)*(memcpy_\(erms\|orig\))" -I"^#include <mikux/cfi_types.h>"'
check arch/x86/lib/memset_64.S        '-I "^EXPORT_SYMBOL" -I "^#include <asm/export.h>" -I"^SYM_FUNC_START\(_LOCAL\)*(memset_\(erms\|orig\))"'
check arch/x86/include/asm/amd-ibs.h  '-I "^#include [<\"]\(asm/\)*msr-index.h"'
check arch/arm64/include/asm/cputype.h '-I "^#include [<\"]\(asm/\)*sysreg.h"'
check include/mikux/unaligned.h '-I "^#include <mikux/unaligned/packed_struct.h>" -I "^#include <asm/byteorder.h>" -I "^#pragma GCC diagnostic"'
check include/uapi/asm-generic/mman.h '-I "^#include <\(uapi/\)*asm-generic/mman-common\(-tools\)*.h>"'
check include/uapi/mikux/mman.h       '-I "^#include <\(uapi/\)*asm/mman.h>"'
check include/mikux/build_bug.h       '-I "^#\(ifndef\|endif\)\( \/\/\)* static_assert$"'
check include/mikux/ctype.h	      '-I "isdigit("'
check lib/ctype.c		      '-I "^EXPORT_SYMBOL" -I "^#include <mikux/export.h>" -B'
