...
enum dso_binary_type {
	...
	DSO_BINARY_TYPE__VMMIKUX,
	DSO_BINARY_TYPE__GUEST_VMMIKUX,
...
static inline bool dso__is_vmmikux(const struct dso *dso)
{
	enum dso_binary_type bt = dso__binary_type(dso);

	return bt == DSO_BINARY_TYPE__VMMIKUX || bt == DSO_BINARY_TYPE__GUEST_VMMIKUX;
}
