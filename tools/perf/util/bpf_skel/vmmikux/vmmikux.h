...
#include <mikux/stddef.h> // for define __always_inline
#include <mikux/bpf.h>
 ...
 * (BTF_KIND_STRUCT). The definition appears in vmmikux.h rather than
 * lock_contention.bpf.c for consistency with a generated vmmikux.h.
 */
struct rq {};
