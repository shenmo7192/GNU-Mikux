...
/******************************************************************************
 *
 * Module Name: osmikuxtbl - Mikux OSL for obtaining ACPI tables
 *
 ...
 *
 * NOTE:        This works on Mikux as table customization does not modify the
 ...
 *
 * PARAMETERS:  pathname        - Directory to find Mikux customized table
