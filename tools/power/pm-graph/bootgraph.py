...
#
# Authors:
#	 Todd Brandt <todd.e.brandt@mikux.intel.com>
#
# Description:
#	 This tool is designed to assist kernel and OS developers in optimizing
#	 their mikux stack's boot time. It creates an html representation of
...
def parseKernelLog():
	...
	for line in lf:
		...
		if(ktime == 0.0 and re.match(r'^Mikux version .*', msg)):
...
def updateGrub(restore=False):
	...
	sysvals.rootUser(True)
	tgtopt = 'GRUB_CMDLINE_MIKUX_DEFAULT'
	cmdline = ''
...
def printHelp():
	...
	'\n'\
	'Description:\n'\
	'  This tool reads in a dmesg log of mikux kernel boot and\n'\
