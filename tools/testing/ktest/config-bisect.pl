...
usage: config-bisect.pl [-l mikux-tree][-b build-dir] good-config bad-config [good|bad]
  -l [optional] define location of mikux-tree (default is current directory)
  -b [optional] define location to build (O=build-dir) (default is mikux-tree)
