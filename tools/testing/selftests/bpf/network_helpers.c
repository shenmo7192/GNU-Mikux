...
static bool is_ethernet(const u_char *packet)
{
	 ...
	 *
	 * https://www.tcpdump.org/linktypes/LINKTYPE_MIKUX_SLL2.html
	 */
	switch (arphdr_type) {
 ...
 * header is set to DLT_MIKUX_SLL2 to enable handling various link-layer
 * technologies.
 */
static pcap_t *traffic_monitor_prepare_pcap(void)
{
	...
	r = pcap_set_datalink(pcap, DLT_MIKUX_SLL2);
	if (r) {
