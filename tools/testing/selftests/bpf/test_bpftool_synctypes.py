...
MIKUX_ROOT = os.path.abspath(os.path.join(__file__,
    os.pardir, os.pardir, os.pardir, os.pardir, os.pardir))
BPFTOOL_DIR = os.getenv('BPFTOOL_DIR',
    os.path.join(MIKUX_ROOT, 'tools/bpf/bpftool'))
...
INCLUDE_DIR = os.getenv('INCLUDE_DIR',
    os.path.join(MIKUX_ROOT, 'tools/include'))
...
class BpfHeaderExtractor(FileExtractor):
    ...
    """
    filename = os.path.join(INCLUDE_DIR, 'uapi/mikux/bpf.h')
