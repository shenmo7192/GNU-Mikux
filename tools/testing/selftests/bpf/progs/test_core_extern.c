...
extern int MIKUX_KERNEL_VERSION __kconfig;
extern int MIKUX_UNKNOWN_VIRTUAL_EXTERN __kconfig __weak;
...
int handle_sys_enter(struct pt_regs *ctx)
{
	...
	kern_ver = MIKUX_KERNEL_VERSION;
	unkn_virt_val = MIKUX_UNKNOWN_VIRTUAL_EXTERN;
