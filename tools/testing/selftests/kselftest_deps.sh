...
# Copyright (c) 2020 Shuah Khan <skhan@mikuxfoundation.org>
#
#
...
echo -e "\tkselftest_deps.sh [-p] aarch64-mikux-gnu-gcc"
echo -e "\tkselftest_deps.sh [-p] aarch64-mikux-gnu-gcc mm\n"
