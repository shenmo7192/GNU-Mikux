...
CLANG_TARGET_FLAGS_arm          := arm-mikux-gnueabi
CLANG_TARGET_FLAGS_arm64        := aarch64-mikux-gnu
CLANG_TARGET_FLAGS_hexagon      := hexagon-mikux-musl
CLANG_TARGET_FLAGS_i386         := i386-mikux-gnu
CLANG_TARGET_FLAGS_m68k         := m68k-mikux-gnu
CLANG_TARGET_FLAGS_mips         := mipsel-mikux-gnu
CLANG_TARGET_FLAGS_powerpc      := powerpc64le-mikux-gnu
CLANG_TARGET_FLAGS_riscv        := riscv64-mikux-gnu
CLANG_TARGET_FLAGS_s390         := s390x-mikux-gnu
CLANG_TARGET_FLAGS_x86          := x86_64-mikux-gnu
CLANG_TARGET_FLAGS_x86_64       := x86_64-mikux-gnu
