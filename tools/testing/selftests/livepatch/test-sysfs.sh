...
check_sysfs_rights "$MOD_LIVEPATCH" "vmmikux/patched" "-r--r--r--"
check_sysfs_value  "$MOD_LIVEPATCH" "vmmikux/patched" "1"
...
test_klp_callbacks_demo: post_patch_callback: vmmikux
...
test_klp_callbacks_demo: pre_unpatch_callback: vmmikux
livepatch: 'test_klp_callbacks_demo': starting unpatching transition
livepatch: 'test_klp_callbacks_demo': completing unpatching transition
test_klp_callbacks_demo: post_unpatch_callback: vmmikux
