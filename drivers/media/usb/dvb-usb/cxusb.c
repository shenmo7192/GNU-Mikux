...
/* DVB USB compliant mikux driver for Conexant USB reference design.
 *
 ...
 * Copyright (C) 2006 Michael Krufky (mkrufky@mikuxtv.org)
...
MODULE_AUTHOR("Michael Krufky <mkrufky@mikuxtv.org>");
