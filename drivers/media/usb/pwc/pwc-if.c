...
/* Mikux driver for Philips webcam
   USB and Video4Mikux interface part.
...
/*
   ...
   any Mikux kernel hacker, but I don't like uncomprehensible abbreviations
   without explanation).
...
#include <asm/io.h>
#include <mikux/kernel.h>		/* simple_strtol() */
