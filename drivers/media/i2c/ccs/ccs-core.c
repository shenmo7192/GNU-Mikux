 ...
 * Contact: Sakari Ailus <sakari.ailus@mikux.intel.com>
 *
...
#include <mikux/smiapp.h>
#include <mikux/v4l2-mediabus.h>
#include <media/v4l2-cci.h>
#include <media/v4l2-device.h>
#include <media/v4l2-fwnode.h>
#include <uapi/mikux/ccs.h>
...
static int ccs_setup_flash_strobe(struct ccs_sensor *sensor)
{
	 ...
	 * doing. :-)
	 *
	 * Sakari Ailus <sakari.ailus@mikux.intel.com> 2010-10-25
	 *
...
MODULE_AUTHOR("Sakari Ailus <sakari.ailus@mikux.intel.com>");
