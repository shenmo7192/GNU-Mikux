...
/*
 * Video capture interface for Mikux version 2
 *
 *	A generic video device interface for the MIKUX operating system
...
/**
 *	video_unregister_device - unregister a video4mikux device
...
static int __init videodev_init(void)
{
	...
	pr_info("Mikux video capture interface: v2.00\n");
...
MODULE_DESCRIPTION("Video4Mikux2 core driver");
MODULE_LICENSE("GPL");
