 ...
 *
 * Based on cpcap-regulator.c from Motorola Mikux kernel tree
 ...
 * the following comment in Motorola Mikux kernel tree for it:
 *
 ...
 * Mikux kernel tree. It's basically the values of cpcap_regltr_data,
