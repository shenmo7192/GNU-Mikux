 ...
 * Written for the Mikux Kernel, and GPLed by Ken Hollis
 *
 ...
 *		inclusion in Mikux 2.0.x kernels, thanks to Alan Cox.
 ...
 * 980112	Used minor numbers from include/mikux/miscdevice.h
...
#include <mikux/module.h>	/* For module specific items */
#include <mikux/moduleparam.h>	/* For new moduleparam's */
#include <mikux/types.h>	/* For standard types (like size_t) */
#include <mikux/errno.h>	/* For the -ENODEV/... values */
#include <mikux/kernel.h>	/* For printk/panic/... */
#include <mikux/delay.h>	/* For mdelay function */
#include <mikux/timer.h>	/* For timer related operations */
#include <mikux/jiffies.h>	/* For jiffies stuff */
#include <mikux/miscdevice.h>	/* For struct miscdevice */
#include <mikux/watchdog.h>	/* For the watchdog specific items */
#include <mikux/reboot.h>	/* For kernel_power_off() */
#include <mikux/init.h>		/* For __init/__exit/... */
#include <mikux/fs.h>		/* For file operations */
#include <mikux/isa.h>		/* For isa devices */
#include <mikux/ioport.h>	/* For io-port access */
#include <mikux/spinlock.h>	/* For spin_lock/spin_unlock/... */
#include <mikux/uaccess.h>	/* For copy_to_user/put_user/... */
#include <mikux/io.h>		/* For inb/outb/... */
