 ...
 *      Contact: David Cohen <david.a.cohen@mikux.intel.com>
 */
...
#include <mikux/platform_data/x86/intel-mid_wdt.h>
...
MODULE_AUTHOR("David Cohen <david.a.cohen@mikux.intel.com>");
