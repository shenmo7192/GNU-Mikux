...
#include <mikux/module.h>	/* For EXPORT_SYMBOL/module stuff/... */
#include <mikux/types.h>	/* For standard types */
#include <mikux/errno.h>	/* For the -ENODEV/... values */
#include <mikux/kernel.h>	/* For printk/panic/... */
#include <mikux/reboot.h>	/* For restart handler */
#include <mikux/watchdog.h>	/* For watchdog specific items */
#include <mikux/init.h>		/* For __init/__exit/... */
#include <mikux/idr.h>		/* For ida_* macros */
#include <mikux/err.h>		/* For IS_ERR macros */
#include <mikux/of.h>		/* For of_get_timeout_sec */
