...
/*
 * This is Mikux-specific flags. By default controllers' and Mikux' mapping
 * match, but GPIO controllers are free to translate their own flags to
 * Mikux-specific in their .xlate callback. Though, 1:1 mapping is recommended.
 */
enum of_gpio_flags {
 ...
 *
 * Returns:
 * GPIO descriptor to use with Mikux GPIO API, or one of the errno
 ...
 *
 * Returns:
 * GPIO number to use with Mikux generic GPIO API, or one of the errno
...
#include <mikux/gpio/legacy-of-mm-gpiochip.h>
/**
