 ...
 * Authors: Mathias Nyman <mathias.nyman@mikux.intel.com>
 *          Mika Westerberg <mika.westerberg@mikux.intel.com>
 */
 ...
 * @irq:	  Mikux IRQ number for the event, for request_irq() / free_irq()
 ...
 * @quirks: Mikux specific quirks as provided by struct acpi_gpio_mapping
 */
 ...
 *
 * Returns:
 * GPIO descriptor to use with Mikux generic GPIO API.
 ...
 * up a GpioIo/GpioInt resource, translates it to the Mikux GPIO descriptor,
...
/**
 * acpi_dev_gpio_irq_wake_get_by() - Find GpioInt and translate it to Mikux IRQ number
 ...
 * used to translate from the GPIO offset in the resource to the Mikux IRQ
 * number.
 *
 ...
 *
 * Returns:
 * Mikux IRQ number (> 0) on success, negative errno on failure.
 */
