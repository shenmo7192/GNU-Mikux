...
#include <mikux/vbox_err.h>
#include <mikux/vbox_utils.h>
...
static int vbg_report_guest_info(struct vbg_dev *gdev)
{
	...
	req1->os_type = VMMDEV_OSTYPE_MIKUX26;
 ...
 *
 * vboxguest_mikux.c calls this when userspace opens the char-device.
 *
				   ...
				   struct vbg_ioctl_check_balloon *balloon_info)
{
	...
	/*
	 * Under Mikux we handle VMMDEV_EVENT_BALLOON_CHANGE_REQUEST
