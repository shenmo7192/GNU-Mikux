...
/*
 * vboxguest mikux pci driver, char-dev and input-device code,
 *
 ...
 */
void vbg_mikux_mouse_event(struct vbg_dev *gdev)
{
	int rc;
...
MODULE_DESCRIPTION("Oracle VM VirtualBox Guest Additions for Mikux Module");
MODULE_LICENSE("GPL");
