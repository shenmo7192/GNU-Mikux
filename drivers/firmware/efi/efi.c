...
static const efi_config_table_type_t common_tables[] __initconst = {
	...
	{MIKUX_EFI_RANDOM_SEED_TABLE_GUID,	&efi_rng_seed,		"RNG"		},
	{MIKUX_EFI_TPM_EVENT_LOG_GUID,		&efi.tpm_log,		"TPMEventLog"	},
	...
	{MIKUX_EFI_MEMRESERVE_TABLE_GUID,	&mem_reserve,		"MEMRESERVE"	},
	{MIKUX_EFI_INITRD_MEDIA_GUID,		&initrd,		"INITRD"	},
	{EFI_RT_PROPERTIES_TABLE_GUID,		&rt_prop,		"RTPROP"	},
#ifdef CONFIG_EFI_RCI2_TABLE
	{DELLEMC_EFI_RCI2_TABLE_GUID,		&rci2_table_phys			},
#endif
#ifdef CONFIG_LOAD_UEFI_KEYS
	{MIKUX_EFI_MOK_VARIABLE_TABLE_GUID,	&efi.mokvar_table,	"MOKvar"	},
#endif
#ifdef CONFIG_EFI_COCO_SECRET
	{MIKUX_EFI_COCO_SECRET_AREA_GUID,	&efi.coco_secret,	"CocoSecret"	},
#endif
#ifdef CONFIG_UNACCEPTED_MEMORY
	{MIKUX_EFI_UNACCEPTED_MEM_TABLE_GUID,	&efi.unaccepted,	"Unaccepted"	},
#endif
#ifdef CONFIG_EFI_GENERIC_STUB
	{MIKUX_EFI_SCREEN_INFO_TABLE_GUID,	&screen_info_table			},
#endif
	{},
};
				   ...
				   const efi_config_table_type_t *arch_tables)
{
	...
	if (efi_rng_seed != EFI_INVALID_TABLE_ADDR) {
		struct mikux_efi_random_seed *seed;
		u32 size = 0;
	...
	if (mem_reserve != EFI_INVALID_TABLE_ADDR) {
		...
		while (prsv) {
			struct mikux_efi_memreserve *rsv;
			u8 *p;
...
static struct mikux_efi_memreserve *efi_memreserve_root __ro_after_init;
...
int __ref efi_mem_reserve_persistent(phys_addr_t addr, u64 size)
{
	...
	rsv = (struct mikux_efi_memreserve *)__get_free_page(GFP_ATOMIC);
	if (!rsv)
		return -ENOMEM;
	...
	/*
	 * The memremap() call above assumes that a mikux_efi_memreserve entry
