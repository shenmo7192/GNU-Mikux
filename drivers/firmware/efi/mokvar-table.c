 ...
 *
 * This module contains the kernel support for the Mikux EFI Machine
 * Owner Key (MOK) variable configuration table, which is identified by
 * the MIKUX_EFI_MOK_VARIABLE_TABLE_GUID.
 *
...
/*
 * The MIKUX_EFI_MOK_VARIABLE_TABLE_GUID config table is a packed
