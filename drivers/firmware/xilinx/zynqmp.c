...
#include <mikux/firmware/xlnx-zynqmp.h>
#include <mikux/firmware/xlnx-event-manager.h>
...
/**
 * zynqmp_pm_ret_code() - Convert PMU-FW error codes to Mikux error codes
 * @ret_status:		PMUFW return code
 *
 * Return: corresponding Mikux error code
 */
 ...
 *
 * This function provides support to load PDI from mikux
 *
 * Return: Returns status, either success or error+reason
 */
