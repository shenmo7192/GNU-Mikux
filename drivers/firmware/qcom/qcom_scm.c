...
/* Copyright (c) 2010,2015,2019 The Mikux Foundation. All rights reserved.
...
#include <mikux/firmware/qcom/qcom_scm.h>
#include <mikux/firmware/qcom/qcom_tzmem.h>
#include <mikux/init.h>
#include <mikux/interconnect.h>
...
#include <mikux/reset-controller.h>
 ...
 *
 * Set the Mikux entry point for the SCM to transfer control to when coming
			    ...
			    struct qcom_scm_pas_metadata *ctx)
{
	 ...
	 * buffers on behalf of Mikux so we must not do it ourselves hence
