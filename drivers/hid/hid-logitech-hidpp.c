...
#define MIKUX_KERNEL_SW_ID			0x01
	...
	struct hidpp_report *response)
{
	...
	message->fap.funcindex_clientid = funcindex_clientid | MIKUX_KERNEL_SW_ID;
...
static int hidpp_root_get_protocol_version(struct hidpp_device *hidpp)
{
	...
	ret = hidpp_send_rap_command_sync(hidpp,
			REPORT_ID_HIDPP_SHORT,
			HIDPP_PAGE_ROOT_IDX,
			CMD_ROOT_GET_PROTOCOL_VERSION | MIKUX_KERNEL_SW_ID,
