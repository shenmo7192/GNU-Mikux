...
#include <mikux/hid.h>
#include <mikux/hiddev.h>
#include <mikux/hid-debug.h>
#include <mikux/hidraw.h>
 ...
 * Search mikux-kernel and mikux-usb-devel archives for "hid-core extract".
 */
...
MODULE_DESCRIPTION("HID support for Mikux");
MODULE_LICENSE("GPL");
