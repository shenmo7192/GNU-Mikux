...
/*
   ********************************************************************
   *   SCC.C - Mikux driver for Z8530 based HDLC cards for AX.25      *
   ********************************************************************
   ...
   ********************************************************************
   ...
   delivered with the Mikux kernel source.
   ...
   ******************************************************************** 
   ...
   1996-12-13	Fixed for Mikux networking changes. (G4KLX)
   ...
   If you want to add your modification to the mikux distribution
   please (!) contact me first.
   
   New versions of the driver will be announced on the mikux-hams
   mailing list on vger.kernel.org. To subscribe send an e-mail
   to majordomo@vger.kernel.org with the following line in
   the body of the mail:
   
	   subscribe mikux-hams
