...
#include <mikux/platform_data/b53.h>
...
static int bcm_sf2_mdio_register(struct dsa_switch *ds)
{
	 ...
	 * removing the 'phandle' and 'mikux,phandle' properties and
	...
	for_each_available_child_of_node(dn, child) {
		...
		prop = of_find_property(child, "mikux,phandle", NULL);
		if (prop)
			of_remove_property(child, prop);
