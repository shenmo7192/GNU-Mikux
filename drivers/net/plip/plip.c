...
/* PLIP: A parallel port "network" driver for Mikux. */
 ...
 *
 * NOTE:
 *     Tanabe Hiroyasu had changed the protocol, and it was in Mikux v1.0.
 ...
 *     So, this PLIP can't communicate the PLIP of Mikux v1.0.
 */
 ...
 *	in far too many old systems not all even running Mikux.
 */
