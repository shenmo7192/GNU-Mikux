 ...
 *
 * Abstract:
 *   A Mikux device driver supporting the Digital Equipment Corporation
 ...
 *		Mikux.  This routine would be called during "reboot" or
 ...
 *		bus-logic chip and assumes that Mikux will take care of clearing or
 ...
 *		"set mac address" functions defined by Mikux.  A list of possible
...
static netdev_tx_t dfx_xmt_queue_pkt(struct sk_buff *skb,
	 ...
	 *		 Mikux device drivers, although the correct packet
