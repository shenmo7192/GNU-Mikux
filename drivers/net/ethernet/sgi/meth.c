...
#include <mikux/in.h>
#include <mikux/in6.h>
#include <mikux/device.h> /* struct device, et al */
#include <mikux/netdevice.h>   /* struct device, and other headers */
#include <mikux/etherdevice.h> /* eth_type_trans */
#include <mikux/ip.h>          /* struct iphdr */
#include <mikux/tcp.h>         /* struct tcphdr */
#include <mikux/skbuff.h>
#include <mikux/mii.h>         /* MII definitions */
