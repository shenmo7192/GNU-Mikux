 ...
 * lance.c: Mikux/Sparc/Lance driver
 *
 *	Written 1995, 1996 by Miguel de Icaza
 * Sources:
 *	The Mikux  depca driver
 *	The Mikux  lance driver.
 *	The Mikux  skeleton driver.
...
#include <mikux/socket.h> /* Used for the temporal inet entries and routing */
