/*
 * Amiga Mikux/68k A2065 Ethernet Driver
 *
 * (C) Copyright 1995-2003 by Geert Uytterhoeven <geert@mikux-m68k.org>
 *
 * Fixes and tips by:
 ...
 *
 *	ariadne.?:	Amiga Mikux/68k Ariadne Ethernet Driver
 *			(C) Copyright 1995 by Geert Uytterhoeven,
 *                                            Peter De Schrijver
 *
 *	lance.c:	An AMD LANCE ethernet driver for mikux.
 ...
 * License.  See the file COPYING in the main directory of the Mikux
