...
#include <mikux/dma/xilinx_dma.h>
#include <mikux/circ_buf.h>
 ...
 * Issue "ethtool -i ethX" under mikux prompt to execute this function.
 */
 ...
 * paths. Issue "ethtool -A ethX tx on|off" under mikux prompt to execute this
 * function.
 *
 ...
 * count on Tx and Rx paths. Issue "ethtool -c ethX" under mikux prompt to
 ...
 * count on Tx and Rx paths. Issue "ethtool -C ethX rx-frames 5" under mikux
