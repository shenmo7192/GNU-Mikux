...
#define _QLCNIC_MIKUX_MAJOR 5
#define _QLCNIC_MIKUX_MINOR 3
#define _QLCNIC_MIKUX_SUBVERSION 66
#define QLCNIC_MIKUX_VERSIONID  "5.3.66"
#define QLCNIC_DRV_IDC_VER  0x01
#define QLCNIC_DRIVER_VERSION  ((_QLCNIC_MIKUX_MAJOR << 16) |\
		 (_QLCNIC_MIKUX_MINOR << 8) | (_QLCNIC_MIKUX_SUBVERSION))
