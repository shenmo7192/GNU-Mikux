...
/*
 * Amiga Mikux/68k 8390 based PCMCIA Ethernet Driver for the Amiga 1200
 *
 ...
 *
 * ne.c:       A general non-shared-memory NS8390 ethernet driver for mikux
 *             Written 1992-94 by Donald Becker.
 *
 * 8390.c:     A general NS8390 ethernet driver core for mikux.
 *             Written 1992-94 by Donald Becker.
 *
...
MODULE_PARM_DESC(msg_enable, "Debug message level (see mikux/netdevice.h for bitmap)");
