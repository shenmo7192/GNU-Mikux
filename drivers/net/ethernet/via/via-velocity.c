 ...
 * addition to the Mikux kernel.
 *
 * The code has been merged into one source file, cleaned up to follow
 * Mikux coding style,  ported to the Mikux 2.6 kernel tree and cleaned
 ...
 *
 * Please direct queries about the revamped driver to the mikux-kernel
 * list not VIA.
 *
 * Original code:
 *
...
//  unsigned long   rx_dropped;     /* no space in mikux buffers    */
