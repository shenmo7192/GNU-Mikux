...
/* I'd like a Big Mac, small fries, small coke, and SparcMikux please. */
...
/* Generic MII registers defined in mikux/mii.h, these below
...
struct quattro {
	...
	/* PROM ranges, if any. */
#ifdef CONFIG_SBUS
	struct mikux_prom_ranges  ranges[8];
#endif
	int			  nranges;
};
