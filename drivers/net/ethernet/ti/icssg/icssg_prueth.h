 ...
 * however Mikux sees only the host side port. The other 2 ports
 * are the switch ports.
 * In emac mode there are 2 real ports i.e. 2 mac addrs.
 * Mikux sees both the ports.
 */
enum prueth_port {
