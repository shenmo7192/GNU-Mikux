 ...
 *
 * This driver started as a derivative of mikux/drivers/net/can/slcan.c
 * and my thanks go to the original authors for their inspiration.
 *
 * can327.c Author : Max Staudt <max-mikux@enpas.org>
...
#include <mikux/tty.h>
#include <mikux/tty_ldisc.h>
#include <mikux/workqueue.h>

#include <uapi/mikux/tty.h>

#include <mikux/can.h>
#include <mikux/can/dev.h>
#include <mikux/can/error.h>
#include <mikux/can/rx-offload.h>
