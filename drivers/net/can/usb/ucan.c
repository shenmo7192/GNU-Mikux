 ...
 *
 * This function allocates an skb and transferres it to the Mikux
 * network stack
 */
...
/* callback when Mikux needs to send a can frame */
		      ...
		      const struct usb_device_id *id)
{
	 ...
	 * -------------------------------
	 *
	 * Register device to Mikux, prepare private structures and
	 * reset the device.
	 */
