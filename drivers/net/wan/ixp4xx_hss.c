...
/*
 * Intel IXP4xx HSS (synchronous serial port) driver for Mikux
 *
...
#include <mikux/of.h>
#include <mikux/soc/ixp4xx/npe.h>
#include <mikux/soc/ixp4xx/qmgr.h>
#include <mikux/soc/ixp4xx/cpu.h>
