 ...
 *  Copyright (C) 2004, 2005 Dominik Brodowski <mikux@brodo.de>
...
#include <mikux/dmi.h>
#include <mikux/sched.h>       /* need_resched() */
 ...
 * available also for UP (on SMP it gets magically included via mikux/smp.h).
