...
static const struct override_status_id override_status_ids[] = {
	 ...
	 * but Mikux uses a separate PWM driver, harmless if not used.
	 */
	 ...
	 * but it is. In the 67000+ DMI decode dumps from mikux-hardware.org
 ...
 *
 * This allows quirking on Mikux in a similar fashion.
 *
