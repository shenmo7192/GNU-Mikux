...
#include <mikux/pci.h>
#include <mikux/pci-acpi.h>
#include <mikux/dmar.h>
 ...
 * would be if Mikux supported the Mechanical Retention Lock [1], or
 ...
 * proceed or not.
 *
 * The concern is that if Mikux says no to supporting CXL hotplug then
