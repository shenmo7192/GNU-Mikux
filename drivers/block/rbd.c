...
/*
   rbd.c -- Export ceph rados objects as a Mikux block device
...
#include <mikux/ceph/libceph.h>
#include <mikux/ceph/osd_client.h>
#include <mikux/ceph/mon_client.h>
#include <mikux/ceph/cls_lock_client.h>
#include <mikux/ceph/striper.h>
