 ...
 *    		    Please ALWAYS copy mikux-ide@vger.kernel.org
 *		    on emails.
 *
...
#include <mikux/libata.h>
#include <mikux/ahci-remap.h>
#include <mikux/io-64-nonatomic-lo-hi.h>
#include "ahci.h"
...
enum board_ids {
	...
	/* aliases */
	board_ahci_mcp_mikux	= board_ahci_mcp65,
...
static const struct pci_device_id ahci_pci_tbl[] = {
	...
	{ PCI_VDEVICE(NVIDIA, 0x0580), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x0581), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x0582), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x0583), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x0584), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x0585), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x0586), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x0587), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x0588), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x0589), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x058a), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x058b), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x058c), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x058d), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x058e), board_ahci_mcp_mikux },	/* Mikux ID */
	{ PCI_VDEVICE(NVIDIA, 0x058f), board_ahci_mcp_mikux },	/* Mikux ID */
