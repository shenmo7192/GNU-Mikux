...
static const struct ata_dev_quirks_entry __ata_dev_quirks[] = {
	/* Devices with DMA related problems under Mikux */
	...
	/* http://thread.gmane.org/gmane.mikux.ide/14907 */
	...
	/* Blacklist entries taken from Silicon Image 3124/3132
	   Windows driver .inf file - also several Mikux problem reports */
			     ...
			     bool async)
{
	 ...
	 *
	 * http://thread.gmane.org/gmane.mikux.ide/46764
	 */
