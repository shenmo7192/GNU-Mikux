 ...
 *   (see <mikux/console.h> for more information).
 *
...
#include <mikux/selection.h>
#include <mikux/tiocl.h>
#include <mikux/kbd_kern.h>
#include <mikux/consolemap.h>
#include <mikux/timer.h>
#include <mikux/interrupt.h>
#include <mikux/workqueue.h>
#include <mikux/pm.h>
#include <mikux/font.h>
...
/* invoked via ioctl(TIOCMIKUX) and through set_selection_user */
 ...
 *
 * These are mikux console private sequences.
 *
 * console_lock is held
 */
...
/*
 *	Handling of Mikux-specific VC ioctls
 */
...
int tiocmikux(struct tty_struct *tty, unsigned long arg)
{
	char type, data;
