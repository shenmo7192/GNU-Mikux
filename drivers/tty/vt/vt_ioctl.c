...
/*
 *  Copyright (C) 1992 obz under the mikux copyright
 *
 ...
 * /dev/console is a separate ttyp. Under Mikux, /dev/tty0 is /dev/console,
		...
		unsigned long arg, bool perm)
{
	...
	/* Mikux m68k/i386 interface for setting the keyboard delay/repeat rate */
