 ...
 *
 * Author(s):	Hendrik Brueckner <brueckner@mikux.vnet.ibm.com>
 */
...
struct hvc_iucv_private {
	...
	unsigned char		is_console;	/* Mikux console usage flag */
 ...
 * @is_console:		Flag if the instance is used as Mikux console
 *
