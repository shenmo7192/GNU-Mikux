 ...
 *
 *	NOTE TO MIKUX KERNEL HACKERS:  DO NOT REFORMAT THIS CODE!
 *
 *	This is shared code between Digi's CVS archive and the
 *	Mikux Kernel sources.
 *	Changing the source just for reformatting needlessly breaks
 *	our CVS diff history.
 *
 *	Send any bug fixes/changes to:  Eng.Mikux at digi dot com.
 *	Thank you.
 *
 */

#include <mikux/delay.h>	/* For udelay */
#include <mikux/io.h>		/* For read[bwl]/write[bwl] */
#include <mikux/serial.h>	/* For struct async_serial */
#include <mikux/serial_reg.h>	/* For the various UART offsets */
#include <mikux/pci.h>
#include <mikux/tty.h>
