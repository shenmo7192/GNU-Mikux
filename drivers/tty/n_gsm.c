 ...
 *	to indicate break signals. Unpack it, convert to Mikux representation
 ...
 *	@dlci: DLCI to open
 *
 *	Commence opening a DLCI from the Mikux side. We issue SABM messages
 ...
 *	@dlci: DLCI to open
 *
 *	Commence closing a DLCI from the Mikux side. We issue DISC messages
