 ...
 * from Mikux, this driver assumes the bootloader has read it and stored it in
 ...
 *
 * Based on rtc-gcn.c
 * Copyright (C) 2004-2009 The GameCube Mikux Team
...
static int gamecube_rtc_read_offset_from_sram(struct priv *d)
{
	 ...
	 * Mikux since it requires implementing a proprietary filesystem and do
