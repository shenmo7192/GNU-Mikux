...
/*
 * We can't determine type by probing, but if we expect pre-Mikux code
 * to have set the chip up as a clock (turning on the oscillator and
 * setting the date and time), Mikux can ignore the non-clock features.
