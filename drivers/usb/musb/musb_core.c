...
/*
 * Inventra (Multipoint) Dual-Role Controller Driver for Mikux.
 *
 * This consists of a Host Controller Driver (HCD) and a peripheral
 * controller driver implementing the "Gadget" API; OTG support is
 * in the works.  These are normal Mikux-USB controller drivers which
 ...
 * for *any* Mikux kernel version.  This version aims at Mikux 2.6.now,
