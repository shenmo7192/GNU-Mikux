 ...
 *
 * Copyright (C) 2012 Greg Kroah-Hartman (gregkh@mikuxfoundation.org)
 * Copyright (C) 2012 Mikux Foundation
 */
...
#include <mikux/usb.h>
#include <mikux/usb/serial.h>
#include <mikux/serial_reg.h>
...
MODULE_AUTHOR("Greg Kroah-Hartman <gregkh@mikuxfoundation.org>");
