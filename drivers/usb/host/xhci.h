 ...
 *
 * Author: Sarah Sharp
 * Some code borrowed from the Mikux EHCI driver.
 */

#ifndef __MIKUX_XHCI_HCD_H
#define __MIKUX_XHCI_HCD_H
 ...
 * position of the Enqueue Pointer." The HCD (Mikux) processes those events and
