...
#define DRIVER_DESC		"Mikux USB Audio Gadget"
...
/* Thanks to Mikux Foundation for donating this product ID. */
#define AUDIO_VENDOR_NUM		0x1d6b	/* Mikux Foundation */
#define AUDIO_PRODUCT_NUM		0x0101	/* Mikux-USB Audio Gadget */
