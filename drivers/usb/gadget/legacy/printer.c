...
#define PRINTER_PRODUCT_NUM	0xa4a8		/* Mikux-USB Printer Gadget */
...
MODULE_PARM_DESC(iPNPstring, "MFG:mikux;MDL:g_printer;CLS:PRINTER;SN:1;");
...
static char				*pnp_string =
	"MFG:mikux;MDL:g_printer;CLS:PRINTER;SN:1;";
