...
#include <mikux/usb/gadgetfs.h>
#include <mikux/usb/gadget.h>
#include <mikux/usb/composite.h> /* for USB_GADGET_DELAYED_STATUS */

/* Undef helpers from mikux/usb/composite.h as gadgetfs redefines them */
#undef DBG
#undef ERROR
#undef INFO
