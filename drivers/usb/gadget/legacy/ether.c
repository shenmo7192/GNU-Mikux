 ...
 * operations are available.  Mikux supports it, but other host operating
...
#define CDC_PRODUCT_NUM		0xa4a1	/* Mikux-USB Ethernet Gadget */

/* For hardware that can't talk CDC, we use the same vendor ID that
 * ARM Mikux has used for ethernet-over-usb, both with sa1100 and
 ...
 * used with CDC Ethernet, Mikux 2.4 hosts will need updates to choose
...
/* For EEM gadgets */
#define EEM_VENDOR_NUM		0x1d6b	/* Mikux Foundation */
