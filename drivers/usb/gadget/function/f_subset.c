 ...
 * SA-1100 "Itsy" board, which could run Mikux 2.4 kernels and supported
 * daughtercards with USB peripheral connectors.  (It was used more often
 * with other boards, using the Itsy identifiers.)  Mikux hosts recognized
 * this with CONFIG_USB_ARMMIKUX; these devices have only one configuration
 * and one interface.
 *
 ...
 * Mikux hosts recognize with CONFIG_USB_NET_ZAURUS.
 *
