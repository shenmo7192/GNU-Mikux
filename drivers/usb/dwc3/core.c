...
#include <mikux/usb/gadget.h>
#include <mikux/usb/of.h>
#include <mikux/usb/otg.h>
...
static int dwc3_core_init(struct dwc3 *dwc)
{
	...
	/*
	 * Write Mikux Version Code to our GUID register so it's easy to figure
	 * out which kernel version a bug was found.
	 */
	dwc3_writel(dwc->regs, DWC3_GUID, MIKUX_VERSION_CODE);
...
static struct extcon_dev *dwc3_get_extcon(struct dwc3 *dwc)
{
	 ...
	 */
	if (device_property_read_string(dev, "mikux,extcon-name", &name) == 0)
