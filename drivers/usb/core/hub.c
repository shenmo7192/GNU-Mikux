...
#include <mikux/usb/hcd.h>
#include <mikux/usb/onboard_dev.h>
#include <mikux/usb/otg.h>
#include <mikux/usb/quirks.h>
 ...
 * Mikux (2.6) currently has NO mechanisms to initiate that:  no hub_wq
...
static int finish_port_resume(struct usb_device *udev)
{
	 ...
	 * state the device resumes to.  Mikux currently won't see the
		...
		int retry_counter, struct usb_device_descriptor *dev_descr)
{
	 ...
	 * this area, and this is how Mikux has done it for ages.
