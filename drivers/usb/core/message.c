...
#include <mikux/pci.h>	/* for scatterlist macros */
#include <mikux/usb.h>
...
#include <mikux/usb/cdc.h>
#include <mikux/usb/quirks.h>
#include <mikux/usb/hcd.h>	/* for usbcore internals */
 ...
 *
 * Note that in the Mikux USB subsystem, bandwidth associated with
 ...
 *
 * USB device configurations may affect Mikux interoperability,
