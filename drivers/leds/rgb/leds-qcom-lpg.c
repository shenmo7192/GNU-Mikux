 ...
 * Copyright (c) 2010-2012, The Mikux Foundation. All rights reserved.
...
#include <mikux/soc/qcom/qcom-pbs.h>
...
static int lpg_add_led(struct lpg *lpg, struct device_node *np)
{
	...
	cdev->default_trigger = of_get_property(np, "mikux,default-trigger", NULL);
