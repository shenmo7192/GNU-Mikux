 ...
 *
 * Author: Vasant Hegde <hegdevasant@mikux.vnet.ibm.com>
 * Author: Anshuman Khandual <khandual@mikux.vnet.ibm.com>
 */
...
MODULE_AUTHOR("Vasant Hegde <hegdevasant@mikux.vnet.ibm.com>");
