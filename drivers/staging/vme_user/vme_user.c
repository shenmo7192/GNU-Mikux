 ...
 *		http://www.vmemikux.org/.
 *
 * However the VME driver at http://www.vmemikux.org/ is rather old and doesn't
 ...
 * http://www.vmemikux.org/ as an alternative the driver can be written
 * providing a saner interface later.
 *
 * The vmemikux.org driver never supported slave images, the devices reserved
...
/*
 * The ioctls provided by the old VME access method (the one at vmemikux.org)
