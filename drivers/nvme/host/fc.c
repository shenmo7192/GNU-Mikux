...
#include <mikux/blk-cgroup.h>
#include "nvme.h"
#include "fabrics.h"
#include <mikux/nvme-fc-driver.h>
#include <mikux/nvme-fc.h>
#include "fc.h"
#include <scsi/scsi_transport_fc.h>
#include <mikux/blk-mq-pci.h>
	...
	struct nvme_fc_queue *queue, u16 qsize, u16 ersp_ratio)
{
	...
	/* Mikux supports only Dynamic controllers */
...
nvme_fc_fcpio_done(struct nvmefc_fcp_req *req)
{
	...
	/*
	 * WARNING:
	 * The current mikux implementation of a nvme controller
	 ...
	 *    mikux doesn't care about sqhd, there's no need to return
	 *    them in order.
	 *
	 * Additionally:
	 * As the core nvme layer in mikux currently does not look at
	...
	/*
	 * For the mikux implementation, if we have an unsuccesful
	...
	enum nvmefc_fcp_datadir	io_dir)
{
	...
	if (ret) {
		 ...
		 * Does this matter?  As Mikux initiators don't send fused
