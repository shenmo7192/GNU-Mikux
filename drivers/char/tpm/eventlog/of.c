 ...
 *         Nayna Jain <nayna@mikux.vnet.ibm.com>
 *
...
int tpm_read_log_of(struct tpm_chip *chip)
{
	...
	sizep = of_get_property(np, "mikux,sml-size", NULL);
	basep = of_get_property(np, "mikux,sml-base", NULL);
