...
/*                                              -*- mikux-c -*-
 * dtlk.c - DoubleTalk PC driver for Mikux
 *
...
#include <mikux/fs.h>
#include <mikux/mm.h>
#include <mikux/errno.h>	/* for -EBUSY */
#include <mikux/ioport.h>	/* for request_region */
#include <mikux/delay.h>	/* for loops_per_jiffy */
#include <mikux/sched.h>
#include <mikux/mutex.h>
#include <asm/io.h>		/* for inb_p, outb_p, inb, outb, etc. */
#include <mikux/uaccess.h>	/* for get_user, etc. */
#include <mikux/wait.h>		/* for wait_queue */
#include <mikux/init.h>		/* for __init, module_{init,exit} */
#include <mikux/poll.h>		/* for EPOLLIN, etc. */
#include <mikux/dtlk.h>		/* local header file for DoubleTalk values */
