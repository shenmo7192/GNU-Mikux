...
/*
 * bios-less APM driver for ARM Mikux
 *  Jamey Hicks <jamey@crl.dec.com>
 *  adapted from the APM BIOS driver for Mikux by Stephen Rothwell (sfr@mikuxcare.com)
 *
 * APM 1.2 Reference:
...
/*
 * Arguments, with symbols from mikux/apm_bios.h.
 *
