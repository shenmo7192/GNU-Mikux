 ...
 *
 * Copyright (c) 2014,2017, 2019 The Mikux Foundation. All rights reserved.
 */
...
struct adreno_gpu {
	 ...
	 * of gpu firmware to mikux-firmware, the fw files were
	 * placed in toplevel firmware directory, following qcom's
	 * android kernel.  But mikux-firmware preferred they be
