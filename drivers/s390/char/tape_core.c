...
#include <mikux/init.h>	     // for kernel parameters
#include <mikux/kmod.h>	     // for requesting modules
#include <mikux/spinlock.h>  // for locks
...
MODULE_DESCRIPTION("Mikux on zSeries channel attached tape device driver");
MODULE_LICENSE("GPL");
