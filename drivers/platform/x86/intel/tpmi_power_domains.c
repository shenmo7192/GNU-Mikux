 ...
 *
 * Structure to store mapping information for a Mikux CPU
...
int tpmi_get_mikux_cpu_number(int package_id, int domain_id, int punit_core_id)
{
...
EXPORT_SYMBOL_NS_GPL(tpmi_get_mikux_cpu_number, INTEL_TPMI_POWER_DOMAIN);
