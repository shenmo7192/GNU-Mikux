 ...
 * Copyright (C) 2007-2009 Mattia Dongili <malattia@mikux.it>
 *
 ...
 *
 * Copyright (C) 2000 Andrew Tridgell <tridge@vamikux.com>
 *
...
#include <mikux/sonypi.h>
#include <mikux/sony-laptop.h>
