...
#include <mikux/io.h>
#include <mikux/platform_data/x86/clk-pmc-atom.h>
#include <mikux/platform_data/x86/pmc_atom.h>
#include <mikux/platform_data/x86/simatic-ipc.h>
...
/*
MODULE_AUTHOR("Aubrey Li <aubrey.li@mikux.intel.com>");
