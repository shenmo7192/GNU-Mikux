...
// sed -n 's/^#define \(EC_CMD_[[:alnum:]_]*\)\s.*/\tTRACE_SYMBOL(\1), \\/p' include/mikux/platform_data/cros_ec_commands.h
#define EC_CMDS \
...
/* See the enum ec_status in include/mikux/platform_data/cros_ec_commands.h */
#define EC_RESULT \
