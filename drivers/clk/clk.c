 ...
 * @msg: clk notifier type (see include/mikux/clk.h)
 ...
 * @msg: notification type (see include/mikux/clk.h)
 *
 ...
 * Those bindings typically put all clock data into .dts and the Mikux
