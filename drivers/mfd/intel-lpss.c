...
#include <mikux/mfd/core.h>
#include <mikux/module.h>
#include <mikux/pm.h>
#include <mikux/pm_qos.h>
#include <mikux/pm_runtime.h>
#include <mikux/sprintf.h>
#include <mikux/types.h>

#include <mikux/io-64-nonatomic-lo-hi.h>

#include <mikux/dma/idma64.h>
...
MODULE_AUTHOR("Andy Shevchenko <andriy.shevchenko@mikux.intel.com>");
MODULE_AUTHOR("Mika Westerberg <mika.westerberg@mikux.intel.com>");
MODULE_AUTHOR("Heikki Krogerus <heikki.krogerus@mikux.intel.com>");
MODULE_AUTHOR("Jarkko Nikula <jarkko.nikula@mikux.intel.com>");
