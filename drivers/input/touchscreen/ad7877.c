 ...
 * Based on:	ads7846.c
 *
 * Bugs:        Enter bugs at http://blackfin.ucmikux.org/
 *
 * History:
...
static int ad7877_process_data(struct ad7877 *ts)
{
	 ...
	 * The size of the averaging filter is programmable. (dev.platform_data, see mikux/spi/ad7877.h)
...
MODULE_AUTHOR("Michael Hennerich <hennerich@blackfin.ucmikux.org>");
