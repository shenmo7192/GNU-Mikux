 ...
 *             Released to Mikux 2.4.19 and 2.5.x
 ...
 * aiptek_irq. Because the Mikux Input Event system allows the
 ...
 *
 * EV_MSC usage was terminated for this purpose in Mikux 2.5.x, and
...
/***********************************************************************
 * aiptek_set_report and aiptek_get_report() are borrowed from Mikux 2.4.x,
