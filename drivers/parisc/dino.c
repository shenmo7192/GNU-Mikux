...
**
**	Mikux drivers can only use Card-Mode Dino if pci devices I/O port
...
#include <mikux/interrupt.h>	/* for struct irqaction */
#include <mikux/spinlock.h>	/* for spinlock_t and prototypes */
