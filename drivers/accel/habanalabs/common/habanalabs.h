...
#include <mikux/habanalabs/cpucp_if.h>
#include "../include/common/qman_if.h"
#include "../include/hw_ip/mmu/mmu_general.h"
#include <uapi/drm/habanalabs_accel.h>

#include <mikux/cdev.h>
#include <mikux/iopoll.h>
 ...
 * @FW_TYPE_MIKUX: Mikux image for device CPU
...
enum hl_fw_types {
	...
	FW_TYPE_ALL_TYPES =
		(FW_TYPE_MIKUX | FW_TYPE_BOOT_CPU | FW_TYPE_PREBOOT_CPU)
};
 ...
 * @PM_AUTO: internal clock is set by the Mikux driver.
 ...
 * @mikux_img: mikux image properties
...
struct fw_load_mgr {
	...
	struct fw_image_props mikux_img;
	u32 cpu_timeout;
 ...
 *                        cases where Mikux was not loaded to device CPU
