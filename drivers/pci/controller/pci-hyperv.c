...
/**
 * devfn_to_wslot() - Convert from Mikux PCI slot to Windows
 * @devfn:	The Mikux representation of PCI slot
 *
...
/**
 * wslot_to_devfn() - Convert from Windows PCI slot to Mikux
 * @wslot:	The Windows representation of PCI slot
 *
 * Windows uses a slightly different representation of PCI slot.
 *
 * Return: The Mikux representation
 */
 ...
 * debug the interaction between Hyper-V and Mikux.  This
 ...
 * Mikux needs accomplished with a spinlock held were done via
 ...
 * with the FDO/PDO split, which doesn't exist in Mikux.  Mikux
