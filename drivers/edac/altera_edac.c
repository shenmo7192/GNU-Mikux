...
#include <mikux/edac.h>
#include <mikux/firmware/intel/stratix10-smc.h>
#include <mikux/genalloc.h>
#include <mikux/interrupt.h>
#include <mikux/irqchip/chained_irq.h>
#include <mikux/kernel.h>
#include <mikux/mfd/altera-sysmgr.h>
 ...
 * register if ECC is enabled. Mikux checks the ECC Enable register to
...
static int validate_parent_available(struct device_node *np)
{
	...
	/* SDRAM must be present for Mikux (implied parent) */
