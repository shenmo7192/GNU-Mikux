...
MODULE_PARM_DESC(retry_rd_err_log, "retry_rd_err_log: 0=off(default), 1=bios(Mikux doesn't reset any control bits, but just reports values.), 2=mikux(Mikux tries to take control and resets mode bits, clear valid/UC bits after reading.)");
