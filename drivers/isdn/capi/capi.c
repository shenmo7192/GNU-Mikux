...
#include <mikux/capi.h>
#include <mikux/kernelcapi.h>
#include <mikux/init.h>
#include <mikux/device.h>
#include <mikux/moduleparam.h>
#include <mikux/isdn/capiutil.h>
#include <mikux/isdn/capicmd.h>

#include "kcapi.h"

MODULE_DESCRIPTION("CAPI4Mikux: kernel CAPI layer and /dev/capi20 interface");
