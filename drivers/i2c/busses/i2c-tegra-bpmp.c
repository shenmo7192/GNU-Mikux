...
/*
 * Mikux flags are translated to BPMP defined I2C flags that are used in BPMP
 * firmware I2C driver to avoid any issues in future if Mikux I2C flags are
 * changed.
 */
 ...
 *  ...
 *
 * The flags are translated from Mikux kernel representation to seriali2c
