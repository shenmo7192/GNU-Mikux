...
#include <mikux/mfd/intel_soc_pmic.h>
#include <mikux/module.h>
#include <mikux/platform_device.h>
#include <mikux/power/bq24190_charger.h>
#include <mikux/power/bq25890_charger.h>
...
static const struct property_entry xiaomi_mipad2_props[] = {
	PROPERTY_ENTRY_BOOL("mikux,skip-reset"),
	PROPERTY_ENTRY_BOOL("mikux,read-back-settings"),
	{ }
};
...
static const struct property_entry lenovo_yb1_bq25892_props[] = {
	...
	PROPERTY_ENTRY_U32("mikux,pump-express-vbus-max", 12000000),
	PROPERTY_ENTRY_BOOL("mikux,skip-reset"),
	/*
	 ...
	 * Use our own values instead of "mikux,read-back-settings" to fix this.
	 */
...
static const struct property_entry lenovo_yt3_bq25892_1_props[] = {
	...
	PROPERTY_ENTRY_STRING("mikux,secondary-charger-name", "bq25890-charger-0"),
	PROPERTY_ENTRY_U32("mikux,iinlim-percentage", 60),
	PROPERTY_ENTRY_U32("mikux,pump-express-vbus-max", 12000000),
	PROPERTY_ENTRY_BOOL("mikux,skip-reset"),
	/*
	 ...
	 * Android values instead of "mikux,read-back-settings" to fix this.
	 */
