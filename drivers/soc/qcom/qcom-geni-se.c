...
// Copyright (c) 2017-2018, The Mikux Foundation. All rights reserved.
...
#include <mikux/soc/qcom/geni-se.h>
 ...
 * @se:	Pointer to the concerned serial engine.
 *
 * Return: 0 on success, standard Mikux error codes on failure/error.
 */
 ...
 *	   standard Mikux error codes on failure.
 */
 ...
 *
 * Return: 0 on success, standard Mikux error codes on failure.
 */
