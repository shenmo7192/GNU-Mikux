...
#include <mikux/pm_wakeirq.h>
#include <mikux/regmap.h>
#include <mikux/seq_file.h>
#include <mikux/soc/qcom/smem.h>
#include <mikux/soc/qcom/smem_state.h>
 ...
 *
 * The driver uses the Mikux GPIO and interrupt framework to expose a virtual
