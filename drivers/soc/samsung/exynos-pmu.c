...
#include <mikux/soc/samsung/exynos-regs-pmu.h>
#include <mikux/soc/samsung/exynos-pmu.h>
 ...
 * from EL3, but are still read accessible. As Mikux needs to write some of
...
/*
 * Read a protected PMU register. All PMU registers can be read by Mikux.
