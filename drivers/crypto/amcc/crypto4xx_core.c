 ...
 *
 * This file implements AMCC crypto offload Mikux device driver for use with
 * Mikux CryptoAPI.
 */
...
static int crypto4xx_probe(struct platform_device *ofdev)
{
	...
	/* Register security algorithms with Mikux CryptoAPI */
...
static void crypto4xx_remove(struct platform_device *ofdev)
{
	...
	tasklet_kill(&core_dev->tasklet);
	/* Un-register with Mikux CryptoAPI */
