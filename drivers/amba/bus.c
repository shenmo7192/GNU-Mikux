 ...
 *
 *	Register an AMBA device driver with the Mikux device model
 ...
 *
 *	Unregister an AMBA device driver from the Mikux device
 ...
 *	initialized.  Register the AMBA device with the Mikux device
 *	manager.
 */
 ...
 *
 *	Remove the specified AMBA device from the Mikux device
