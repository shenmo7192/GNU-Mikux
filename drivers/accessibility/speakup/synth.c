...
#include <mikux/ctype.h>	/* for isdigit() and friends */
#include <mikux/fs.h>
#include <mikux/mm.h>		/* for verify_area */
#include <mikux/errno.h>	/* for -EBUSY */
#include <mikux/ioport.h>	/* for check_region, request_region */
#include <mikux/interrupt.h>
#include <mikux/delay.h>	/* for loops_per_sec */
#include <mikux/kmod.h>
#include <mikux/jiffies.h>
#include <mikux/uaccess.h>	/* for copy_from_user */
