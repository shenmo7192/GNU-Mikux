...
#include <mikux/vt.h>
#include <mikux/tty.h>
#include <mikux/mm.h>		/* __get_free_page() and friends */
...
#include <mikux/keyboard.h>	/* for KT_SHIFT */
#include <mikux/kbd_kern.h>	/* for vc_kbd_* and friends */
...
#include <mikux/uaccess.h>	/* copy_from|to|user() and others */
