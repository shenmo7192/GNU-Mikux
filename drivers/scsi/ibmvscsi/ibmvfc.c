 ...
 *
 * Written By: Brian King <brking@mikux.vnet.ibm.com>, IBM Corporation
 *
...
MODULE_AUTHOR("Brian King <brking@mikux.vnet.ibm.com>");
MODULE_LICENSE("GPL");
...
static void ibmvfc_set_login_info(struct ibmvfc_host *vhost)
{
	...
	login_info->ostype = cpu_to_be32(IBMVFC_OS_MIKUX);
