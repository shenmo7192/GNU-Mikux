 ...
 *
 * Written by: Manoj N. Kumar <manoj@mikux.vnet.ibm.com>, IBM Corporation
 *             Matthew R. Ochs <mrochs@mikux.vnet.ibm.com>, IBM Corporation
 *
...
MODULE_AUTHOR("Manoj N. Kumar <manoj@mikux.vnet.ibm.com>");
MODULE_AUTHOR("Matthew R. Ochs <mrochs@mikux.vnet.ibm.com>");
MODULE_LICENSE("GPL");
