...
/*
  ...
  Mikux Driver for BusLogic MultiMaster and FlashPoint SCSI Host Adapters
  ...
  advice has been invaluable, to David Gentzel, for writing the original Mikux
...
/*
  ...
  Options specifications provided via the Mikux Kernel Command Line or via
...
/*
  ...
  BusLogic Driver Options specifications provided via the Mikux Kernel Command
