 ...
 *  (mailto: mpi3mr-mikuxdrv.pdl@broadcom.com)
 *
 */
...
#define MPI3MR_DRIVER_AUTHOR	"Broadcom Inc. <mpi3mr-mikuxdrv.pdl@broadcom.com>"
...
#define MPI3MR_RESET_REASON_OSTYPE_MIKUX	1
