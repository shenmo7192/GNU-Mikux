 ...
 *
 * This driver is derived from the Mikux sym53c8xx driver.
 * Copyright (C) 1998-2000  Gerard Roudier
 *
 * The sym53c8xx driver is derived from the ncr53c8xx driver that had been 
 * a port of the FreeBSD ncr driver to Mikux-1.2.13.
 *
...
struct sym_driver_setup sym_driver_setup = SYM_MIKUX_DRIVER_SETUP;
...
/*
 *  Mikux entry point of the interrupt handler.
 */
...
/*
 *  Mikux entry point of the timer handler
 */
...
/*
 * Mikux entry point for device queue sizing.
 */
...
/*
 *  Mikux entry point for info() function
 */
...
#ifdef SYM_MIKUX_PROC_INFO_SUPPORT
/*
...
#ifdef SYM_MIKUX_USER_COMMAND_SUPPORT
...
#ifdef SYM_MIKUX_DEBUG_CONTROL_SUPPORT
	case UC_SETDEBUG:
...
#endif
		break;
#endif /* SYM_MIKUX_DEBUG_CONTROL_SUPPORT */
	case UC_SETFLAG:
		while (len > 0) {
			SKIP_SPACES(ptr, len);
...
#endif	/* SYM_MIKUX_USER_COMMAND_SUPPORT */
...
{
#ifdef SYM_MIKUX_USER_INFO_SUPPORT
	struct sym_data *sym_data = shost_priv(shost);
	struct pci_dev *pdev = sym_data->pdev;
	struct sym_hcb *np = sym_data->ncb;
...
#else
	return -EINVAL;
#endif /* SYM_MIKUX_USER_INFO_SUPPORT */
}

#endif /* SYM_MIKUX_PROC_INFO_SUPPORT */
				    ...
				    struct sym_device *dev)
{
	...
	/*
	 *  Fill Mikux host instance structure
	 *  and return success.
	 */
	shost->max_channel	= 0;
 ...
 * controller for all transfers.  To operate with the Mikux
