 ...
 */
#if 1
#define	SYM_MIKUX_PROC_INFO_SUPPORT
#define SYM_MIKUX_USER_COMMAND_SUPPORT
#define SYM_MIKUX_USER_INFO_SUPPORT
#define SYM_MIKUX_DEBUG_CONTROL_SUPPORT
#endif
 ...
 *
 *  This structure is initialized from mikux config options.
