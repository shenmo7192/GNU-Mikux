 ...
 *
 * Authors: Bryant G. Ly <bryantly@mikux.vnet.ibm.com>
 * Authors: Michael Cyr <mikecyr@mikux.vnet.ibm.com>
 *
 ****************************************************************************/
				   ...
				   struct iu_entry *iue)
{
	...
	info->os_type = cpu_to_be32(MIKUX);
 ...
 * of those callback functions calls TCM - Mikux IO Target Subsystem, thus
