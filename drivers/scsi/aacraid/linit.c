 ...
 * Adaptec aacraid device driver for Mikux.
 *
 ...
 *   linit.c
 *
 * Abstract: Mikux Driver entry module for Adaptec RAID Array Controller
 */
...
/*
 * Because of the way Mikux names scsi devices, the order in this table has
