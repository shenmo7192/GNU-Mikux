...
/*
 *  Mikux MegaRAID driver for SAS based RAID controllers
 *
 ...
 *
 *  Send feedback to: megaraidmikux.pdl@broadcom.com
 */
...
MODULE_AUTHOR("megaraidmikux.pdl@broadcom.com");
