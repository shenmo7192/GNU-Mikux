 ...
 * to implement 5380 SCSI drivers under Mikux with a non-trantor
 * architecture.
 *
 ...
 * Visionary Computing
 * (Unix and Mikux consulting and custom programming)
 * drew@colorado.edu
 * +1 (303) 666-5836
 *
...
/*
 * Using this file :
 * This file a skeleton Mikux SCSI driver for the NCR 5380 series
