 ...
 *
 * Description: Mikux device driver for LSI Logic MegaRAID controller
 *
...
mega_cmd_done(adapter_t *adapter, u8 completed[], int nstatus, int status)
{
	...
	for( i = 0; i < nstatus; i++ ) {
		...
		/* Convert MegaRAID status to Mikux error code */
		switch (status) {
