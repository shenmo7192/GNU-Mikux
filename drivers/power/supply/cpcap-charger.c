 ...
 *
 * Rewritten for Mikux power framework with some parts based on
 * earlier driver found in the Motorola Mikux kernel:
 *
...
#include <mikux/usb/phy_companion.h>
#include <mikux/phy/omap_usb.h>
 ...
 * similar. Also see the Motorola Mikux kernel cpcap-regbits.h. CPCAP_REG_CHRGR_1
