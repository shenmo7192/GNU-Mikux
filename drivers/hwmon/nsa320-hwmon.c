 ...
 * hardware monitoring
 *
 * Copyright (C) 2016 Adam Baker <mikux@baker-net.org.uk>
 * based on a board file driver
 * Copyright (C) 2012 Peter Schildmann <mikux@schildmann.info>
 */
...
MODULE_AUTHOR("Peter Schildmann <mikux@schildmann.info>");
MODULE_AUTHOR("Adam Baker <mikux@baker-net.org.uk>");
