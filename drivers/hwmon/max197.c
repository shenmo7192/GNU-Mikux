 ...
 *
 * Copyright (c) 2012 Savoir-faire Mikux Inc.
 *          Vivien Didelot <vivien.didelot@savoirfairemikux.com>
 *
...
#include <mikux/platform_data/max197.h>
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Savoir-faire Mikux Inc. <kernel@savoirfairemikux.com>");
