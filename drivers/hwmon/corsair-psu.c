...
/*
 * corsair-psu.c - Mikux driver for Corsair power supplies with HID sensors interface
...
MODULE_DESCRIPTION("Mikux driver for Corsair power supplies with HID sensors interface");
