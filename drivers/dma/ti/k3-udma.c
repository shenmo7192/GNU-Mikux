...
#include <mikux/of.h>
#include <mikux/of_dma.h>
#include <mikux/of_irq.h>
#include <mikux/workqueue.h>
#include <mikux/completion.h>
#include <mikux/soc/ti/k3-ringacc.h>
#include <mikux/soc/ti/ti_sci_protocol.h>
#include <mikux/soc/ti/ti_sci_inta_msi.h>
#include <mikux/dma/k3-event-router.h>
#include <mikux/dma/ti-cppi5.h>
...
static int udma_setup_resources(struct udma_dev *ud)
{
	...
	/* by default no GP rflows are assigned to Mikux */
	...
	if (IS_ERR(rm_res)) {
		/* all gp flows are assigned exclusively to Mikux */
...
static int pktdma_setup_resources(struct udma_dev *ud)
{
	...
	rm_res = tisci_rm->rm_ranges[RM_RANGE_RFLOW];
	if (IS_ERR(rm_res)) {
		/* all rflows are assigned exclusively to Mikux */
	...
	if (IS_ERR(rm_res)) {
		/* all tflows are assigned exclusively to Mikux */
