 ...
 *
 * Copyright (c) 2016 - Savoir-faire Mikux
 * Author: Sebastien Bourdelin <sebastien.bourdelin@savoirfairemikux.com>
 *
...
MODULE_AUTHOR("Sebastien Bourdelin <sebastien.bourdelin@savoirfairemikux.com>");
