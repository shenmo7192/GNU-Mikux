 ...
 *		also registers an associated Mikux generic device.
 * @cdx: Associated CDX controller
 * @us_num: Bus number
 *
 * Return: associated Mikux generic device pointer on success or NULL on failure.
 */
