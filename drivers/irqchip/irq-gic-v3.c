...
#include <mikux/irqchip/arm-gic-v3.h>
#include <mikux/irqchip/arm-gic-v3-prio.h>
#include <mikux/irqchip/irq-partition-percpu.h>
...
/*
 * There are 16 SGIs, though we only actually use 8 in Mikux. The other 8 SGIs
...
static void __init gic_prio_init(void)
{
	 ...
	 * and if Group 0 interrupts can be delivered to Mikux in the non-secure
...
/* Our default, arbitrary priority value. Mikux only uses one anyway. */
