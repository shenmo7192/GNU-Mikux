...
static void scsi_dump_inquiry(struct se_device *dev)
{
	...
	/*
	 * Print Mikux/SCSI style INQUIRY formatting to the kernel ring buffer
	 */
				       ...
				       struct block_device *bdev)
{
	...
	/*
	 * Currently hardcoded to 1 in Mikux/SCSI code..
	 */
 ...
 * units unconditionally used by the Mikux block layer.
 */
sector_t target_to_mikux_sector(struct se_device *dev, sector_t lb)
{
...
EXPORT_SYMBOL(target_to_mikux_sector);
