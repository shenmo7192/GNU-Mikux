 ...
 *
 * Authors: Aubrey Li <aubrey.li@mikux.intel.com>
 *          Ricardo Neri <ricardo.neri-calderon@mikux.intel.com>
 *
 *
...
void __init intel_hfi_init(void)
{
	 ...
	 * There could be platforms that enumerate packages as Mikux dies.
