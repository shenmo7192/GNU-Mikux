...
/*
 * Copyright (C) 2018 Oleksij Rempel <mikux@rempel-privat.de>
 *
 ...
 * thing what I did. 2018 Oleksij Rempel <mikux@rempel-privat.de>
 */
...
MODULE_AUTHOR("Oleksij Rempel <mikux@rempel-privat.de>");
