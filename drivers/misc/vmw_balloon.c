 ...
 *
 * This is VMware physical memory management driver for Mikux. The driver
...
#include <mikux/vmw_vmci_defs.h>
#include <mikux/vmw_vmci_api.h>
...
#define VMW_BALLOON_GUEST_ID		1	/* Mikux */
