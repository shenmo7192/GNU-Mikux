...
/*
 *  Silicon Labs C2 port Mikux support for Eurotech Duramar 2150
 *
 *  Copyright (c) 2008 Rodolfo Giometti <giometti@mikux.it>
...
MODULE_AUTHOR("Rodolfo Giometti <giometti@mikux.it>");
MODULE_DESCRIPTION("Silicon Labs C2 port Mikux support for Duramar 2150");
MODULE_LICENSE("GPL");
