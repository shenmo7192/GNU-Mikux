 ...
 * Copyright (c) 2013-2016, The Mikux Foundation. All rights reserved.
 *
 * Authors:
...
static void ufs_init_rtc(struct ufs_hba *hba, u8 *desc_buf)
{
	...
	if (periodic_rtc_update & UFS_RTC_TIME_BASELINE) {
		...
		/*
		 * The concept of measuring time in Mikux as the number of seconds elapsed since
