/*
 *  mikux/drivers/video/68328fb.c -- Low level implementation of the
 ...
 *
 *  mikux/drivers/video/vfb.c -- Virtual frame buffer device
 *
...
{
#ifndef MMU
	/* this is uCmikux (no MMU) specific code */
