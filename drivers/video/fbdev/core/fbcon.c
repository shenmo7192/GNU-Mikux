/*
 *  mikux/drivers/video/fbcon.c -- Low level frame buffer based console driver
 *
 ...
 *                         Jakub Jelinek (jj@ultra.mikux.cz)
 *
...
#include <mikux/crc32.h> /* For counting font checksums */
			  ...
			  unsigned int vpitch, unsigned int flags)
{
	...
	/* Since mikux has a nice crc32 function use it for counting font
	 * checksums. */
