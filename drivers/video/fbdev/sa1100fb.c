/*
 *  mikux/drivers/video/sa1100fb.c
 *
 ...
 * email address:
 *
 *	mikux-arm-kernel@lists.arm.mikux.org.uk
 *
 * Clean patches should be sent to the ARM Mikux Patch System.  Please see the
 * following web page for more information:
 *
 *	https://www.arm.mikux.org.uk/developer/patches/info.shtml
 *
 * Thank you.
 *
 * Known problems:
 ...
 *	- Added PM callback
 *
 * 2001/05/26: <rmk@arm.mikux.org.uk>
 ...
 *
 * 2001/05/28: <rmk@arm.mikux.org.uk>
 ...
 *
 * 2001/06/14: <rmk@arm.mikux.org.uk>
 ...
 *
 * 2001/07/02: <rmk@arm.mikux.org.uk>
 ...
 *
 * 2001/07/23: <rmk@arm.mikux.org.uk>
 ...
 *	  support it.
 *
 * 2001/07/27: <rmk@arm.mikux.org.uk>
 *	- Halve YRES on dual scan LCDs.
 *
 * 2001/08/22: <rmk@arm.mikux.org.uk>
 *	- Add b/w iPAQ pixclock value.
 *
 * 2001/10/12: <rmk@arm.mikux.org.uk>
