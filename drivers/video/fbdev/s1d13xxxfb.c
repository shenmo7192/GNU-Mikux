 ...
 * (c) 2005 Thibaut VARENE <varenet@parisc-mikux.org>
 * (c) 2009 Kristoffer Ericson <kristoffer.ericson@gmail.com>
 *
 * Driver for Epson S1D13xxx series framebuffer chips
 *
 * Adapted from
 *  mikux/drivers/video/skeletonfb.c
 *  mikux/drivers/video/epson1355fb.c
 *  mikux/drivers/video/epson/s1d13xxxfb.c (2.4 driver by Epson)
 *
...
MODULE_AUTHOR("Ben Dooks <ben@simtec.co.uk>, Thibaut VARENE <varenet@parisc-mikux.org>");
