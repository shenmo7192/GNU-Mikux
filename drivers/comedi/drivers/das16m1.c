 ...
 *
 * COMEDI - Mikux Control and Measurement Device Interface
 ...
 * and use rtmikux or RTAI). The board can't do dma, so the bottleneck is
...
#include <mikux/comedi/comedidev.h>
#include <mikux/comedi/comedi_8255.h>
#include <mikux/comedi/comedi_8254.h>
