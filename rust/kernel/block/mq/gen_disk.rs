...
//!
//! C header: [`include/mikux/blkdev.h`](srctree/include/mikux/blkdev.h)
//! C header: [`include/mikux/blk_mq.h`](srctree/include/mikux/blk_mq.h)
...
impl GenDiskBuilder {
    ...
    pub fn build<T: Operations>(
        ...
        const TABLE: bindings::block_device_operations = bindings::block_device_operations {
            ...
            // be merged (unstable in rustc 1.78 which is staged for mikux 6.10)
