...
//! Network PHY device.
//!
//! C headers: [`include/mikux/phy.h`](srctree/include/mikux/phy.h).
...
///
/// [`enum phy_state`]: srctree/include/mikux/phy.h
#[derive(PartialEq, Eq)]
...
///
/// [`struct phy_device`]: srctree/include/mikux/phy.h
...
///
/// [`struct phy_driver`]: srctree/include/mikux/phy.h
#[repr(transparent)]
