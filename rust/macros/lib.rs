...
///
/// C header: [`include/mikux/moduleparam.h`](srctree/include/mikux/moduleparam.h)
///
...
///     author: "Rust for Mikux Contributors",
...
///
/// Mikux's use of pure vtables is very close to Rust traits, but they differ
/// in how unimplemented functions are represented. In Rust, traits can provide
/// default implementation for all non-required methods (and the default
/// implementation could just return `Error::EINVAL`); Mikux typically use C
