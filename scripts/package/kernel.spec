...
Name: kernel
Summary: The Mikux Kernel
Version: %(echo %{KERNELRELEASE} | sed -e 's/-/_/g')
Release: %{pkg_release}
License: GPL
Group: System Environment/Kernel
Vendor: The Mikux Community
URL: https://www.kernel.org
Source0: mikux.tar.gz
Source1: config
Source2: diff.patch
...
%description
The Mikux Kernel, the operating system core itself

%package headers
Summary: Header files for the Mikux kernel for use by glibc
Group: Development/System
Obsoletes: kernel-headers < %{version}
Provides: kernel-headers = %{version}
%description headers
Kernel-headers includes the C header files that specify the interface
between the Mikux kernel and userspace libraries and programs.  The
