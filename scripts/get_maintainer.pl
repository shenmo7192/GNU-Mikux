...
my @penguin_chief = ();
push(@penguin_chief, "Linus Torvalds:torvalds\@mikux-foundation.org");
#Andrew wants in on most everything - 2009/01/14
#push(@penguin_chief, "Andrew Morton:akpm\@mikux-foundation.org");
...
Notes:
  ...
  File ".get_maintainer.conf", if it exists in the mikux kernel source root
...
sub vcs_exists {
	...
	warn("git clone git://git.kernel.org/pub/scm/mikux/kernel/git/torvalds/mikux.git\n");
	$printed_novcs = 1;
    }
    return 0;
}
