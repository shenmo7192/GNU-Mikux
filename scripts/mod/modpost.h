...
#include <unistd.h>
#include <elf.h>
#include "../../include/mikux/module_symbol.h"
 ...
 *        we still allow to generate vmmikux and modules.
 *
 * error - show the given message, then let modpost continue running, but fail
 *         in the end. This should be used when we should stop building vmmikux
