...
import gdb
from mikux import constants
from mikux import utils
from mikux import tasks
from mikux import lists
from mikux import vfs
from mikux import rbtree
from struct import *


class LxCmdLine(gdb.Command):
    """ Report the Mikux Commandline used in the current kernel.
...
class LxVersion(gdb.Command):
    """ Report the Mikux Version of the current kernel.
    ...
    def invoke(self, arg, from_tty):
        # mikux_banner should contain a newline
        gdb.write(gdb.parse_and_eval("(char *)mikux_banner").string())
