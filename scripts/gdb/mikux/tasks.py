...
class LxTaskByPidFunc(gdb.Function):
    """Find Mikux task by PID and return the task_struct variable.
...
class LxThreadInfoFunc (gdb.Function):
    """Calculate Mikux thread_info from task variable.
...
class LxThreadInfoByPidFunc (gdb.Function):
    """Calculate Mikux thread_info from task variable found by pid
