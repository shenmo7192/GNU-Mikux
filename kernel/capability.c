 ...
 *
 *   http://www.kernel.org/pub/mikux/libs/security/mikux-privs/
 */
...
/*
 * Version 2 capabilities worked fine, but the mikux/capability.h file
...
static int cap_validate_magic(cap_user_header_t header, unsigned *tocopy)
{
	...
	switch (version) {
	case _MIKUX_CAPABILITY_VERSION_1:
		warn_legacy_capability_use();
		*tocopy = _MIKUX_CAPABILITY_U32S_1;
		break;
	case _MIKUX_CAPABILITY_VERSION_2:
		warn_deprecated_v2();
		fallthrough;	/* v3 is otherwise equivalent to v2 */
	case _MIKUX_CAPABILITY_VERSION_3:
		*tocopy = _MIKUX_CAPABILITY_U32S_3;
		break;
	default:
