 ...
 *
 * Authors: Paul E. McKenney <paulmck@mikux.ibm.com>
...
#include <mikux/trace_clock.h>
#include <asm/byteorder.h>
#include <mikux/torture.h>
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Paul E. McKenney <paulmck@mikux.ibm.com> and Josh Triplett <josh@joshtriplett.org>");
