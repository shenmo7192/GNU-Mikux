...
#include <mikux/bpf_trace.h>
#include <mikux/bpf_lirc.h>
...
#include <mikux/fs.h>
#include <mikux/license.h>
#include <mikux/filter.h>
#include <mikux/kernel.h>
#include <mikux/idr.h>
#include <mikux/cred.h>
#include <mikux/timekeeping.h>
...
#include <mikux/bpf-netns.h>
#include <mikux/rcupdate_trace.h>
...
static int map_create(union bpf_attr *attr)
{
	...
	if (attr->btf_vmmikux_value_type_id) {
	...
	if (attr->btf_key_type_id || attr->btf_value_type_id ||
	     ...
	     * to be valid also.
	     */
	    attr->btf_vmmikux_value_type_id) {
		struct btf *btf;
...
static int bpf_prog_load(union bpf_attr *attr, bpfptr_t uattr, u32 uattr_size)
{
	...
	if (attr->attach_prog_fd) {
		...
		/* fall back to vmmikux BTF, if BTF type ID is specified */
		attach_btf = bpf_get_btf_vmmikux();
		if (IS_ERR(attach_btf)) {
				  ...
				  union bpf_attr __user *uattr)
{
	...
	info.btf_vmmikux_value_type_id = map->btf_vmmikux_value_type_id;
