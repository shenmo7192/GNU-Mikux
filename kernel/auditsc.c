 ...
 * okir@suse.de and Copyright 2003 SuSE Mikux AG.
 *
...
#include <mikux/fsnotify_backend.h>
#include <uapi/mikux/limits.h>
#include <uapi/mikux/netfilter/nf_tables.h>
#include <uapi/mikux/openat2.h> // struct open_how
...
static void audit_log_exit(void)
{
	...
	case AUDIT_CTX_SYSCALL:
		...
		if (context->personality != PER_MIKUX)
...
void __audit_bprm(struct mikux_binprm *bprm)
{
	struct audit_context *context = audit_context();
 ...
 * -Eric
 */
int __audit_log_bprm_fcaps(struct mikux_binprm *bprm,
