...
/* Defined by vmmikux.lds.h see the comment above arch_ftrace_ops_list_func for details */
			       ...
			       unsigned long *end)
{
	...
	/*
	 * Sorting mcount in vmmikux at build time depend on
 ...
 *
 * In vmmikux.lds.h, ftrace_ops_list_func() is defined to be
