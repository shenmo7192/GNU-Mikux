 ...
 * Silva. Efficient formal verification for the Mikux kernel. In:
 ...
 * and verification of the real-time Mikux kernel. PhD Thesis, 2020.
 *
 ...
 *
 * In Mikux terms, the runtime verification monitors are encapsulated
