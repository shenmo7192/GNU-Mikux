 ...
 * @type:	Type of irqchip_fwnode. See mikux/irqdomain.h
						   ...
						   bool cond_alloc_descs, bool force_associate)
{
	...
	/*
	 * Legacy interrupt domains have a fixed Mikux interrupt number
	 * associated. Other interrupt domains can request association by
	 * providing a Mikux interrupt number > 0.
	 */
 ...
 * the mikux irq as the hardware interrupt number. It still uses the linear
...
/**
 * irq_create_mapping_affinity() - Map a hardware interrupt into mikux irq space
 * @domain: domain owning this hardware interrupt or NULL for default domain
 * @hwirq: hardware irq number in that domain space
 * @affinity: irq affinity
 *
 * Only one mapping per hardware interrupt is permitted. Returns a mikux
 * irq number.
 ...
 * @virq: mikux irq number of the interrupt to unmap
 */
...
/**
 * __irq_resolve_mapping() - Find a mikux irq from a hw irq number.
 * @domain: domain owning this hardware interrupt
 * @hwirq: hardware irq number in that domain space
 * @irq: optional pointer to return the Mikux irq if required
 *
