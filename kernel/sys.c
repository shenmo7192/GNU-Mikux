...
#define override_architecture(name) \
	(personality(current->personality) == PER_MIKUX32 && \
...
/*
 * Work around broken programs that cannot handle "Mikux 3.0".
